...
function wp_register_tinymce_scripts($scripts, $force_uncompressed = false)
{
    ...
    $compressed =
        $compress_scripts && $concatenate_scripts && !$force_uncompressed;
...
function wp_register_development_scripts($scripts)
{
    ...
    $development_scripts = ["react-refresh-entry", "react-refresh-runtime"];

    foreach ($development_scripts as $script_name) {
        $assets = include ABSPATH .
            WPINC .
            "/assets/script-loader-" .
            $script_name .
            ".php";
        if (!is_array($assets)) {
            return;
...
function wp_default_packages_scripts($scripts)
{
    ...
    $assets = include ABSPATH .
        WPINC .
        "/assets/script-loader-packages{$suffix}.php";
...
function wp_tinymce_inline_scripts()
{
    ...
    /** This filter is documented in wp-includes/class-wp-editor.php */
    $external_plugins = apply_filters(
    ...
    if (
        !empty($editor_settings["tinymce"]) &&
        is_array($editor_settings["tinymce"])
    ) {
        $tinymce_settings = array_merge(
            $tinymce_settings,
            $editor_settings["tinymce"]
        );
    }
    ...
    $script =
		...
		tinymce: {
			baseURL: ' .
        wp_json_encode(includes_url("js/tinymce")) .
        ',
			suffix: ' .
        (SCRIPT_DEBUG ? '""' : '".min"') .
        ',
...
function wp_default_scripts($scripts)
{
    ...
    did_action("init") &&
        $scripts->localize("utils", "userSettings", [
            "url" => (string) SITECOOKIEPATH,
            "uid" => (string) get_current_user_id(),
            "time" => (string) time(),
            "secure" =>
                (string) ("https" === parse_url(site_url(), PHP_URL_SCHEME)),
        ]);

    $scripts->add(
        "common",
        "/wp-admin/js/common$suffix.js",
        ["jquery", "hoverIntent", "utils", "wp-a11y"],
        false,
        1
    );
    ...
    $scripts->add(
        "wp-sanitize",
        "/wp-includes/js/wp-sanitize$suffix.js",
        [],
        false,
        1
    );
    ...
    $scripts->add(
        "quicktags",
        "/wp-includes/js/quicktags$suffix.js",
        [],
        false,
        1
    );
    did_action("init") &&
        $scripts->localize("quicktags", "quicktagsL10n", [
    ...
    $scripts->add(
        "colorpicker",
        "/wp-includes/js/colorpicker$suffix.js",
        ["prototype"],
        "3517m"
    );
    ...
    $scripts->add(
        "clipboard",
        "/wp-includes/js/clipboard$suffix.js",
        [],
        "2.0.11",
        1
    );
    ...
    $scripts->add(
        "wp-ajax-response",
        "/wp-includes/js/wp-ajax-response$suffix.js",
        ["jquery", "wp-a11y"],
        false,
        1
    );
    did_action("init") &&
        $scripts->localize("wp-ajax-response", "wpAjax", [
    ...
    $scripts->add(
        "wp-api-request",
        "/wp-includes/js/api-request$suffix.js",
        ["jquery"],
        false,
        1
    );
    ...
    did_action("init") &&
        $scripts->localize("wp-api-request", "wpApiSettings", [
    ...
    $scripts->add(
        "wp-pointer",
        "/wp-includes/js/wp-pointer$suffix.js",
        ["jquery-ui-core"],
        false,
        1
    );
    ...
    $scripts->add(
        "autosave",
        "/wp-includes/js/autosave$suffix.js",
        ["heartbeat"],
        false,
        1
    );
    ...
    $scripts->add(
        "wp-auth-check",
        "/wp-includes/js/wp-auth-check$suffix.js",
        ["heartbeat"],
        false,
        1
    );
    ...
    $scripts->add(
        "wp-lists",
        "/wp-includes/js/wp-lists$suffix.js",
        ["wp-ajax-response", "jquery-color"],
        false,
        1
    );
    ...
    $scripts->add(
        "jquery-core",
        "/wp-includes/js/jquery/jquery$suffix.js",
        [],
        "3.7.1"
    );
    $scripts->add(
    ...
    $scripts->add(
        ...
        "/wp-includes/js/jquery/ui/effect-blind$suffix.js",
        ["jquery-effects-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        ...
        "/wp-includes/js/jquery/ui/effect-bounce$suffix.js",
        ["jquery-effects-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-effects-clip",
        "/wp-includes/js/jquery/ui/effect-clip$suffix.js",
        ["jquery-effects-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-effects-drop",
        "/wp-includes/js/jquery/ui/effect-drop$suffix.js",
        ["jquery-effects-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        ...
        "/wp-includes/js/jquery/ui/effect-explode$suffix.js",
        ["jquery-effects-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-effects-fade",
        "/wp-includes/js/jquery/ui/effect-fade$suffix.js",
        ["jquery-effects-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-effects-fold",
        "/wp-includes/js/jquery/ui/effect-fold$suffix.js",
        ["jquery-effects-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        ...
        "/wp-includes/js/jquery/ui/effect-highlight$suffix.js",
        ["jquery-effects-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-effects-puff",
        "/wp-includes/js/jquery/ui/effect-puff$suffix.js",
        ["jquery-effects-core", "jquery-effects-scale"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-effects-pulsate",
        "/wp-includes/js/jquery/ui/effect-pulsate$suffix.js",
        ["jquery-effects-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        ...
        "/wp-includes/js/jquery/ui/effect-scale$suffix.js",
        ["jquery-effects-core", "jquery-effects-size"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-effects-shake",
        "/wp-includes/js/jquery/ui/effect-shake$suffix.js",
        ["jquery-effects-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-effects-size",
        "/wp-includes/js/jquery/ui/effect-size$suffix.js",
        ["jquery-effects-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        ...
        "/wp-includes/js/jquery/ui/effect-slide$suffix.js",
        ["jquery-effects-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        ...
        "/wp-includes/js/jquery/ui/effect-transfer$suffix.js",
        ["jquery-effects-core"],
        "1.13.3",
        1
    );
    ...
    $scripts->add(
        "jquery-ui-accordion",
        "/wp-includes/js/jquery/ui/accordion$suffix.js",
        ["jquery-ui-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        ...
        "/wp-includes/js/jquery/ui/autocomplete$suffix.js",
        ["jquery-ui-menu", "wp-a11y"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-ui-button",
        "/wp-includes/js/jquery/ui/button$suffix.js",
        ["jquery-ui-core", "jquery-ui-controlgroup", "jquery-ui-checkboxradio"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-ui-datepicker",
        "/wp-includes/js/jquery/ui/datepicker$suffix.js",
        ["jquery-ui-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-ui-dialog",
        "/wp-includes/js/jquery/ui/dialog$suffix.js",
        ["jquery-ui-resizable", "jquery-ui-draggable", "jquery-ui-button"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-ui-menu",
        "/wp-includes/js/jquery/ui/menu$suffix.js",
        ["jquery-ui-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-ui-mouse",
        "/wp-includes/js/jquery/ui/mouse$suffix.js",
        ["jquery-ui-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        ...
        "/wp-includes/js/jquery/ui/progressbar$suffix.js",
        ["jquery-ui-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        ...
        "/wp-includes/js/jquery/ui/selectmenu$suffix.js",
        ["jquery-ui-menu"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-ui-slider",
        "/wp-includes/js/jquery/ui/slider$suffix.js",
        ["jquery-ui-mouse"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-ui-spinner",
        "/wp-includes/js/jquery/ui/spinner$suffix.js",
        ["jquery-ui-button"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-ui-tabs",
        "/wp-includes/js/jquery/ui/tabs$suffix.js",
        ["jquery-ui-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-ui-tooltip",
        "/wp-includes/js/jquery/ui/tooltip$suffix.js",
        ["jquery-ui-core"],
        "1.13.3",
        1
    );
    ...
    $scripts->add(
        ...
        "/wp-includes/js/jquery/ui/checkboxradio$suffix.js",
        ["jquery-ui-core"],
        "1.13.3",
        1
    );
    $scripts->add(
        ...
        "/wp-includes/js/jquery/ui/controlgroup$suffix.js",
        ["jquery-ui-core"],
        "1.13.3",
        1
    );
    ...
    $scripts->add(
        "jquery-ui-draggable",
        "/wp-includes/js/jquery/ui/draggable$suffix.js",
        ["jquery-ui-mouse"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-ui-droppable",
        "/wp-includes/js/jquery/ui/droppable$suffix.js",
        ["jquery-ui-draggable"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-ui-resizable",
        "/wp-includes/js/jquery/ui/resizable$suffix.js",
        ["jquery-ui-mouse"],
        "1.13.3",
        1
    );
    $scripts->add(
        ...
        "/wp-includes/js/jquery/ui/selectable$suffix.js",
        ["jquery-ui-mouse"],
        "1.13.3",
        1
    );
    $scripts->add(
        "jquery-ui-sortable",
        "/wp-includes/js/jquery/ui/sortable$suffix.js",
        ["jquery-ui-mouse"],
        "1.13.3",
        1
    );
     ...
     */
    $scripts->add("jquery-ui-position", false, ["jquery-ui-core"], "1.13.3", 1);
    $scripts->add("jquery-ui-widget", false, ["jquery-ui-core"], "1.13.3", 1);

    // Deprecated, not used in core, most functionality is included in jQuery 1.3.
    $scripts->add(
        "jquery-form",
        "/wp-includes/js/jquery/jquery.form$suffix.js",
        ["jquery"],
        "4.3.0",
        1
    );
    ...
    $scripts->add(
        "jquery-hotkeys",
        "/wp-includes/js/jquery/jquery.hotkeys$suffix.js",
        ["jquery"],
        "0.0.2m",
        1
    );
    $scripts->add(
        ...
        "/wp-includes/js/jquery/jquery.table-hotkeys$suffix.js",
    ...
    $scripts->add(
        "suggest",
        "/wp-includes/js/jquery/suggest$suffix.js",
        ["jquery"],
        "1.1-20110113",
        1
    );
    ...
    did_action("init") &&
        $scripts->localize("thickbox", "thickboxL10n", [
            "next" => __("Next &gt;"),
            "prev" => __("&lt; Prev"),
            "image" => __("Image"),
            "of" => __("of"),
    ...
    $scripts->add(
        "moxiejs",
        "/wp-includes/js/plupload/moxie$suffix.js",
        [],
        "1.3.5.1"
    );
    $scripts->add(
        "plupload",
        "/wp-includes/js/plupload/plupload$suffix.js",
        ["moxiejs"],
        "2.1.9"
    );
    // Back compat handles:
    ...
    $scripts->add(
        ...
        ["plupload", "jquery", "json2", "media-models"],
        false,
        1
    );
    did_action("init") &&
    ...
    $scripts->add(
        "comment-reply",
        "/wp-includes/js/comment-reply$suffix.js",
        [],
        false,
        1
    );
    ...
    did_action("init") &&
        $scripts->localize("wp-util", "_wpUtilSettings", [
            "ajax" => [
    ...
    $scripts->add(
        ...
        ["wp-backbone", "jquery-ui-slider", "hoverIntent"],
        false,
        1
    );
    ...
    $scripts->add(
        "imgareaselect",
        "/wp-includes/js/imgareaselect/jquery.imgareaselect$suffix.js",
        ["jquery"],
        false,
        1
    );
    ...
    $scripts->add(
        "mediaelement-core",
        "/wp-includes/js/mediaelement/mediaelement-and-player$suffix.js",
        [],
        "4.2.17",
        1
    );
    $scripts->add(
        ...
        "/wp-includes/js/mediaelement/mediaelement-migrate$suffix.js",
        [],
        false,
        1
    );
    ...
    $mejs_settings = [
        ...
        "audioShortcodeLibrary" => apply_filters(
            "wp_audio_shortcode_library",
            "mediaelement"
        ),
        /** This filter is documented in wp-includes/media.php */
        "videoShortcodeLibrary" => apply_filters(
    ...
    $scripts->add(
        "zxcvbn-async",
        "/wp-includes/js/zxcvbn-async$suffix.js",
        [],
        "1.0"
    );
    did_action("init") &&
        $scripts->localize("zxcvbn-async", "_zxcvbnSettings", [
            "src" => empty($guessed_url)
                ? includes_url("/js/zxcvbn.min.js")
                : $scripts->base_url . "/wp-includes/js/zxcvbn.min.js",
        ]);
    ...
    did_action("init") &&
        $scripts->localize("password-strength-meter", "pwsL10n", [
    ...
    $scripts->add(
        "password-toggle",
        "/wp-admin/js/password-toggle$suffix.js",
        [],
        false,
        1
    );
    ...
    $scripts->add(
        ...
        ["jquery", "wp-api-request", "wp-i18n", "wp-hooks"],
        false,
        1
    );
    ...
    did_action("init") &&
        $scripts->localize("user-profile", "userProfileL10n", [
            "user_id" => $user_id,
            "nonce" => wp_installing()
                ? ""
                : wp_create_nonce("reset-password-for-" . $user_id),
        ]);

    $scripts->add(
        "language-chooser",
        "/wp-admin/js/language-chooser$suffix.js",
        ["jquery"],
        false,
        1
    );
    ...
    $scripts->add(
        "user-suggest",
        "/wp-admin/js/user-suggest$suffix.js",
        ["jquery-ui-autocomplete"],
        false,
        1
    );
    ...
    $scripts->add(
        "admin-bar",
        "/wp-includes/js/admin-bar$suffix.js",
        ["hoverintent-js"],
        false,
        1
    );
    ...
    $scripts->add(
        "wplink",
        "/wp-includes/js/wplink$suffix.js",
        ["common", "jquery", "wp-a11y", "wp-i18n"],
        false,
        1
    );
    $scripts->set_translations("wplink");
    did_action("init") &&
        $scripts->localize("wplink", "wpLinkL10n", [
    ...
    $scripts->add(
        "wpdialogs",
        "/wp-includes/js/wpdialog$suffix.js",
        ["jquery-ui-dialog"],
        false,
        1
    );
    ...
    $scripts->add(
        "word-count",
        "/wp-admin/js/word-count$suffix.js",
        [],
        false,
        1
    );
    ...
    $scripts->add(
        "media-upload",
        "/wp-admin/js/media-upload$suffix.js",
        ["thickbox", "shortcode"],
        false,
        1
    );
    ...
    $scripts->add(
        "hoverIntent",
        "/wp-includes/js/hoverIntent$suffix.js",
        ["jquery"],
        "1.10.2",
        1
    );
    ...
    $scripts->add(
        "customize-base",
        "/wp-includes/js/customize-base$suffix.js",
        ["jquery", "json2", "underscore"],
        false,
        1
    );
    $scripts->add(
    ...
    did_action("init") &&
        $scripts->localize("customize-controls", "_wpCustomizeControlsL10n", [
    ...
    did_action("init") &&
        $scripts->localize("media-models", "_wpMediaModelsL10n", [
            "settings" => [
    ...
    $scripts->add(
        "media-views",
        "/wp-includes/js/media-views$suffix.js",
        [
            "utils",
            "media-models",
            "wp-plupload",
    ...
    $scripts->add(
        "media-editor",
        "/wp-includes/js/media-editor$suffix.js",
        ["shortcode", "media-views"],
        false,
        1
    );
    ...
    $scripts->add(
        "mce-view",
        "/wp-includes/js/mce-view$suffix.js",
        ["shortcode", "jquery", "media-views", "media-audiovideo"],
        false,
        1
    );
    ...
    $scripts->add(
        "wp-api",
        "/wp-includes/js/wp-api$suffix.js",
    ...
    if (is_admin()) {
        ...
        $scripts->add(
            ...
            ["wp-lists", "quicktags", "jquery-query", "wp-a11y"],
            false,
            1
        );
        $scripts->set_translations("admin-comments");
        did_action("init") &&
            $scripts->localize("admin-comments", "adminCommentsSettings", [
                "hotkeys_highlight_first" => isset(
                    $_GET["hotkeys_highlight_first"]
                ),
                "hotkeys_highlight_last" => isset(
                    $_GET["hotkeys_highlight_last"]
                ),
            ]);

        $scripts->add(
            "xfn",
            "/wp-admin/js/xfn$suffix.js",
            ["jquery"],
            false,
            1
        );
        ...
        $scripts->add(
            "tags-box",
            "/wp-admin/js/tags-box$suffix.js",
            ["jquery", "tags-suggest"],
            false,
            1
        );
        ...
        $scripts->add(
            ...
            ["common", "jquery-ui-autocomplete", "wp-a11y", "wp-i18n"],
            false,
            1
        );
        ...
        $scripts->add(
            "editor-expand",
            "/wp-admin/js/editor-expand$suffix.js",
            ["jquery", "underscore"],
            false,
            1
        );
        ...
        $scripts->add("admin-gallery", "/wp-admin/js/gallery$suffix.js", [
            "jquery-ui-sortable",
        ]);
        ...
        $scripts->add(
            ...
            "/wp-admin/js/widgets/media-gallery-widget$suffix.js",
            ["media-widgets"]
        );
        $scripts->add(
            "media-video-widget",
        ...
        $scripts->add(
            "custom-html-widgets",
            "/wp-admin/js/widgets/custom-html-widgets$suffix.js",
            ["jquery", "backbone", "wp-util", "jquery-ui-core", "wp-a11y"]
        );

        $scripts->add(
            "theme",
            "/wp-admin/js/theme$suffix.js",
            ["wp-backbone", "wp-a11y", "customize-base"],
            false,
            1
        );
        ...
        $scripts->add(
            "site-health",
            "/wp-admin/js/site-health$suffix.js",
            [
                "clipboard",
                "jquery",
                "wp-util",
        ...
        $scripts->add(
            "privacy-tools",
            "/wp-admin/js/privacy-tools$suffix.js",
            ["jquery", "wp-a11y"],
            false,
            1
        );
        ...
        did_action("init") &&
            $scripts->localize("updates", "_wpUpdatesSettings", [
                "ajax_nonce" => wp_installing()
                    ? ""
        ...
        $scripts->add(
            "wp-color-picker",
            "/wp-admin/js/color-picker$suffix.js",
            ["iris"],
            false,
            1
        );
        ...
        $scripts->add(
            "list-revisions",
            "/wp-includes/js/wp-list-revisions$suffix.js"
        );
        ...
        $scripts->add(
            ...
            ["jquery", "clipboard", "wp-i18n", "wp-a11y"],
            false,
            1
        );
        ...
        $scripts->add(
            ...
            ["jquery", "jquery-ui-core", "json2", "imgareaselect", "wp-a11y"],
            false,
            1
        );
        ...
        $scripts->add(
            "set-post-thumbnail",
            "/wp-admin/js/set-post-thumbnail$suffix.js",
            ["jquery"],
            false,
            1
        );
        ...
        $scripts->add(
            ...
            ["wp-color-picker", "media-views"],
            false,
            1
        );
        $scripts->add(
            "media-gallery",
            "/wp-admin/js/media-gallery$suffix.js",
            ["jquery"],
            false,
            1
        );
...
function wp_default_styles($styles)
{
    ...
    $styles->add(
        ...
        "/wp-includes/css/wp-empty-template-alert$suffix.css"
    );
    ...
    $styles->add(
        "farbtastic",
        "/wp-admin/css/farbtastic$suffix.css",
        [],
        "1.3u1"
    );
    $styles->add(
    ...
    $block_library_theme_path =
        WPINC . "/css/dist/block-library/theme$suffix.css";
    $styles->add("wp-block-library-theme", "/$block_library_theme_path");
    $styles->add_data(
        "wp-block-library-theme",
        "path",
        ABSPATH . $block_library_theme_path
    );
    ...
    $styles->add_data(
        ...
        "path",
        ABSPATH . $classic_theme_styles_path
    );
...
function wp_just_in_time_script_localization()
{
    ...
    wp_localize_script("mce-view", "mceViewL10n", [
        "shortcodes" => !empty($GLOBALS["shortcode_tags"])
...
function wp_localize_community_events()
{
    ...
    $saved_ip_address = isset($saved_location["ip"])
        ? $saved_location["ip"]
        : false;
    ...
    if (
        $saved_ip_address &&
        $current_ip_address &&
        $current_ip_address !== $saved_ip_address
    ) {
...
function _print_scripts()
{
    ...
    $type_attr = current_theme_supports("html5", "script")
        ? ""
...
function _print_styles()
{
    ...
    if ($concat) {
        ...
        $href =
            $wp_styles->base_url .
            "/wp-admin/load-styles.php?c={$zip}&dir={$dir}" .
            $concatenated .
            "&ver=" .
            $ver;
...
function script_concat_settings()
{
    ...
    $can_compress_scripts =
        !wp_installing() && get_site_option("can_compress_scripts");

    if (!isset($concatenate_scripts)) {
        $concatenate_scripts = defined("CONCATENATE_SCRIPTS")
            ? CONCATENATE_SCRIPTS
            : true;
        if (
            (!is_admin() && !did_action("login_init")) ||
    ...
    if (!isset($compress_scripts)) {
        $compress_scripts = defined("COMPRESS_SCRIPTS")
            ? COMPRESS_SCRIPTS
            : true;
        if (
            $compress_scripts &&
            (!$can_compress_scripts || $compressed_output)
        ) {
...
function wp_enqueue_global_styles()
{
    ...
    if ($is_block_theme) {
        ...
        $stylesheet .= wp_get_global_stylesheet(["custom-css"]);
    }
...
function wp_enqueue_registered_block_scripts_and_styles()
{
    ...
    $load_editor_scripts_and_styles =
        is_admin() && wp_should_load_block_editor_scripts_and_styles();
        ...
        foreach ($styles as $style_properties) {
            if (isset($style_properties["style_handle"])) {
                ...
                if (wp_should_load_block_assets_on_demand()) {
                    add_filter(
                        "render_block",
                        static function ($html, $block) use (
                            $block_name,
                            $style_properties
                        ) {
            ...
            if (isset($style_properties["inline_style"])) {
                ...
                if (wp_should_load_block_assets_on_demand()) {
                    $block_stylesheet_handle = generate_block_asset_handle(
                        $block_name,
                        "style"
                    );

                    if (
                        isset($wp_styles->registered[$block_stylesheet_handle])
                    ) {
...
function enqueue_editor_block_styles_assets()
{
    ...
    wp_register_script("wp-block-styles", false, ["wp-blocks"], true, [
        "in_footer" => true,
    ]);
...
{
    $html5_script_support =
        !is_admin() && !current_theme_supports("html5", "script");
    $attributes_string = "";
    ...
    foreach ($attributes as $attribute_name => $attribute_value) {
        if (is_bool($attribute_value)) {
            if ($attribute_value) {
                $attributes_string .= $html5_script_support
                    ? sprintf(
                        ' %1$s="%2$s"',
...
function wp_maybe_inline_styles()
{
     ...
     */
    $total_inline_limit = apply_filters(
    ...
    if (!empty($styles)) {
        ...
        foreach ($styles as $style) {
            ...
            if (
                empty($wp_styles->registered[$style["handle"]]->extra["after"])
            ) {
...
function wp_enqueue_stored_styles($options = [])
{
    ...
    foreach (array_keys($additional_stores) as $store_name) {
        ...
        $styles = wp_style_engine_get_stylesheet_from_context(
            $store_name,
            $options
        );
        if (!empty($styles)) {
...
function wp_enqueue_block_style($block_name, $args)
{
    ...
    $hook = did_action("wp_enqueue_scripts")
        ? "wp_footer"
        : "wp_enqueue_scripts";
    if (wp_should_load_block_assets_on_demand()) {
        /**
         ...
         * @return string Block content.
         */
        $callback_separate = static function ($content, $block) use (
            $block_name,
            $callback
        ) {
            if (
