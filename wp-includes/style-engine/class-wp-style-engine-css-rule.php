...
class WP_Style_Engine_CSS_Rule
{
    ...
    public function add_declarations($declarations)
    {
        ...
        $declarations_array = $is_declarations_object
    ...
    public function get_css($should_prettify = false, $indent_count = 0)
    {
        ...
        $nested_rule_indent = $should_prettify
            ? str_repeat("\t", $indent_count + 1)
            : "";
        ...
        $selector = $should_prettify
            ? implode(
                ",",
                array_map("trim", explode(",", $this->get_selector()))
            )
            : $this->get_selector();
        $selector = $should_prettify
            ? str_replace([","], ",\n", $selector)
        ...
        $css_declarations = $this->declarations->get_declarations_string(
            $should_prettify,
            $has_rules_group
