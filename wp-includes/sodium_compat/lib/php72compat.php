...
if (!is_callable("sodium_add")) {
     ...
     */
    function sodium_add(
        #[\SensitiveParameter] &$string1,
        #[\SensitiveParameter] $string2
    ) {
...
if (!is_callable("sodium_bin2base64")) {
     ...
     * @throws TypeError
     */
    function sodium_bin2base64(#[\SensitiveParameter] $string, $variant)
    {
...
if (!is_callable("sodium_bin2hex")) {
     ...
     * @throws TypeError
     */
    function sodium_bin2hex(#[\SensitiveParameter] $string)
    {
...
if (!is_callable("sodium_crypto_aead_aes256gcm_decrypt")) {
    ...
    function sodium_crypto_aead_aes256gcm_decrypt(
        ...
        try {
            ...
            if (
                $ex instanceof SodiumException &&
                $ex->getMessage() === "AES-256-GCM is not available"
            ) {
                throw $ex;
            }
            return false;
...
if (!is_callable("sodium_crypto_aead_aes256gcm_encrypt")) {
    ...
    function sodium_crypto_aead_aes256gcm_encrypt(
        ...
        return ParagonIE_Sodium_Compat::crypto_aead_aes256gcm_encrypt(
            $message,
            $additional_data,
            $nonce,
            $key
...
if (!is_callable("sodium_crypto_auth")) {
     ...
     * @throws TypeError
     */
    function sodium_crypto_auth($message, #[\SensitiveParameter] $key)
    {
...
if (!is_callable("sodium_crypto_auth_verify")) {
    ...
    function sodium_crypto_auth_verify(
        ...
        return ParagonIE_Sodium_Compat::crypto_auth_verify(
            $mac,
            $message,
            $key
        );
...
if (!is_callable("sodium_crypto_box_open")) {
    ...
    function sodium_crypto_box_open(
        ...
        try {
            return ParagonIE_Sodium_Compat::crypto_box_open(
                $ciphertext,
                $nonce,
                $key_pair
            );
...
if (!is_callable("sodium_crypto_box_publickey")) {
     ...
     * @throws TypeError
     */
    function sodium_crypto_box_publickey(#[\SensitiveParameter] $key_pair)
    {
...
if (!is_callable("sodium_crypto_box_publickey_from_secretkey")) {
    ...
    function sodium_crypto_box_publickey_from_secretkey(
        ...
        return ParagonIE_Sodium_Compat::crypto_box_publickey_from_secretkey(
            $secret_key
        );
    }
}
...
if (!is_callable("sodium_crypto_box_seal_open")) {
    ...
    function sodium_crypto_box_seal_open(
        ...
        try {
            return ParagonIE_Sodium_Compat::crypto_box_seal_open(
                $message,
                $key_pair
            );
...
if (!is_callable("sodium_crypto_box_secretkey")) {
     ...
     * @throws TypeError
     */
    function sodium_crypto_box_secretkey(#[\SensitiveParameter] $key_pair)
    {
...
if (!is_callable("sodium_crypto_box_seed_keypair")) {
     ...
     * @throws TypeError
     */
    function sodium_crypto_box_seed_keypair(#[\SensitiveParameter] $seed)
    {
...
if (!is_callable("sodium_crypto_generichash_final")) {
    ...
    {
        return ParagonIE_Sodium_Compat::crypto_generichash_final(
            $state,
            $outputLength
        );
    }
...
if (!is_callable("sodium_crypto_kx_seed_keypair")) {
     ...
     * @throws Exception
     */
    function sodium_crypto_kx_seed_keypair(#[\SensitiveParameter] $seed)
    {
...
if (!is_callable("sodium_crypto_kx_server_session_keys")) {
    ...
    function sodium_crypto_kx_server_session_keys(
        #[\SensitiveParameter] $server_key_pair,
        $client_key
    ) {
...
if (!is_callable("sodium_crypto_kx_secretkey")) {
     ...
     * @throws Exception
     */
    function sodium_crypto_kx_secretkey(#[\SensitiveParameter] $key_pair)
    {
...
if (!is_callable("sodium_crypto_kx_publickey")) {
     ...
     * @throws Exception
     */
    function sodium_crypto_kx_publickey(#[\SensitiveParameter] $key_pair)
    {
...
if (!is_callable("sodium_crypto_pwhash")) {
    ...
    function sodium_crypto_pwhash(
        ...
        return ParagonIE_Sodium_Compat::crypto_pwhash(
            $length,
            $passwd,
            $salt,
            $opslimit,
...
if (!is_callable("sodium_crypto_pwhash_str_needs_rehash")) {
    ...
    function sodium_crypto_pwhash_str_needs_rehash(
        ...
        return ParagonIE_Sodium_Compat::crypto_pwhash_str_needs_rehash(
            $hash,
            $opslimit,
            $memlimit
        );
...
if (!is_callable("sodium_crypto_pwhash_str_verify")) {
    ...
    function sodium_crypto_pwhash_str_verify(
        ...
        return ParagonIE_Sodium_Compat::crypto_pwhash_str_verify(
            $passwd,
            $hash
        );
    }
...
if (!is_callable("sodium_crypto_pwhash_scryptsalsa208sha256_str_verify")) {
    ...
    function sodium_crypto_pwhash_scryptsalsa208sha256_str_verify(
        ...
        return ParagonIE_Sodium_Compat::crypto_pwhash_scryptsalsa208sha256_str_verify(
            $passwd,
            $hash
        );
    }
...
if (!is_callable("sodium_crypto_scalarmult")) {
     ...
     * @throws TypeError
     */
    function sodium_crypto_scalarmult(#[\SensitiveParameter] $n, $p)
    {
...
if (!is_callable("sodium_crypto_scalarmult_base")) {
     ...
     * @throws TypeError
     */
    function sodium_crypto_scalarmult_base(#[\SensitiveParameter] $n)
    {
...
if (!is_callable("sodium_crypto_secretbox")) {
    ...
    function sodium_crypto_secretbox(
        ...
        return ParagonIE_Sodium_Compat::crypto_secretbox(
            $message,
            $nonce,
            $key
        );
...
if (!is_callable("sodium_crypto_secretstream_xchacha20poly1305_init_push")) {
    ...
    function sodium_crypto_secretstream_xchacha20poly1305_init_push(
        ...
        return ParagonIE_Sodium_Compat::crypto_secretstream_xchacha20poly1305_init_push(
            $key
        );
    }
}
...
if (!is_callable("sodium_crypto_shorthash")) {
     ...
     * @throws TypeError
     */
    function sodium_crypto_shorthash($message, #[\SensitiveParameter] $key = "")
    {
...
if (!is_callable("sodium_crypto_sign")) {
     ...
     * @throws TypeError
     */
    function sodium_crypto_sign($message, #[\SensitiveParameter] $secret_key)
    {
...
if (!is_callable("sodium_crypto_sign_detached")) {
    ...
    function sodium_crypto_sign_detached(
        ...
        return ParagonIE_Sodium_Compat::crypto_sign_detached(
            $message,
            $secret_key
        );
    }
...
if (!is_callable("sodium_crypto_sign_open")) {
    ...
    {
        try {
            return ParagonIE_Sodium_Compat::crypto_sign_open(
                $signedMessage,
                $public_key
            );
        } catch (Error $ex) {
...
if (!is_callable("sodium_crypto_sign_publickey")) {
     ...
     * @throws TypeError
     */
    function sodium_crypto_sign_publickey(#[\SensitiveParameter] $key_pair)
    {
...
if (!is_callable("sodium_crypto_sign_publickey_from_secretkey")) {
    ...
    function sodium_crypto_sign_publickey_from_secretkey(
        ...
        return ParagonIE_Sodium_Compat::crypto_sign_publickey_from_secretkey(
            $secret_key
        );
    }
}
if (!is_callable("sodium_crypto_sign_secretkey")) {
     ...
     * @throws TypeError
     */
    function sodium_crypto_sign_secretkey(#[\SensitiveParameter] $key_pair)
    {
...
if (!is_callable("sodium_crypto_sign_seed_keypair")) {
     ...
     * @throws TypeError
     */
    function sodium_crypto_sign_seed_keypair(#[\SensitiveParameter] $seed)
    {
...
if (!is_callable("sodium_crypto_sign_ed25519_pk_to_curve25519")) {
    ...
    {
        return ParagonIE_Sodium_Compat::crypto_sign_ed25519_pk_to_curve25519(
            $public_key
        );
    }
}
if (!is_callable("sodium_crypto_sign_ed25519_sk_to_curve25519")) {
    ...
    function sodium_crypto_sign_ed25519_sk_to_curve25519(
        ...
        return ParagonIE_Sodium_Compat::crypto_sign_ed25519_sk_to_curve25519(
            $secret_key
        );
    }
}
if (!is_callable("sodium_crypto_stream")) {
     ...
     * @throws TypeError
     */
    function sodium_crypto_stream($length, $nonce, #[\SensitiveParameter] $key)
    {
...
if (!is_callable("sodium_crypto_stream_xor")) {
    ...
    function sodium_crypto_stream_xor(
        ...
        return ParagonIE_Sodium_Compat::crypto_stream_xor(
            $message,
            $nonce,
            $key
        );
...
if (!is_callable("sodium_hex2bin")) {
     ...
     * @throws TypeError
     */
    function sodium_hex2bin(#[\SensitiveParameter] $string, $ignore = "")
    {
...
if (!is_callable("sodium_increment")) {
     ...
     * @throws TypeError
     */
    function sodium_increment(#[\SensitiveParameter] &$string)
    {
...
if (!is_callable("sodium_memzero")) {
     ...
     */
    function sodium_memzero(#[\SensitiveParameter] &$string)
    {
...
if (!is_callable("sodium_pad")) {
     ...
     * @throws TypeError
     */
    function sodium_pad(#[\SensitiveParameter] $unpadded, $block_size)
    {
...
if (!is_callable("sodium_unpad")) {
     ...
     * @throws TypeError
     */
    function sodium_unpad(#[\SensitiveParameter] $padded, $block_size)
    {
