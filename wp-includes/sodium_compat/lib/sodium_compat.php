...
if (!is_callable("\\Sodium\\bin2hex")) {
     ...
     * @throws \TypeError
     */
    function bin2hex(#[\SensitiveParameter] $string)
    {
...
if (!is_callable("\\Sodium\\compare")) {
     ...
     * @throws \TypeError
     */
    function compare(#[\SensitiveParameter] $a, #[\SensitiveParameter] $b)
    {
...
if (!is_callable("\\Sodium\\crypto_auth")) {
     ...
     * @throws \TypeError
     */
    function crypto_auth($message, #[\SensitiveParameter] $key)
    {
...
if (!is_callable("\\Sodium\\crypto_auth_verify")) {
     ...
     * @throws \TypeError
     */
    function crypto_auth_verify($mac, $message, #[\SensitiveParameter] $key)
    {
...
if (!is_callable("\\Sodium\\crypto_box_publickey")) {
     ...
     * @throws \TypeError
     */
    function crypto_box_publickey(#[\SensitiveParameter] $keypair)
    {
...
if (!is_callable("\\Sodium\\crypto_box_publickey_from_secretkey")) {
     ...
     * @throws \TypeError
     */
    function crypto_box_publickey_from_secretkey(#[\SensitiveParameter] $sk)
    {
...
if (!is_callable("\\Sodium\\crypto_box_seal")) {
     ...
     * @throws \TypeError
     */
    function crypto_box_seal(#[\SensitiveParameter] $message, $publicKey)
    {
...
if (!is_callable("\\Sodium\\crypto_box_seal_open")) {
     ...
     * @return string|bool
     */
    function crypto_box_seal_open($message, #[\SensitiveParameter] $kp)
    {
        try {
...
if (!is_callable("\\Sodium\\crypto_box_secretkey")) {
     ...
     * @throws \TypeError
     */
    function crypto_box_secretkey(#[\SensitiveParameter] $keypair)
    {
...
if (!is_callable("\\Sodium\\crypto_scalarmult")) {
     ...
     * @throws \TypeError
     */
    function crypto_scalarmult(#[\SensitiveParameter] $n, $p)
    {
...
if (!is_callable("\\Sodium\\crypto_scalarmult_base")) {
     ...
     * @throws \TypeError
     */
    function crypto_scalarmult_base(#[\SensitiveParameter] $n)
    {
...
if (!is_callable("\\Sodium\\crypto_shorthash")) {
     ...
     * @throws \TypeError
     */
    function crypto_shorthash($message, #[\SensitiveParameter] $key = "")
    {
...
if (!is_callable("\\Sodium\\crypto_sign")) {
     ...
     * @throws \TypeError
     */
    function crypto_sign($message, #[\SensitiveParameter] $sk)
    {
...
if (!is_callable("\\Sodium\\crypto_sign_detached")) {
     ...
     * @throws \TypeError
     */
    function crypto_sign_detached($message, #[\SensitiveParameter] $sk)
    {
...
if (!is_callable("\\Sodium\\crypto_sign_publickey")) {
     ...
     * @throws \TypeError
     */
    function crypto_sign_publickey(#[\SensitiveParameter] $keypair)
    {
...
if (!is_callable("\\Sodium\\crypto_sign_publickey_from_secretkey")) {
     ...
     * @throws \TypeError
     */
    function crypto_sign_publickey_from_secretkey(#[\SensitiveParameter] $sk)
    {
...
if (!is_callable("\\Sodium\\crypto_sign_secretkey")) {
     ...
     * @throws \TypeError
     */
    function crypto_sign_secretkey(#[\SensitiveParameter] $keypair)
    {
...
if (!is_callable("\\Sodium\\crypto_sign_seed_keypair")) {
     ...
     * @throws \TypeError
     */
    function crypto_sign_seed_keypair(#[\SensitiveParameter] $seed)
    {
...
if (!is_callable("\\Sodium\\crypto_sign_ed25519_sk_to_curve25519")) {
     ...
     * @throws \TypeError
     */
    function crypto_sign_ed25519_sk_to_curve25519(#[\SensitiveParameter] $sk)
    {
...
if (!is_callable("\\Sodium\\crypto_stream")) {
     ...
     * @throws \TypeError
     */
    function crypto_stream($len, $nonce, #[\SensitiveParameter] $key)
    {
...
if (!is_callable("\\Sodium\\hex2bin")) {
     ...
     * @throws \TypeError
     */
    function hex2bin(#[\SensitiveParameter] $string)
    {
...
if (!is_callable("\\Sodium\\memcmp")) {
     ...
     * @throws \TypeError
     */
    function memcmp(#[\SensitiveParameter] $a, #[\SensitiveParameter] $b)
    {
...
if (!is_callable("\\Sodium\\memzero")) {
     ...
     */
    function memzero(#[\SensitiveParameter] &$str)
    {
