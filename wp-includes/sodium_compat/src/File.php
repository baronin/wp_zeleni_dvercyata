...
class ParagonIE_Sodium_File extends ParagonIE_Sodium_Core_Util
{
    ...
    public static function box(
        ...
        if (!is_string($nonce)) {
            throw new TypeError(
                "Argument 3 must be a string, " . gettype($nonce) . " given."
            );
        }
        ...
        if (!is_string($keyPair)) {
            throw new TypeError(
                "Argument 4 must be a string, " . gettype($keyPair) . " given."
            );
        }
        if (
            self::strlen($nonce) !==
            ...
            throw new TypeError(
                "Argument 3 must be CRYPTO_BOX_NONCEBYTES bytes"
            );
        }
        if (
            self::strlen($keyPair) !==
            ...
            throw new TypeError(
                "Argument 4 must be CRYPTO_BOX_KEYPAIRBYTES bytes"
            );
        }
    ...
    public static function box_open(
        ...
        if (
            ...
            throw new TypeError(
                "Argument 4 must be CRYPTO_BOX_NONCEBYTES bytes"
            );
        }
        if (
            self::strlen($keypair) !==
    ...
    public static function box_seal(
        ...
        /* Input validation: */
        if (
            self::strlen($publicKey) !==
            ParagonIE_Sodium_Compat::CRYPTO_BOX_PUBLICKEYBYTES
        ) {
            throw new TypeError(
                "Argument 3 must be CRYPTO_BOX_PUBLICKEYBYTES bytes"
            );
        }
        ...
        if (
            $firstWrite !== ParagonIE_Sodium_Compat::CRYPTO_BOX_PUBLICKEYBYTES
        ) {
            ParagonIE_Sodium_Compat::memzero($ephKeypair);
            fclose($ifp);
            fclose($ofp);
            throw new SodiumException(
                "Error writing public key to output file"
            );
        }
    ...
    public static function box_seal_open(
        $inputFile,
        $outputFile,
        #[\SensitiveParameter] $ecdhKeypair
    ) {
        /* Type checks: */
        if (!is_string($inputFile)) {
            throw new TypeError(
        ...
        /* Input validation: */
        if (
            self::strlen($ecdhKeypair) !==
            ParagonIE_Sodium_Compat::CRYPTO_BOX_KEYPAIRBYTES
        ) {
            throw new TypeError(
                "Argument 3 must be CRYPTO_BOX_KEYPAIRBYTES bytes"
            );
        }

        $publicKey = ParagonIE_Sodium_Compat::crypto_box_publickey(
            $ecdhKeypair
        );
        ...
        if (
            self::strlen($ephemeralPK) !==
            ParagonIE_Sodium_Compat::CRYPTO_BOX_PUBLICKEYBYTES
        ) {
            fclose($ifp);
            fclose($ofp);
            throw new SodiumException(
                "Could not read public key from sealed file"
            );
        }
    ...
    public static function generichash(
        ...
        if (!is_string($filePath)) {
            throw new TypeError(
                "Argument 1 must be a string, " . gettype($filePath) . " given."
            );
        }
        if (!is_string($key)) {
            if (is_null($key)) {
                ...
                throw new TypeError(
                    "Argument 2 must be a string, " . gettype($key) . " given."
                );
            }
        }
        ...
        if (!empty($key)) {
            if (
                ...
                throw new TypeError(
                    "Argument 2 must be at least CRYPTO_GENERICHASH_KEYBYTES_MIN bytes"
                );
            }
            if (
                self::strlen($key) >
                ...
                throw new TypeError(
                    "Argument 2 must be at most CRYPTO_GENERICHASH_KEYBYTES_MAX bytes"
                );
            }
        }
        if (
            ...
            throw new SodiumException(
                "Argument 3 must be at least CRYPTO_GENERICHASH_BYTES_MIN"
            );
        }
        if (
            $outputLength >
            ...
            throw new SodiumException(
                "Argument 3 must be at least CRYPTO_GENERICHASH_BYTES_MAX"
            );
        }
    ...
    public static function secretbox(
        ...
        if (
            ...
            throw new TypeError(
                "Argument 3 must be CRYPTO_SECRETBOX_NONCEBYTES bytes"
            );
        }
        if (!is_string($key)) {
            throw new TypeError(
                "Argument 4 must be a string, " . gettype($key) . " given."
            );
        }
        if (
            self::strlen($key) !==
            ...
            throw new TypeError(
                "Argument 4 must be CRYPTO_SECRETBOX_KEYBYTES bytes"
            );
        }
    ...
    public static function secretbox_open(
        ...
        if (
            ...
            throw new TypeError(
                "Argument 4 must be CRYPTO_SECRETBOX_NONCEBYTES bytes"
            );
        }
        if (
            self::strlen($key) !==
            ...
            throw new TypeError(
                "Argument 4 must be CRYPTO_SECRETBOXBOX_KEYBYTES bytes"
            );
        }
     ...
     * @throws TypeError
     */
    public static function sign($filePath, #[\SensitiveParameter] $secretKey)
    {
        /* Type checks: */
        if (!is_string($filePath)) {
            throw new TypeError(
        ...
        /* Input validation: */
        if (
            self::strlen($secretKey) !==
            ParagonIE_Sodium_Compat::CRYPTO_SIGN_SECRETKEYBYTES
        ) {
            throw new TypeError(
                "Argument 2 must be CRYPTO_SIGN_SECRETKEYBYTES bytes"
            );
        }
        if (PHP_INT_SIZE === 4) {
        ...
        /** @var string $nonce */
        $nonce =
            ParagonIE_Sodium_Core_Ed25519::sc_reduce($nonceHash) .
        ...
        /** @var string $sigAfter */
        $sigAfter = ParagonIE_Sodium_Core_Ed25519::sc_muladd(
            $hram,
            $az,
            $nonce
        );
    ...
    public static function verify($sig, $filePath, $publicKey)
    {
        ...
        if (!is_string($sig)) {
            throw new TypeError(
                "Argument 1 must be a string, " . gettype($sig) . " given."
            );
        }
        if (!is_string($filePath)) {
            throw new TypeError(
                "Argument 2 must be a string, " . gettype($filePath) . " given."
            );
        }
        if (!is_string($publicKey)) {
            throw new TypeError(
        ...
        if (
            ...
            throw new TypeError(
                "Argument 3 must be CRYPTO_SIGN_PUBLICKEYBYTES bytes"
            );
        }
        ...
        $A = ParagonIE_Sodium_Core_Ed25519::ge_frombytes_negate_vartime(
            $publicKey
        );
        ...
        /** @var string $h */
        $h =
            ParagonIE_Sodium_Core_Ed25519::sc_reduce($hDigest) .
    ...
    {
        if (PHP_INT_SIZE === 4) {
            return self::secretbox_encrypt_core32(
                $ifp,
                $ofp,
                $mlen,
                $nonce,
        ...
        if (
            $mlen0 >
            64 - ParagonIE_Sodium_Crypto::secretbox_xsalsa20poly1305_ZEROBYTES
        ) {
            $mlen0 =
                64 -
    ...
    {
        if (PHP_INT_SIZE === 4) {
            return self::secretbox_decrypt_core32(
                $ifp,
                $ofp,
                $mlen,
                $nonce,
    ...
    public static function updateHashWithFile($hash, $fp, $size = 0)
    {
        ...
        if (PHP_VERSION_ID < 70200) {
            ...
            if (!is_object($hash)) {
                throw new TypeError(
                    "Argument 1 must be an object (PHP 7.2+), " .
                        gettype($hash) .
                        " given."
                );
            }
        ...
        if (!is_resource($fp)) {
            throw new TypeError(
                "Argument 2 must be a resource, " . gettype($fp) . " given."
            );
        }
        if (!is_int($size)) {
            throw new TypeError(
                "Argument 3 must be an integer, " . gettype($size) . " given."
            );
        }
        ...
        for ($i = 0; $i < $size; $i += self::BUFFER_SIZE) {
            ...
            $message = fread(
                $fp,
                $size - $i > self::BUFFER_SIZE ? $size - $i : self::BUFFER_SIZE
            );
    ...
    private static function sign_core32($filePath, $secretKey)
    {
        ...
        $pk = self::substr($secretKey, 32, 32);
        $nonce =
            ParagonIE_Sodium_Core32_Ed25519::sc_reduce($nonceHash) .
            self::substr($nonceHash, 32);
        ...
        $sigAfter = ParagonIE_Sodium_Core32_Ed25519::sc_muladd(
            $hram,
            $az,
            $nonce
        );
    ...
    public static function verify_core32($sig, $filePath, $publicKey)
    {
        ...
        $A = ParagonIE_Sodium_Core32_Ed25519::ge_frombytes_negate_vartime(
            $publicKey
        );
        ...
        /** @var string $h */
        $h =
            ParagonIE_Sodium_Core32_Ed25519::sc_reduce($hDigest) .
            self::substr($hDigest, 32);
     ...
     * @throws TypeError
     */
    protected static function secretbox_encrypt_core32(
        $ifp,
        $ofp,
        $mlen,
        $nonce,
     ...
     * @throws TypeError
     */
    protected static function secretbox_decrypt_core32(
        $ifp,
        $ofp,
        $mlen,
        $nonce,
