...
class ParagonIE_Sodium_Compat
{
    ...
    public static function add(
        #[\SensitiveParameter] &$val,
        #[\SensitiveParameter] $addv
    ) {
        ...
        try {
            switch ($variant) {
                case self::BASE64_VARIANT_ORIGINAL:
                    return ParagonIE_Sodium_Core_Base64_Original::decode(
                        $encoded,
                        true
                    );
                ...
                default:
                    throw new SodiumException(
                        "invalid base64 variant identifier"
                    );
            }
        } catch (Exception $ex) {
     ...
     * @throws SodiumException
     */
    public static function bin2base64(#[\SensitiveParameter] $decoded, $variant)
    {
        /* Type checks: */
        ...
        switch ($variant) {
            ...
            case self::BASE64_VARIANT_ORIGINAL_NO_PADDING:
                return ParagonIE_Sodium_Core_Base64_Original::encodeUnpadded(
                    $decoded
                );
            case self::BASE64_VARIANT_URLSAFE:
                return ParagonIE_Sodium_Core_Base64_UrlSafe::encode($decoded);
            case self::BASE64_VARIANT_URLSAFE_NO_PADDING:
                return ParagonIE_Sodium_Core_Base64_UrlSafe::encodeUnpadded(
                    $decoded
                );
            default:
     ...
     */
    public static function bin2hex(#[\SensitiveParameter] $string)
    {
        /* Type checks: */
    ...
    public static function compare(
        #[\SensitiveParameter] $left,
        #[\SensitiveParameter] $right
    ) {
        /* Type checks: */
    ...
    public static function crypto_aead_aegis128l_decrypt(
        ...
        /* Input validation: */
        if (
            ParagonIE_Sodium_Core_Util::strlen($nonce) !==
            self::CRYPTO_AEAD_AEGIS128L_NPUBBYTES
        ) {
            throw new SodiumException(
                "Nonce must be CRYPTO_AEAD_AEGIS_128L_NPUBBYTES long"
            );
        }
        if (
            ParagonIE_Sodium_Core_Util::strlen($key) !==
            self::CRYPTO_AEAD_AEGIS128L_KEYBYTES
        ) {
            throw new SodiumException(
                "Key must be CRYPTO_AEAD_AEGIS128L_KEYBYTES long"
            );
        }
        $ct_length = ParagonIE_Sodium_Core_Util::strlen($ciphertext);
        if ($ct_length < self::CRYPTO_AEAD_AEGIS128L_ABYTES) {
            throw new SodiumException(
                "Message must be at least CRYPTO_AEAD_AEGIS128L_ABYTES long"
            );
        }
        ...
        return ParagonIE_Sodium_Core_AEGIS128L::decrypt(
            $ct,
            $tag,
            $assocData,
            $key,
    ...
    public static function crypto_aead_aegis128l_encrypt(
        ...
        if (
            ...
            throw new SodiumException(
                "Nonce must be CRYPTO_AEAD_AEGIS128L_KEYBYTES long"
            );
        }
        if (
            ParagonIE_Sodium_Core_Util::strlen($key) !==
        ...
        list($ct, $tag) = ParagonIE_Sodium_Core_AEGIS128L::encrypt(
            $plaintext,
            $assocData,
            $key,
            $nonce
    ...
    public static function crypto_aead_aegis256_decrypt(
        ...
        if (
            ParagonIE_Sodium_Core_Util::strlen($nonce) !==
            self::CRYPTO_AEAD_AEGIS256_NPUBBYTES
        ) {
            throw new SodiumException(
                "Nonce must be CRYPTO_AEAD_AEGIS256_NPUBBYTES long"
            );
        }
        if (
            ParagonIE_Sodium_Core_Util::strlen($key) !==
            self::CRYPTO_AEAD_AEGIS256_KEYBYTES
        ) {
            throw new SodiumException(
                "Key must be CRYPTO_AEAD_AEGIS256_KEYBYTES long"
            );
        }
        $ct_length = ParagonIE_Sodium_Core_Util::strlen($ciphertext);
        if ($ct_length < self::CRYPTO_AEAD_AEGIS256_ABYTES) {
            throw new SodiumException(
                "Message must be at least CRYPTO_AEAD_AEGIS256_ABYTES long"
            );
        }
        ...
        return ParagonIE_Sodium_Core_AEGIS256::decrypt(
            $ct,
            $tag,
            $assocData,
            $key,
    ...
    public static function crypto_aead_aegis256_encrypt(
        ...
        list($ct, $tag) = ParagonIE_Sodium_Core_AEGIS256::encrypt(
            $plaintext,
            $assocData,
            $key,
            $nonce
    ...
    public static function crypto_aead_aes256gcm_decrypt(
        ...
        if (
            ...
            throw new SodiumException(
                "Nonce must be CRYPTO_AEAD_AES256GCM_NPUBBYTES long"
            );
        }
        if (
            ParagonIE_Sodium_Core_Util::strlen($key) !==
            ...
            throw new SodiumException(
                "Key must be CRYPTO_AEAD_AES256GCM_KEYBYTES long"
            );
        }
        if (
            ParagonIE_Sodium_Core_Util::strlen($ciphertext) <
            self::CRYPTO_AEAD_AES256GCM_ABYTES
        ) {
            throw new SodiumException(
                "Message must be at least CRYPTO_AEAD_AES256GCM_ABYTES long"
            );
        }
        if (!is_callable("openssl_decrypt")) {
            throw new SodiumException(
                "The OpenSSL extension is not installed, or openssl_decrypt() is not available"
            );
        }

        /** @var string $ctext */
        $ctext = ParagonIE_Sodium_Core_Util::substr(
            $ciphertext,
            0,
            -self::CRYPTO_AEAD_AES256GCM_ABYTES
        );
        /** @var string $authTag */
        $authTag = ParagonIE_Sodium_Core_Util::substr(
            $ciphertext,
            -self::CRYPTO_AEAD_AES256GCM_ABYTES,
            16
        );
    ...
    public static function crypto_aead_aes256gcm_encrypt(
        ...
        if (!is_callable("openssl_encrypt")) {
            throw new SodiumException(
                "The OpenSSL extension is not installed, or openssl_encrypt() is not available"
            );
        }
    ...
    public static function crypto_aead_chacha20poly1305_decrypt(
        ...
        if (
            ...
            throw new SodiumException(
                "Nonce must be CRYPTO_AEAD_CHACHA20POLY1305_NPUBBYTES long"
            );
        }
        if (
            ParagonIE_Sodium_Core_Util::strlen($key) !==
            ...
            throw new SodiumException(
                "Key must be CRYPTO_AEAD_CHACHA20POLY1305_KEYBYTES long"
            );
        }
        if (
            ParagonIE_Sodium_Core_Util::strlen($ciphertext) <
            ...
            throw new SodiumException(
                "Message must be at least CRYPTO_AEAD_CHACHA20POLY1305_ABYTES long"
            );
        }
    ...
    public static function crypto_aead_chacha20poly1305_ietf_decrypt(
        ...
        if (
            ...
            throw new SodiumException(
                "Nonce must be CRYPTO_AEAD_CHACHA20POLY1305_IETF_NPUBBYTES long"
            );
        }
        if (
            ParagonIE_Sodium_Core_Util::strlen($key) !==
    ...
    public static function crypto_aead_xchacha20poly1305_ietf_decrypt(
        ...
        if (
            ...
            throw new SodiumException(
                "Nonce must be CRYPTO_AEAD_XCHACHA20POLY1305_IETF_NPUBBYTES long"
            );
        }
        if (
            ParagonIE_Sodium_Core_Util::strlen($key) !==
            ...
            throw new SodiumException(
                "Key must be CRYPTO_AEAD_XCHACHA20POLY1305_IETF_KEYBYTES long"
            );
        }
        if (
            ParagonIE_Sodium_Core_Util::strlen($ciphertext) <
            ...
            throw new SodiumException(
                "Message must be at least CRYPTO_AEAD_XCHACHA20POLY1305_IETF_ABYTES long"
            );
        }
    ...
    public static function crypto_aead_xchacha20poly1305_ietf_encrypt(
        ...
        if (
            ...
            throw new SodiumException(
                "Nonce must be CRYPTO_AEAD_XCHACHA20POLY1305_NPUBBYTES long"
            );
        }
        if (
            ParagonIE_Sodium_Core_Util::strlen($key) !==
            ...
            throw new SodiumException(
                "Key must be CRYPTO_AEAD_XCHACHA20POLY1305_KEYBYTES long"
            );
        }
        if (self::useNewSodiumAPI() && !$dontFallback) {
            if (
     ...
     * @psalm-suppress MixedArgument
     */
    public static function crypto_auth($message, #[\SensitiveParameter] $key)
    {
        /* Type checks: */
        ...
        if (
            ...
            throw new SodiumException(
                "Argument 2 must be CRYPTO_AUTH_KEYBYTES long."
            );
        }
    ...
    public static function crypto_auth_verify(
        ...
        /* Input validation: */
        if (
            ParagonIE_Sodium_Core_Util::strlen($mac) !== self::CRYPTO_AUTH_BYTES
        ) {
            throw new SodiumException(
                "Argument 1 must be CRYPTO_AUTH_BYTES long."
            );
        }
        if (
            ParagonIE_Sodium_Core_Util::strlen($key) !==
            ...
            throw new SodiumException(
                "Argument 3 must be CRYPTO_AUTH_KEYBYTES long."
            );
        }
    ...
    public static function crypto_box(
        ...
        if (
            ...
            throw new SodiumException(
                "Argument 2 must be CRYPTO_BOX_NONCEBYTES long."
            );
        }
        if (
            ParagonIE_Sodium_Core_Util::strlen($keypair) !==
            self::CRYPTO_BOX_KEYPAIRBYTES
        ) {
            throw new SodiumException(
                "Argument 3 must be CRYPTO_BOX_KEYPAIRBYTES long."
            );
        }
    ...
    public static function crypto_box_seal(
        ...
        /* Input validation: */
        if (
            ParagonIE_Sodium_Core_Util::strlen($publicKey) !==
    ...
    public static function crypto_box_seal_open(
        ...
        if (
            ...
            throw new SodiumException(
                "Argument 2 must be CRYPTO_BOX_KEYPAIRBYTES long."
            );
        }
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::box_seal_open(
                $ciphertext,
                $keypair
            );
        }
    ...
    public static function crypto_box_keypair_from_secretkey_and_publickey(
        ...
        /* Input validation: */
        if (
            ParagonIE_Sodium_Core_Util::strlen($secretKey) !==
            self::CRYPTO_BOX_SECRETKEYBYTES
        ) {
            throw new SodiumException(
                "Argument 1 must be CRYPTO_BOX_SECRETKEYBYTES long."
            );
        }
        if (
            ParagonIE_Sodium_Core_Util::strlen($publicKey) !==
        ...
        if (self::useNewSodiumAPI()) {
            return (string) sodium_crypto_box_keypair_from_secretkey_and_publickey(
                $secretKey,
                $publicKey
            );
        }
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::box_keypair_from_secretkey_and_publickey(
                $secretKey,
                $publicKey
            );
        }
        return ParagonIE_Sodium_Crypto::box_keypair_from_secretkey_and_publickey(
            $secretKey,
            $publicKey
        );
    }
    ...
    public static function crypto_box_open(
        ...
        if (
            ...
            throw new SodiumException(
                "Argument 1 must be at least CRYPTO_BOX_MACBYTES long."
            );
        }
        if (
            ParagonIE_Sodium_Core_Util::strlen($nonce) !==
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::box_open(
                $ciphertext,
                $nonce,
                $keypair
            );
     ...
     * @psalm-suppress MixedArgument
     */
    public static function crypto_box_publickey(#[\SensitiveParameter] $keypair)
    {
        /* Type checks: */
        ...
        if (
            ...
            throw new SodiumException(
                "Argument 1 must be CRYPTO_BOX_KEYPAIRBYTES long."
            );
        }
    ...
    public static function crypto_box_publickey_from_secretkey(
        ...
        if (self::useNewSodiumAPI()) {
            return (string) sodium_crypto_box_publickey_from_secretkey(
                $secretKey
            );
        }
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::box_publickey_from_secretkey(
                $secretKey
            );
        }
        return ParagonIE_Sodium_Crypto::box_publickey_from_secretkey(
            $secretKey
        );
    }
     ...
     * @psalm-suppress MixedArgument
     */
    public static function crypto_box_secretkey(#[\SensitiveParameter] $keypair)
    {
        /* Type checks: */
        ParagonIE_Sodium_Core_Util::declareScalarType($keypair, "string", 1);
     ...
     * @psalm-suppress UndefinedFunction
     */
    public static function crypto_box_seed_keypair(#[\SensitiveParameter] $seed)
    {
        /* Type checks: */
    ...
    public static function crypto_generichash(
        ...
        if (!empty($key)) {
            if (
                ...
                throw new SodiumException(
                    "Unsupported key size. Must be at least CRYPTO_GENERICHASH_KEYBYTES_MIN bytes long."
                );
            }
            if (
                ParagonIE_Sodium_Core_Util::strlen($key) >
                ...
                throw new SodiumException(
                    "Unsupported key size. Must be at most CRYPTO_GENERICHASH_KEYBYTES_MAX bytes long."
                );
            }
        }
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::generichash(
                $message,
                $key,
                $length
            );
    ...
    public static function crypto_generichash_final(
        ...
        if (PHP_INT_SIZE === 4) {
            $result = ParagonIE_Sodium_Crypto32::generichash_final(
                $ctx,
                $length
            );
        } else {
    ...
    public static function crypto_generichash_init_salt_personal(
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::generichash_init_salt_personal(
                $key,
                $length,
                $salt,
                $personal
        ...
        return ParagonIE_Sodium_Crypto::generichash_init_salt_personal(
            $key,
            $length,
            $salt,
            $personal
    ...
    public static function crypto_generichash_update(
        ...
        if (PHP_INT_SIZE === 4) {
            $ctx = ParagonIE_Sodium_Crypto32::generichash_update(
                $ctx,
                $message
            );
        } else {
    ...
    public static function crypto_kdf_derive_from_key(
        ...
        if ($subkey_len < self::CRYPTO_KDF_BYTES_MIN) {
            throw new SodiumException(
                "subkey cannot be smaller than SODIUM_CRYPTO_KDF_BYTES_MIN"
            );
        }
        if ($subkey_len > self::CRYPTO_KDF_BYTES_MAX) {
            throw new SodiumException(
                "subkey cannot be larger than SODIUM_CRYPTO_KDF_BYTES_MAX"
            );
        }
        if ($subkey_id < 0) {
        ...
        if (
            ParagonIE_Sodium_Core_Util::strlen($context) !==
    ...
    public static function crypto_kx(
        ...
        /* Input validation: */
        if (
            ParagonIE_Sodium_Core_Util::strlen($my_secret) !==
            self::CRYPTO_BOX_SECRETKEYBYTES
        ) {
            throw new SodiumException(
                "Argument 1 must be CRYPTO_BOX_SECRETKEYBYTES long."
        ...
        if (
            ParagonIE_Sodium_Core_Util::strlen($their_public) !==
            self::CRYPTO_BOX_PUBLICKEYBYTES
        ) {
            throw new SodiumException(
                "Argument 2 must be CRYPTO_BOX_PUBLICKEYBYTES long."
        ...
        if (
            ParagonIE_Sodium_Core_Util::strlen($client_public) !==
            self::CRYPTO_BOX_PUBLICKEYBYTES
        ) {
            throw new SodiumException(
                "Argument 3 must be CRYPTO_BOX_PUBLICKEYBYTES long."
            );
        }
        if (
            ParagonIE_Sodium_Core_Util::strlen($server_public) !==
            self::CRYPTO_BOX_PUBLICKEYBYTES
        ) {
            throw new SodiumException(
                "Argument 4 must be CRYPTO_BOX_PUBLICKEYBYTES long."
            );
        }
     ...
     * @throws SodiumException
     */
    public static function crypto_kx_seed_keypair(#[\SensitiveParameter] $seed)
    {
        ParagonIE_Sodium_Core_Util::declareScalarType($seed, "string", 1);
        ...
        if (
            ParagonIE_Sodium_Core_Util::strlen($seed) !==
            self::CRYPTO_KX_SEEDBYTES
        ) {
            throw new SodiumException(
                "seed must be SODIUM_CRYPTO_KX_SEEDBYTES bytes"
            );
        }
    ...
    public static function crypto_kx_client_session_keys(
        ...
        if (
            ParagonIE_Sodium_Core_Util::strlen($serverPublicKey) !==
            self::CRYPTO_KX_PUBLICKEYBYTES
        ) {
            throw new SodiumException(
                "public keys must be SODIUM_CRYPTO_KX_PUBLICKEYBYTES bytes"
            );
        }

        $sk = self::crypto_kx_secretkey($keypair);
        $pk = self::crypto_kx_publickey($keypair);
        $h = self::crypto_generichash_init(
            null,
            self::CRYPTO_KX_SESSIONKEYBYTES * 2
        );
        self::crypto_generichash_update(
            $h,
            self::crypto_scalarmult($sk, $serverPublicKey)
        );
        self::crypto_generichash_update($h, $pk);
        self::crypto_generichash_update($h, $serverPublicKey);
        $sessionKeys = self::crypto_generichash_final(
            $h,
            self::CRYPTO_KX_SESSIONKEYBYTES * 2
        );
        return [
    ...
    public static function crypto_kx_server_session_keys(
        ...
        if (
            ParagonIE_Sodium_Core_Util::strlen($clientPublicKey) !==
            self::CRYPTO_KX_PUBLICKEYBYTES
        ) {
            throw new SodiumException(
                "public keys must be SODIUM_CRYPTO_KX_PUBLICKEYBYTES bytes"
        ...
        self::crypto_generichash_update(
            $h,
            self::crypto_scalarmult($sk, $clientPublicKey)
        );
     ...
     * @throws SodiumException
     */
    public static function crypto_kx_secretkey(#[\SensitiveParameter] $kp)
    {
    ...
    public static function crypto_scalarmult(
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::scalarmult(
                $secretKey,
                $publicKey
            );
        }
    ...
    public static function crypto_secretbox(
        ...
        if (
            ...
            throw new SodiumException(
                "Argument 2 must be CRYPTO_SECRETBOX_NONCEBYTES long."
            );
        }
        if (
            ParagonIE_Sodium_Core_Util::strlen($key) !==
            ...
            throw new SodiumException(
                "Argument 3 must be CRYPTO_SECRETBOX_KEYBYTES long."
            );
        }
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::secretbox(
                $plaintext,
                $nonce,
                $key
            );
    ...
    public static function crypto_secretbox_open(
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::secretbox_open(
                $ciphertext,
                $nonce,
                $key
            );
        }
        return ParagonIE_Sodium_Crypto::secretbox_open(
            $ciphertext,
            $nonce,
            $key
        );
    ...
    public static function crypto_secretbox_xchacha20poly1305(
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::secretbox_xchacha20poly1305(
                $plaintext,
                $nonce,
                $key
            );
        }
        return ParagonIE_Sodium_Crypto::secretbox_xchacha20poly1305(
            $plaintext,
            $nonce,
            $key
        );
    ...
    public static function crypto_secretbox_xchacha20poly1305_open(
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::secretbox_xchacha20poly1305_open(
                $ciphertext,
                $nonce,
                $key
            );
        }
        return ParagonIE_Sodium_Crypto::secretbox_xchacha20poly1305_open(
            $ciphertext,
            $nonce,
            $key
        );
    ...
    public static function crypto_secretstream_xchacha20poly1305_init_push(
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::secretstream_xchacha20poly1305_init_push(
                $key
            );
        }
        return ParagonIE_Sodium_Crypto::secretstream_xchacha20poly1305_init_push(
            $key
        );
    }
    ...
    public static function crypto_secretstream_xchacha20poly1305_init_pull(
        ...
        if (
            ParagonIE_Sodium_Core_Util::strlen($header) <
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::secretstream_xchacha20poly1305_init_pull(
                $key,
                $header
            );
        }
        return ParagonIE_Sodium_Crypto::secretstream_xchacha20poly1305_init_pull(
            $key,
            $header
        );
    }
    ...
    {
        return random_bytes(
            self::CRYPTO_SECRETSTREAM_XCHACHA20POLY1305_KEYBYTES
        );
    }
    ...
    public static function crypto_shorthash(
        ...
        if (
            ...
            throw new SodiumException(
                "Argument 2 must be CRYPTO_SHORTHASH_KEYBYTES long."
            );
        }
    ...
    public static function crypto_sign_open($signedMessage, $publicKey)
    {
        ...
        /* Input validation: */
        if (
            ParagonIE_Sodium_Core_Util::strlen($signedMessage) <
        ...
        if (
            ...
            throw new SodiumException(
                "Argument 2 must be CRYPTO_SIGN_PUBLICKEYBYTES long."
            );
        }
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::sign_open(
                $signedMessage,
                $publicKey
            );
        }
    ...
    public static function crypto_sign_keypair_from_secretkey_and_publickey(
        ...
        if (
            ParagonIE_Sodium_Core_Util::strlen($sk) !==
            self::CRYPTO_SIGN_SECRETKEYBYTES
        ) {
            throw new SodiumException(
        ...
        if (
            ParagonIE_Sodium_Core_Util::strlen($pk) !==
            self::CRYPTO_SIGN_PUBLICKEYBYTES
        ) {
            throw new SodiumException(
    ...
    public static function crypto_sign_publickey(
        ...
        if (
            ...
            throw new SodiumException(
                "Argument 1 must be CRYPTO_SIGN_KEYPAIRBYTES long."
            );
        }
    ...
    public static function crypto_sign_publickey_from_secretkey(
        ...
        if (
            ...
            throw new SodiumException(
                "Argument 1 must be CRYPTO_SIGN_SECRETKEYBYTES long."
            );
        }
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Core32_Ed25519::publickey_from_secretkey(
                $secretKey
            );
        }
        return ParagonIE_Sodium_Core_Ed25519::publickey_from_secretkey(
            $secretKey
        );
    }
    ...
    public static function crypto_sign_detached(
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::sign_detached(
                $message,
                $secretKey
            );
        }
    ...
    public static function crypto_sign_verify_detached(
        ...
        /* Input validation: */
        if (
            ParagonIE_Sodium_Core_Util::strlen($signature) !==
            self::CRYPTO_SIGN_BYTES
        ) {
            throw new SodiumException(
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Crypto32::sign_verify_detached(
                $signature,
                $message,
                $publicKey
            );
        }
        return ParagonIE_Sodium_Crypto::sign_verify_detached(
            $signature,
            $message,
            $publicKey
        );
    ...
    public static function crypto_sign_ed25519_pk_to_curve25519($pk)
    {
        ...
        if (
            ...
            throw new SodiumException(
                "Argument 1 must be at least CRYPTO_SIGN_PUBLICKEYBYTES long."
            );
        }
        if (self::useNewSodiumAPI()) {
            if (is_callable("crypto_sign_ed25519_pk_to_curve25519")) {
                return (string) sodium_crypto_sign_ed25519_pk_to_curve25519(
                    $pk
                );
            }
        }
    ...
    public static function crypto_sign_ed25519_sk_to_curve25519(
        ...
        if (
            ...
            throw new SodiumException(
                "Argument 1 must be at least CRYPTO_SIGN_SEEDBYTES long."
            );
        }
        if (self::useNewSodiumAPI()) {
        ...
        $h = hash(
            "sha512",
            ParagonIE_Sodium_Core_Util::substr($sk, 0, 32),
            true
        );
    ...
    public static function crypto_stream(
        ...
        if (
            ...
            throw new SodiumException(
                "Argument 3 must be CRYPTO_STREAM_KEYBYTES long."
            );
        }
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Core32_XSalsa20::xsalsa20(
                $len,
                $nonce,
                $key
            );
    ...
    public static function crypto_stream_xor(
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Core32_XSalsa20::xsalsa20_xor(
                $message,
                $nonce,
                $key
            );
        }
        return ParagonIE_Sodium_Core_XSalsa20::xsalsa20_xor(
            $message,
            $nonce,
            $key
        );
    ...
    public static function crypto_stream_xchacha20(
        ...
        if (
            ParagonIE_Sodium_Core_Util::strlen($nonce) !==
            self::CRYPTO_STREAM_XCHACHA20_NONCEBYTES
        ) {
            throw new SodiumException(
                "Argument 2 must be CRYPTO_SECRETBOX_XCHACHA20_NONCEBYTES long."
            );
        }
        if (
            ParagonIE_Sodium_Core_Util::strlen($key) !==
            self::CRYPTO_STREAM_XCHACHA20_KEYBYTES
        ) {
            throw new SodiumException(
                "Argument 3 must be CRYPTO_STREAM_XCHACHA20_KEYBYTES long."
            );
        }
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Core32_XChaCha20::stream(
                $len,
                $nonce,
                $key
            );
    ...
    public static function crypto_stream_xchacha20_xor(
        ...
        if (
            ...
            throw new SodiumException(
                "Argument 3 must be CRYPTO_SECRETBOX_XCHACHA20_KEYBYTES long."
            );
        }
        ...
        if (PHP_INT_SIZE === 4) {
            return ParagonIE_Sodium_Core32_XChaCha20::streamXorIc(
                $message,
                $nonce,
                $key
            );
        }
        return ParagonIE_Sodium_Core_XChaCha20::streamXorIc(
            $message,
            $nonce,
            $key
        );
    ...
    public static function crypto_stream_xchacha20_xor_ic(
        ...
        if (
            ...
            return sodium_crypto_stream_xchacha20_xor_ic(
                $message,
                $nonce,
                $counter,
                $key
     ...
     * @psalm-suppress MixedArgument
     */
    public static function hex2bin(#[\SensitiveParameter] $string, $ignore = "")
    {
        /* Type checks: */
        ParagonIE_Sodium_Core_Util::declareScalarType($string, "string", 1);
     ...
     * @psalm-suppress MixedArgument
     */
    public static function increment(#[\SensitiveParameter] &$var)
    {
        /* Type checks: */
     ...
     * @throws SodiumException
     */
    public static function is_zero(#[\SensitiveParameter] $str)
    {
        $d = 0;
        for ($i = 0; $i < 32; ++$i) {
     ...
     * @psalm-suppress TooFewArguments
     */
    public static function memzero(#[\SensitiveParameter] &$var)
    {
        /* Type checks: */
        ParagonIE_Sodium_Core_Util::declareScalarType($var, "string", 1);
    ...
    public static function ristretto255_is_valid_point(
        ...
        try {
            ...
            return $r["res"] === 0 &&
                ParagonIE_Sodium_Core_Ristretto255::ristretto255_point_is_canonical(
                    $p
                ) === 1;
        } catch (SodiumException $ex) {
    ...
    public static function ristretto255_scalar_invert(
        #[\SensitiveParameter] $s,
        $dontFallback = false
    ) {
        if (self::useNewSodiumAPI() && !$dontFallback) {
            return sodium_crypto_core_ristretto255_scalar_invert($s);
        }
        return ParagonIE_Sodium_Core_Ristretto255::ristretto255_scalar_invert(
            $s
        );
    }
    /**
    ...
    public static function ristretto255_scalar_negate(
        ...
        return ParagonIE_Sodium_Core_Ristretto255::ristretto255_scalar_negate(
            $s
        );
    }
    ...
    public static function ristretto255_scalar_complement(
        ...
        return ParagonIE_Sodium_Core_Ristretto255::ristretto255_scalar_complement(
            $s
        );
    }
    ...
    public static function ristretto255_scalar_add(
        #[\SensitiveParameter] $x,
        #[\SensitiveParameter] $y,
        $dontFallback = false
    ) {
        if (self::useNewSodiumAPI() && !$dontFallback) {
            return sodium_crypto_core_ristretto255_scalar_add($x, $y);
        }
        return ParagonIE_Sodium_Core_Ristretto255::ristretto255_scalar_add(
            $x,
            $y
        );
    }
    ...
    public static function ristretto255_scalar_sub(
        ...
        return ParagonIE_Sodium_Core_Ristretto255::ristretto255_scalar_sub(
            $x,
            $y
        );
    }
    ...
    public static function ristretto255_scalar_mul(
        ...
        return ParagonIE_Sodium_Core_Ristretto255::ristretto255_scalar_mul(
            $x,
            $y
        );
    }
    ...
    public static function scalarmult_ristretto255(
        ...
        return ParagonIE_Sodium_Core_Ristretto255::scalarmult_ristretto255(
            $n,
            $p
        );
    }
    ...
    public static function scalarmult_ristretto255_base(
        ...
        return ParagonIE_Sodium_Core_Ristretto255::scalarmult_ristretto255_base(
            $n
        );
    }
