...
class ParagonIE_Sodium_Core_AES_Block extends SplFixedArray
{
    ...
    public function mixColumns()
    {
        ...
        $this->values[1] =
            $q0 ^ $r0 ^ $q7 ^ $r7 ^ $r1 ^ self::rotr16($q1 ^ $r1);
        $this->values[2] = $q1 ^ $r1 ^ $r2 ^ self::rotr16($q2 ^ $r2);
        $this->values[3] =
            $q2 ^ $r2 ^ $q7 ^ $r7 ^ $r3 ^ self::rotr16($q3 ^ $r3);
        $this->values[4] =
            $q3 ^ $r3 ^ $q7 ^ $r7 ^ $r4 ^ self::rotr16($q4 ^ $r4);
    ...
    public function inverseMixColumns()
    {
        ...
        $this->values[4] =
            ...
            $r6 ^
            $r7 ^
            self::rotr16($q1 ^ $q2 ^ $q4 ^ $q5 ^ $q7 ^ $r1 ^ $r4 ^ $r5 ^ $r6);
        $this->values[5] =
            $q2 ^
            $q3 ^
            $q4 ^
            ...
            $r6 ^
            $r7 ^
            self::rotr16($q2 ^ $q3 ^ $q5 ^ $q6 ^ $r2 ^ $r5 ^ $r6 ^ $r7);
        $this->values[6] =
            $q3 ^
            $q4 ^
            $q5 ^
            ...
            $r6 ^
            $r7 ^
            self::rotr16($q3 ^ $q4 ^ $q6 ^ $q7 ^ $r3 ^ $r6 ^ $r7);
        $this->values[7] =
            $q4 ^
            $q5 ^
            $q6 ^
