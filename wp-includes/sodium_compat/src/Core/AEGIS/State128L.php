...
if (!defined("SODIUM_COMPAT_AEGIS_C0")) {
    define(
        ...
        "\x00\x01\x01\x02\x03\x05\x08\x0d\x15\x22\x37\x59\x90\xe9\x79\x62"
    );
}
if (!defined("SODIUM_COMPAT_AEGIS_C1")) {
    define(
        "SODIUM_COMPAT_AEGIS_C1",
        "\xdb\x3d\x18\x55\x6d\xc2\x2f\xf1\x20\x11\x31\x42\x73\xb5\x28\xdd"
    );
}
...
class ParagonIE_Sodium_Core_AEGIS_State128L
{
    ...
    {
        $encoded =
            ParagonIE_Sodium_Core_Util::store64_le($ad_len_bits) .
