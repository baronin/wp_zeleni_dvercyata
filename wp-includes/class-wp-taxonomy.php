...
final class WP_Taxonomy
{
    ...
    public function set_props($object_type, $args)
    {
        ...
        if (
            ...
            (is_admin() || false !== $args["publicly_queryable"])
        ) {
        ...
        if (
            ...
            if (empty($args["rewrite"]["slug"])) {
                $args["rewrite"]["slug"] = sanitize_title_with_dashes(
                    $this->name
                );
            }
        }
    ...
    public static function get_default_labels()
    {
        ...
        self::$default_labels = [
            ...
            "add_new_item" => [__("Add Tag"), __("Add Category")],
            ...
            "most_used" => [
                _x("Most Used", "tags"),
                _x("Most Used", "categories"),
            ],
            "back_to_items" => [
                __("&larr; Go to Tags"),
                __("&larr; Go to Categories"),
            ],
            "item_link" => [
