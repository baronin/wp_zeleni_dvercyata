...
final class WP_Translation_Controller
{
    ...
    public function load_file(
        ...
        if (
            isset(
                $this->loaded_files[$translation_file][$locale][$textdomain]
            ) &&
            false !==
                $this->loaded_files[$translation_file][$locale][$textdomain]
        ) {
            ...
            if (isset($this->loaded_translations[$locale][$textdomain])) {
                foreach (
                    ...
                    if ($file === $moe || $file === $moe->get_file()) {
                        ...
                        unset(
                            $this->loaded_files[$moe->get_file()][$locale][
                                $textdomain
                            ]
                        );
                        return true;
     ...
     */
    public function is_textdomain_loaded(
        string $textdomain = "default",
        ?string $locale = null
    ): bool {
        if (null === $locale) {
    ...
    public function translate(
        ...
        $translation = $this->locate_translation(
            "{$context}{$text}",
            $textdomain,
            $locale
        );
     ...
     * }
     */
    protected function locate_translation(
        string $singular,
        string $textdomain = "default",
        ?string $locale = null
    ) {
    ...
    public function has_translation(
        ...
        return false !==
            $this->locate_translation($singular, $textdomain, $locale);
    }
}
