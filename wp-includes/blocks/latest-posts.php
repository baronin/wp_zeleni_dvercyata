...
function render_block_core_latest_posts($attributes)
{
    ...
    if (
        isset($attributes["displayFeaturedImage"]) &&
    ...
    foreach ($recent_posts as $post) {
        ...
        if (
            isset($attributes["displayAuthor"]) &&
        ...
        if (
            isset($attributes["displayPostDate"]) &&
        ...
        if (
            ...
            if (str_ends_with($trimmed_excerpt, " [&hellip;]")) {
                ...
                if (
                    $excerpt_length <= $block_core_latest_posts_excerpt_length
                ) {
