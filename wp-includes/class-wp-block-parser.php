...
class WP_Block_Parser
{
    ...
    public function proceed()
    {
        ...
        $leading_html_start =
            $start_offset > $this->offset ? $this->offset : null;
        ...
        switch ($token_type) {
            ...
            case "void-block":
                ...
                if (0 === $stack_depth) {
                    ...
                    $this->output[] = (array) new WP_Block_Parser_Block(
                        $block_name,
                        $attrs,
                        [],
                        "",
    ...
    public function next_token()
    {
        ...
        $namespace =
            isset($namespace) && -1 !== $namespace[1] ? $namespace[0] : "core/";
    ...
    {
        return new WP_Block_Parser_Block(null, [], [], $inner_html, [
            $inner_html,
        ]);
    }
    ...
    public function add_freeform($length = null)
    {
        ...
        $this->output[] = (array) $this->freeform(
            substr($this->document, $this->offset, $length)
        );
    }
    ...
    public function add_inner_block(
        ...
        $html = substr(
            $this->document,
            $parent->prev_offset,
            $token_start - $parent->prev_offset
        );
        ...
        $parent->prev_offset = $last_offset
            ? $last_offset
