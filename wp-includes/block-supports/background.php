...
function wp_register_background_support($block_type)
{
    ...
    $has_background_support = block_has_support(
        $block_type,
        ["background"],
        false
    );
...
function wp_render_background_support($block_content, $block)
{
    ...
    $block_attributes =
        isset($block["attrs"]) && is_array($block["attrs"])
            ? $block["attrs"]
            : [];
    $has_background_image_support = block_has_support(
        $block_type,
    ...
    $background_styles = [];
    $background_styles["backgroundImage"] =
        $block_attributes["style"]["background"]["backgroundImage"] ?? null;
    $background_styles["backgroundSize"] =
        $block_attributes["style"]["background"]["backgroundSize"] ?? null;
    $background_styles["backgroundPosition"] =
        $block_attributes["style"]["background"]["backgroundPosition"] ?? null;
    $background_styles["backgroundRepeat"] =
        $block_attributes["style"]["background"]["backgroundRepeat"] ?? null;
    $background_styles["backgroundAttachment"] =
    ...
    if (!empty($background_styles["backgroundImage"])) {
        ...
        if (
            "contain" === $background_styles["backgroundSize"] &&
            !$background_styles["backgroundPosition"]
        ) {
...
WP_Block_Supports::get_instance()->register("background", [
