...
function wp_render_position_support($block_content, $block)
{
    ...
    $theme_has_sticky_support = isset($global_settings["position"]["sticky"])
        ? $global_settings["position"]["sticky"]
        : false;
    $theme_has_fixed_support = isset($global_settings["position"]["fixed"])
        ? $global_settings["position"]["fixed"]
        : false;
