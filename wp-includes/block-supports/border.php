...
function wp_register_border_support($block_type)
{
    ...
    if (
        ...
        !array_key_exists("borderColor", $block_type->attributes)
    ) {
...
function wp_apply_border_support($block_type, $block_attributes)
{
    ...
    $border_block_styles = [];
    $has_border_color_support = wp_has_border_feature_support(
        $block_type,
        "color"
    );
    $has_border_width_support = wp_has_border_feature_support(
        $block_type,
        "width"
    );
    ...
    if (
        ...
        $border_block_styles["style"] =
            $block_attributes["style"]["border"]["style"];
    }
    ...
    if (
        ...
        $preset_border_color = array_key_exists(
            "borderColor",
            $block_attributes
        )
            ? "var:preset|color|{$block_attributes["borderColor"]}"
            : null;
        $custom_border_color = isset(
            $block_attributes["style"]["border"]["color"]
        )
            ? $block_attributes["style"]["border"]["color"]
            : null;
        $border_block_styles["color"] = $preset_border_color
            ? $preset_border_color
            : $custom_border_color;
    }
...
function wp_has_border_feature_support(
    ...
    if ($block_type instanceof WP_Block_Type) {
        $block_type_supports_border = isset(
    ...
    return block_has_support(
        $block_type,
        ["__experimentalBorder", $feature],
        $default_value
    );
}
