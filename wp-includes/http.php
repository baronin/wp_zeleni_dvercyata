...
function wp_http_supports($capabilities = [], $url = null)
{
    ...
    if (
        $count &&
        count(array_filter(array_keys($capabilities), "is_numeric")) === $count
    ) {
...
function ms_allowed_http_request_hosts($is_external, $host)
{
    ...
    $queried[$host] = (bool) $wpdb->get_var(
        $wpdb->prepare(
