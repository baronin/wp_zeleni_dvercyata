...
class WP_Block_Supports
{
    ...
    public function apply_block_supports()
    {
        ...
        $block_attributes =
            array_key_exists("attrs", self::$block_to_render) &&
            is_array(self::$block_to_render["attrs"])
                ? $block_type->prepare_attributes_for_render(
...
function get_block_wrapper_attributes($extra_attributes = [])
{
    ...
    $attributes_to_merge = ["style", "class", "id", "aria-label"];
    $attributes = [];
    foreach ($attributes_to_merge as $attribute_name) {
        if (
            empty($new_attributes[$attribute_name]) &&
            empty($extra_attributes[$attribute_name])
        ) {
            continue;
        }
        ...
        $attributes[$attribute_name] =
            $extra_attributes[$attribute_name] .
            " " .
