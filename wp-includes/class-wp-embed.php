...
<script type="text/javascript">
    ...
    public function get_embed_handler_html($attr, $url)
    {
        ...
        foreach ($this->handlers as $priority => $handlers) {
            foreach ($handlers as $id => $handler) {
                if (
                    preg_match($handler["regex"], $url, $matches) &&
    ...
    public function shortcode($attr, $url = "")
    {
        ...
        if ($post_id) {
            ...
            $has_kses =
                false !== has_filter("content_save_pre", "wp_filter_post_kses");
    ...
    public function cache_oembed($post_id)
    {
         ...
         */
        $cache_oembed_types = apply_filters(
    ...
    public function find_oembed_post_id($cache_key)
    {
        ...
        if (
            $oembed_post_id &&
            "oembed_cache" === get_post_type($oembed_post_id)
        ) {
