...
class Walker_Page extends Walker
{
    ...
    public function start_el(
        ...
        if (!empty($current_page_id)) {
            ...
            if (
                $_current_page &&
                in_array($page->ID, $_current_page->ancestors, true)
            ) {
        ...
        $args["link_before"] = empty($args["link_before"])
            ? ""
            : $args["link_before"];
        $args["link_after"] = empty($args["link_after"])
            ? ""
            : $args["link_after"];
        ...
        $atts["aria-current"] =
            $page->ID === (int) $current_page_id ? "page" : "";
        ...
        if (!empty($args["show_date"])) {
            ...
            $date_format = empty($args["date_format"])
                ? ""
                : $args["date_format"];
