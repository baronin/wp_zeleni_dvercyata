...
class WP_User
{
    ...
    protected function _init_caps($cap_key = "")
    {
        ...
        if (empty($cap_key)) {
            $this->cap_key =
                $wpdb->get_blog_prefix($this->site_id) . "capabilities";
        } else {
    ...
    public function get_role_caps()
    {
        ...
        if (is_array($this->caps)) {
            $this->roles = array_filter(array_keys($this->caps), [
                $wp_roles,
                "is_role",
            ]);
        }
    ...
    {
        global $wpdb;
        $this->user_level = array_reduce(
            array_keys($this->allcaps),
            [$this, "level_reduction"],
            0
        );
        update_user_meta(
            $this->ID,
