...
class MagpieRSS
{
    ...
    function __construct($source)
    {
        ...
        xml_set_element_handler(
            $this->parser,
            [$this, "feed_start_element"],
            [$this, "feed_end_element"]
        );
    ...
    function feed_start_element($p, $element, &$attrs)
    {
        ...
        elseif (
            $this->feed_type == ATOM and
            in_array($el, $this->_CONTENT_CONSTRUCTS)
        ) {
            ...
            if (isset($resp) and $resp) {
                if ($resp->status == "304") {
                    ...
                    if ($resp->error) {
                        ...
                        $errormsg .=
                            "(HTTP Response: " . $resp->response_code . ")";
                    }
                }
            } else {
