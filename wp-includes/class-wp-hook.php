...
final class WP_Hook implements Iterator, ArrayAccess
{
    ...
    private function resort_active_iterations(
        ...
        foreach ($this->iterations as $index => &$iteration) {
            ...
            if (
                $new_priority === $this->current_priority[$index] &&
                !$priority_existed
            ) {
                /*
    ...
    {
        $function_key = _wp_filter_build_unique_id(
            $hook_name,
            $callback,
            $priority
        );
    ...
    public function apply_filters($value, $args)
    {
        ...
        do {
            $this->current_priority[$nesting_level] = current(
            ...
            foreach ($this->callbacks[$priority] as $the_) {
                ...
                if (0 === $the_["accepted_args"]) {
                    ...
                    $value = call_user_func_array(
                        $the_["function"],
                        array_slice($args, 0, $the_["accepted_args"])
                    );
                }
            }
