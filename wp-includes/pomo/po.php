    ...
    class PO extends Gettext_Translations
    {
        ...
        public function export_headers()
        {
            ...
            if ($this->comments_before_headers) {
                $before_headers = $this->prepend_each_line(
        ...
        public static function poify($input_string)
        {
            ...
            $po =
                ...
                implode(
                    ...
                    explode($newline, $input_string)
                ) .
                $quote;
            // Add empty string on first line for readability.
            if (
                str_contains($input_string, $newline) &&
                (substr_count($input_string, $newline) > 1 ||
                    substr($input_string, -strlen($newline)) !== $newline)
            ) {
        ...
        public static function export_entry($entry)
        {
            ...
            if (!$entry->is_plural) {
                ...
                $translation = PO::match_begin_and_end_newlines(
                    $translation,
                    $entry->singular
                );
