...
class getid3_mp3 extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        if (
            (isset($info["id3v2"]["headerlength"]) &&
                $info["avdataoffset"] > $info["id3v2"]["headerlength"]) ||
            (!isset($info["id3v2"]) &&
                $info["avdataoffset"] > 0 &&
                $info["avdataoffset"] != $initialOffset)
        ) {
            ...
            $synchoffsetwarning .=
                "synch detected at " . $info["avdataoffset"] . ")";
            if (
                isset($info["audio"]["bitrate_mode"]) &&
                $info["audio"]["bitrate_mode"] == "cbr"
            ) {
                if (
                    !empty($info["id3v2"]["headerlength"]) &&
                    $info["avdataoffset"] - $info["id3v2"]["headerlength"] ==
                        $info["mpeg"]["audio"]["framelength"]
                ) {
                    $synchoffsetwarning .=
        ...
        if (isset($info["mpeg"]["audio"]["LAME"])) {
            ...
            if (!empty($info["mpeg"]["audio"]["LAME"]["long_version"])) {
                $info["audio"]["encoder"] = rtrim(
                    $info["mpeg"]["audio"]["LAME"]["long_version"],
                    "\x00"
                );
        ...
        $CurrentDataLAMEversionString = !empty($CurrentDataLAMEversionString)
            ? $CurrentDataLAMEversionString
            : (isset($info["audio"]["encoder"])
                ? $info["audio"]["encoder"]
                : "");
        if (
            !empty($CurrentDataLAMEversionString) &&
            substr($CurrentDataLAMEversionString, 0, 6) == "LAME3." &&
            !preg_match("[0-9\)]", substr($CurrentDataLAMEversionString, -1))
        ) {
            ...
            $PossiblyLongerLAMEversion_Data = $this->fread(
            ...
            switch (substr($CurrentDataLAMEversionString, -1)) {
                ...
                case "b":
                    ...
                    $CurrentDataLAMEversionString = substr(
                        $CurrentDataLAMEversionString,
                        0,
                        -1
                    );
            ...
            if (
                ($PossiblyLongerLAMEversion_String = strstr(
                ...
                if (
                    ...
                    $PossiblyLongerLAMEversion_NewString = substr(
                        $PossiblyLongerLAMEversion_String,
                        0,
                        strspn(
                            $PossiblyLongerLAMEversion_String,
                    ...
                    if (
                        empty($info["audio"]["encoder"]) ||
                        strlen($PossiblyLongerLAMEversion_NewString) >
        ...
        switch (
            isset($info["mpeg"]["audio"]["layer"])
                ? $info["mpeg"]["audio"]["layer"]
                : ""
        ) {
            case 1:
            case 2:
                $info["audio"]["dataformat"] =
                    "mp" . $info["mpeg"]["audio"]["layer"];
                break;
        }
        if (isset($info["fileformat"]) && $info["fileformat"] == "mp3") {
            switch ($info["audio"]["dataformat"]) {
                ...
                default:
                    $this->warning(
                        'Expecting [audio][dataformat] to be mp1/mp2/mp3 when fileformat == mp3, [audio][dataformat] actually "' .
                            $info["audio"]["dataformat"] .
                            '"'
                    );
                    break;
        ...
        if (
            ...
            $xingVBRheaderFrameLength =
                isset($info["mpeg"]["audio"]["VBR_frames"]) &&
                isset($info["mpeg"]["audio"]["framelength"])
                    ? $info["mpeg"]["audio"]["framelength"]
                    : 0;
    ...
    public function GuessEncoderOptions()
    {
        ...
        if (
            isset($thisfile_mpeg_audio["VBR_method"]) &&
            $thisfile_mpeg_audio["VBR_method"] == "Fraunhofer" &&
            !empty($thisfile_mpeg_audio["VBR_quality"])
        ) {
            $encoder_options = "VBR q" . $thisfile_mpeg_audio["VBR_quality"];
        } elseif (
            !empty($thisfile_mpeg_audio_lame["preset_used"]) &&
            isset($thisfile_mpeg_audio_lame["preset_used_id"]) &&
            !in_array(
                $thisfile_mpeg_audio_lame["preset_used_id"],
                $NamedPresetBitrates
            )
        ) {
            ...
            if (empty($KnownEncoderValues)) {
                ...
                $KnownEncoderValues[0xff][58][1][1][3][2][20500] =
                    "--alt-preset insane"; // 3.90,   3.90.1, 3.92
                $KnownEncoderValues[0xff][58][1][1][3][2][20600] =
                    "--alt-preset insane"; // 3.90.2, 3.90.3, 3.91
                $KnownEncoderValues[0xff][57][1][1][3][4][20500] =
                    "--alt-preset insane"; // 3.94,   3.95
                $KnownEncoderValues["**"][78][3][2][3][2][19500] =
                    "--alt-preset extreme"; // 3.90,   3.90.1, 3.92
                $KnownEncoderValues["**"][78][3][2][3][2][19600] =
                    "--alt-preset extreme"; // 3.90.2, 3.91
                $KnownEncoderValues["**"][78][3][1][3][2][19600] =
                    "--alt-preset extreme"; // 3.90.3
                $KnownEncoderValues["**"][78][4][2][3][2][19500] =
                    "--alt-preset fast extreme"; // 3.90,   3.90.1, 3.92
                $KnownEncoderValues["**"][78][4][2][3][2][19600] =
                    "--alt-preset fast extreme"; // 3.90.2, 3.90.3, 3.91
                $KnownEncoderValues["**"][78][3][2][3][4][19000] =
                    "--alt-preset standard"; // 3.90,   3.90.1, 3.90.2, 3.91, 3.92
                $KnownEncoderValues["**"][78][3][1][3][4][19000] =
                    "--alt-preset standard"; // 3.90.3
                $KnownEncoderValues["**"][78][4][2][3][4][19000] =
                    "--alt-preset fast standard"; // 3.90,   3.90.1, 3.90.2, 3.91, 3.92
                $KnownEncoderValues["**"][78][4][1][3][4][19000] =
                    "--alt-preset fast standard"; // 3.90.3
                ...
                $KnownEncoderValues["**"][68][3][2][3][4][18000] =
                    "--alt-preset medium"; // 3.90.3
                $KnownEncoderValues["**"][68][4][2][3][4][18000] =
                    "--alt-preset fast medium"; // 3.90.3

                $KnownEncoderValues[0xff][99][1][1][1][2][0] =
                    "--preset studio"; // 3.90,   3.90.1, 3.90.2, 3.91, 3.92
                $KnownEncoderValues[0xff][58][2][1][3][2][20600] =
                    "--preset studio"; // 3.90.3, 3.93.1
                $KnownEncoderValues[0xff][58][2][1][3][2][20500] =
                    "--preset studio"; // 3.93
                $KnownEncoderValues[0xff][57][2][1][3][4][20500] =
                    "--preset studio"; // 3.94,   3.95
                $KnownEncoderValues[0xc0][88][1][1][1][2][0] = "--preset cd"; // 3.90,   3.90.1, 3.90.2,   3.91, 3.92
                $KnownEncoderValues[0xc0][58][2][2][3][2][19600] =
                    "--preset cd"; // 3.90.3, 3.93.1
                $KnownEncoderValues[0xc0][58][2][2][3][2][19500] =
                    "--preset cd"; // 3.93
                $KnownEncoderValues[0xc0][57][2][1][3][4][19500] =
                    "--preset cd"; // 3.94,   3.95
                $KnownEncoderValues[0xa0][78][1][1][3][2][18000] =
                    "--preset hifi"; // 3.90,   3.90.1, 3.90.2,   3.91, 3.92
                $KnownEncoderValues[0xa0][58][2][2][3][2][18000] =
                    "--preset hifi"; // 3.90.3, 3.93,   3.93.1
                $KnownEncoderValues[0xa0][57][2][1][3][4][18000] =
                    "--preset hifi"; // 3.94,   3.95
                $KnownEncoderValues[0x80][67][1][1][3][2][18000] =
                    "--preset tape"; // 3.90,   3.90.1, 3.90.2,   3.91, 3.92
                $KnownEncoderValues[0x80][67][1][1][3][2][15000] =
                    "--preset radio"; // 3.90,   3.90.1, 3.90.2,   3.91, 3.92
                $KnownEncoderValues[0x70][67][1][1][3][2][15000] =
                    "--preset fm"; // 3.90,   3.90.1, 3.90.2,   3.91, 3.92
                $KnownEncoderValues[0x70][58][2][2][3][2][16000] =
                    "--preset tape/radio/fm"; // 3.90.3, 3.93,   3.93.1
                $KnownEncoderValues[0x70][57][2][1][3][4][16000] =
                    "--preset tape/radio/fm"; // 3.94,   3.95
                $KnownEncoderValues[0x38][58][2][2][0][2][10000] =
                    "--preset voice"; // 3.90.3, 3.93,   3.93.1
                $KnownEncoderValues[0x38][57][2][1][0][4][15000] =
                    "--preset voice"; // 3.94,   3.95
                $KnownEncoderValues[0x38][57][2][1][0][4][16000] =
                    "--preset voice"; // 3.94a14
                $KnownEncoderValues[0x28][65][1][1][0][2][7500] =
                    "--preset mw-us"; // 3.90,   3.90.1, 3.92
                $KnownEncoderValues[0x28][65][1][1][0][2][7600] =
                    "--preset mw-us"; // 3.90.2, 3.91
                $KnownEncoderValues[0x28][58][2][2][0][2][7000] =
                    "--preset mw-us"; // 3.90.3, 3.93,   3.93.1
                $KnownEncoderValues[0x28][57][2][1][0][4][10500] =
                    "--preset mw-us"; // 3.94,   3.95
                $KnownEncoderValues[0x28][57][2][1][0][4][11200] =
                    "--preset mw-us"; // 3.94a14
                $KnownEncoderValues[0x28][57][2][1][0][4][8800] =
                    "--preset mw-us"; // 3.94a15
                $KnownEncoderValues[0x18][58][2][2][0][2][4000] =
                    "--preset phon+/lw/mw-eu/sw"; // 3.90.3, 3.93.1
                $KnownEncoderValues[0x18][58][2][2][0][2][3900] =
                    "--preset phon+/lw/mw-eu/sw"; // 3.93
                $KnownEncoderValues[0x18][57][2][1][0][4][5900] =
                    "--preset phon+/lw/mw-eu/sw"; // 3.94,   3.95
                $KnownEncoderValues[0x18][57][2][1][0][4][6200] =
                    "--preset phon+/lw/mw-eu/sw"; // 3.94a14
                $KnownEncoderValues[0x18][57][2][1][0][4][3200] =
                    "--preset phon+/lw/mw-eu/sw"; // 3.94a15
                $KnownEncoderValues[0x10][58][2][2][0][2][3800] =
                    "--preset phone"; // 3.90.3, 3.93.1
                $KnownEncoderValues[0x10][58][2][2][0][2][3700] =
                    "--preset phone"; // 3.93
                $KnownEncoderValues[0x10][57][2][1][0][4][5600] =
                    "--preset phone"; // 3.94,   3.95
            }
            ...
            if (
                isset(
                    $KnownEncoderValues[
                        ...
                        $thisfile_mpeg_audio_lame["raw"]["vbr_method"]
                    ][$thisfile_mpeg_audio_lame["raw"]["noise_shaping"]][
                        $thisfile_mpeg_audio_lame["raw"]["stereo_mode"]
                    ][$thisfile_mpeg_audio_lame["ath_type"]][
                ...
                $LAME_V_value =
                    10 - ceil($thisfile_mpeg_audio_lame["vbr_quality"] / 10);
                $LAME_q_value =
                    100 -
                    $thisfile_mpeg_audio_lame["vbr_quality"] -
                    $LAME_V_value * 10;
                ...
                $encoder_options =
                    strtoupper($info["audio"]["bitrate_mode"]) .
                    ceil($info["audio"]["bitrate"] / 1000);
            } else {
        ...
        if (
            isset($thisfile_mpeg_audio["bitrate"]) &&
            $thisfile_mpeg_audio["bitrate"] === "free"
        ) {
            $encoder_options .= " --freeformat";
        }

        if (
            !empty($thisfile_mpeg_audio_lame["encoding_flags"]["nogap_prev"]) ||
            !empty($thisfile_mpeg_audio_lame["encoding_flags"]["nogap_next"])
        ) {
                        ...
                        case "r3mix":
                            ...
                            if (
                                ...
                                round(
                                    ...
                                    round(
                                        $thisfile_mpeg_audio["sample_rate"] /
                                            2000
                                    )
                            ) {
                                $encoder_options .=
        ...
        if (isset($thisfile_mpeg_audio_lame["raw"]["source_sample_freq"])) {
            if (
                ...
                $thisfile_mpeg_audio_lame["raw"]["source_sample_freq"] != 1
            ) {
        ...
        if (
            empty($encoder_options) &&
            !empty($info["audio"]["bitrate"]) &&
            !empty($info["audio"]["bitrate_mode"])
        ) {
    ...
    public function decodeMPEGaudioHeader(
        ...
        if ($this->fseek($offset) != 0) {
            $this->error(
                "decodeMPEGaudioHeader() failed to seek to next offset at " .
                    $offset
            );
            return false;
        }
        ...
        if (!isset($MPEGaudioHeaderValidCache[$head4_key])) {
            ...
            $MPEGaudioHeaderValidCache[$head4_key] = self::MPEGaudioHeaderValid(
                $MPEGheaderRawArray,
                false,
                false
            );
        ...
        if ($MPEGaudioHeaderValidCache[$head4_key]) {
            ...
            $this->warning(
                "Invalid MPEG audio header (" .
                    getid3_lib::PrintHexBytes($head4) .
                    ") at offset " .
                    $offset
            );
            return false;
        ...
        if (!$FastMPEGheaderScan) {
            $thisfile_mpeg_audio["version"] =
                $MPEGaudioVersionLookup[$thisfile_mpeg_audio["raw"]["version"]];
            $thisfile_mpeg_audio["layer"] =
                $MPEGaudioLayerLookup[$thisfile_mpeg_audio["raw"]["layer"]];

            $thisfile_mpeg_audio["channelmode"] =
                $MPEGaudioChannelModeLookup[
                    $thisfile_mpeg_audio["raw"]["channelmode"]
                ];
            $thisfile_mpeg_audio["channels"] =
                $thisfile_mpeg_audio["channelmode"] == "mono" ? 1 : 2;
            $thisfile_mpeg_audio["sample_rate"] =
                $MPEGaudioFrequencyLookup[$thisfile_mpeg_audio["version"]][
                    $thisfile_mpeg_audio["raw"]["sample_rate"]
                ];
            $thisfile_mpeg_audio["protection"] = !$thisfile_mpeg_audio["raw"][
                "protection"
            ];
            $thisfile_mpeg_audio["private"] =
                (bool) $thisfile_mpeg_audio["raw"]["private"];
            $thisfile_mpeg_audio["modeextension"] =
                $MPEGaudioModeExtensionLookup[$thisfile_mpeg_audio["layer"]][
                    $thisfile_mpeg_audio["raw"]["modeextension"]
                ];
            $thisfile_mpeg_audio["copyright"] =
                (bool) $thisfile_mpeg_audio["raw"]["copyright"];
            $thisfile_mpeg_audio["original"] =
                (bool) $thisfile_mpeg_audio["raw"]["original"];
            $thisfile_mpeg_audio["emphasis"] =
                $MPEGaudioEmphasisLookup[
                    $thisfile_mpeg_audio["raw"]["emphasis"]
                ];
            ...
            if ($thisfile_mpeg_audio["protection"]) {
                $thisfile_mpeg_audio["crc"] = getid3_lib::BigEndian2Int(
                    substr($headerstring, 4, 2)
                );
            }
        }
        ...
        $thisfile_mpeg_audio["padding"] =
            (bool) $thisfile_mpeg_audio["raw"]["padding"];
        $thisfile_mpeg_audio["bitrate"] =
            $MPEGaudioBitrateLookup[$thisfile_mpeg_audio["version"]][
                $thisfile_mpeg_audio["layer"]
        ...
        if (!$FastMPEGheaderScan && $thisfile_mpeg_audio["layer"] == "2") {
            ...
            switch ($thisfile_mpeg_audio["channelmode"]) {
                case "mono":
                    if (
                        $thisfile_mpeg_audio["bitrate"] == "free" ||
                        $thisfile_mpeg_audio["bitrate"] <= 192000
                    ) {
                        // these are ok
                    } else {
                        $this->error(
                ...
                case "dual channel":
                    if (
                        $thisfile_mpeg_audio["bitrate"] == "free" ||
                        $thisfile_mpeg_audio["bitrate"] == 64000 ||
                        $thisfile_mpeg_audio["bitrate"] >= 96000
                    ) {
                        // these are ok
                    } else {
                        $this->error(
                            intval(
                                round($thisfile_mpeg_audio["bitrate"] / 1000)
                            ) .
                                "kbps not allowed in Layer 2, " .
                                $thisfile_mpeg_audio["channelmode"] .
                                "."
        ...
        if ($info["audio"]["sample_rate"] > 0) {
            $thisfile_mpeg_audio["framelength"] = self::MPEGaudioFrameLength(
                $thisfile_mpeg_audio["bitrate"],
                $thisfile_mpeg_audio["version"],
                $thisfile_mpeg_audio["layer"],
        ...
        if (substr($headerstring, 4 + 32, 4) == "VBRI") {
            ...
            $thisfile_mpeg_audio[
                ...
                substr($headerstring, $FraunhoferVBROffset + 4, 2)
            ); // VbriVersion
            $thisfile_mpeg_audio[
                "VBR_encoder_delay"
            ] = getid3_lib::BigEndian2Int(
                substr($headerstring, $FraunhoferVBROffset + 6, 2)
            ); // VbriDelay
            $thisfile_mpeg_audio["VBR_quality"] = getid3_lib::BigEndian2Int(
                substr($headerstring, $FraunhoferVBROffset + 8, 2)
            ); // VbriQuality
            $thisfile_mpeg_audio["VBR_bytes"] = getid3_lib::BigEndian2Int(
                substr($headerstring, $FraunhoferVBROffset + 10, 4)
            ); // VbriStreamBytes
            $thisfile_mpeg_audio["VBR_frames"] = getid3_lib::BigEndian2Int(
                substr($headerstring, $FraunhoferVBROffset + 14, 4)
            ); // VbriStreamFrames
            $thisfile_mpeg_audio[
                "VBR_seek_offsets"
            ] = getid3_lib::BigEndian2Int(
                substr($headerstring, $FraunhoferVBROffset + 18, 2)
            ); // VbriTableSize
            $thisfile_mpeg_audio["VBR_seek_scale"] = getid3_lib::BigEndian2Int(
                substr($headerstring, $FraunhoferVBROffset + 20, 2)
            ); // VbriTableScale
            $thisfile_mpeg_audio["VBR_entry_bytes"] = getid3_lib::BigEndian2Int(
                substr($headerstring, $FraunhoferVBROffset + 22, 2)
            ); // VbriEntryBytes
            $thisfile_mpeg_audio[
                "VBR_entry_frames"
            ] = getid3_lib::BigEndian2Int(
                substr($headerstring, $FraunhoferVBROffset + 24, 2)
            ); // VbriEntryFrames
            ...
            for ($i = 0; $i < $thisfile_mpeg_audio["VBR_seek_offsets"]; $i++) {
                $Fraunhofer_OffsetN = getid3_lib::BigEndian2Int(
                    substr(
                        $headerstring,
                        $FraunhoferVBROffset,
                ...
                $thisfile_mpeg_audio["VBR_offsets_relative"][$i] =
                    $Fraunhofer_OffsetN *
                    $thisfile_mpeg_audio["VBR_seek_scale"];
                $thisfile_mpeg_audio["VBR_offsets_absolute"][$i] =
                    $Fraunhofer_OffsetN *
                        $thisfile_mpeg_audio["VBR_seek_scale"] +
                    $previousbyteoffset;
            ...
            $VBRidOffset = self::XingVBRidOffset(
                $thisfile_mpeg_audio["version"],
                $thisfile_mpeg_audio["channelmode"]
            );
            ...
            if (
                substr($headerstring, $VBRidOffset, strlen("Xing")) == "Xing" ||
                substr($headerstring, $VBRidOffset, strlen("Info")) == "Info"
            ) {
                ...
                $thisfile_mpeg_audio[
                    ...
                    substr($headerstring, $VBRidOffset + 4, 4)
                );

                $thisfile_mpeg_audio["xing_flags"]["frames"] =
                    (bool) ($thisfile_mpeg_audio["xing_flags_raw"] &
                        0x00000001);
                $thisfile_mpeg_audio["xing_flags"]["bytes"] =
                    (bool) ($thisfile_mpeg_audio["xing_flags_raw"] &
                        0x00000002);
                $thisfile_mpeg_audio["xing_flags"]["toc"] =
                    (bool) ($thisfile_mpeg_audio["xing_flags_raw"] &
                        0x00000004);
                $thisfile_mpeg_audio["xing_flags"]["vbr_scale"] =
                    (bool) ($thisfile_mpeg_audio["xing_flags_raw"] &
                        0x00000008);
                ...
                if ($thisfile_mpeg_audio["xing_flags"]["frames"]) {
                    $thisfile_mpeg_audio[
                        ...
                        substr($headerstring, $VBRidOffset + 8, 4)
                    );
                ...
                if ($thisfile_mpeg_audio["xing_flags"]["bytes"]) {
                    $thisfile_mpeg_audio[
                        ...
                        substr($headerstring, $VBRidOffset + 12, 4)
                    );
                }
                ...
                if (!empty($thisfile_mpeg_audio["VBR_frames"])) {
                    ...
                    if (!empty($thisfile_mpeg_audio["VBR_bytes"])) {
                        ...
                        $used_filesize -= isset($info["id3v2"]["headerlength"])
                            ? intval($info["id3v2"]["headerlength"])
                            : 0;
                        $used_filesize -= isset($info["id3v1"]) ? 128 : 0;
                        $used_filesize -= isset($info["tag_offset_end"])
                            ? $info["tag_offset_end"] -
                                $info["tag_offset_start"]
                            : 0;
                        $this->warning(
                            "MP3.Xing header missing VBR_bytes, assuming MPEG audio portion of file is " .
                                number_format($used_filesize) .
                                " bytes"
                        );
                    }

                    $framelengthfloat =
                        $used_filesize / $thisfile_mpeg_audio["VBR_frames"];
                    ...
                    $thisfile_mpeg_audio["framelength"] = floor(
                        $framelengthfloat
                    );
                }
                ...
                if ($thisfile_mpeg_audio["xing_flags"]["vbr_scale"]) {
                    $thisfile_mpeg_audio[
                        ...
                        substr($headerstring, $VBRidOffset + 116, 4)
                    );
                }
                ...
                if (substr($headerstring, $VBRidOffset + 120, 4) == "LAME") {
                    ...
                    $thisfile_mpeg_audio_lame["long_version"] = substr(
                        $headerstring,
                        $VBRidOffset + 120,
                        20
                    );
                    $thisfile_mpeg_audio_lame["short_version"] = substr(
                        $thisfile_mpeg_audio_lame["long_version"],
                        0,
                        9
                    );
                    ...
                    if (
                        ...
                        $thisfile_mpeg_audio_lame["short_version"] =
                            $matches[0];
                        $thisfile_mpeg_audio_lame["numeric_version"] =
                            $matches[1];
                    }
                    if (
                        strlen($thisfile_mpeg_audio_lame["numeric_version"]) > 0
                    ) {
                        foreach (
                            explode(
                                ".",
                            ...
                            $thisfile_mpeg_audio_lame["integer_version"][
                                $key
                            ] = intval($number);
                        }
                        //if ($thisfile_mpeg_audio_lame['short_version'] >= 'LAME3.90') {
                        if (
                            $thisfile_mpeg_audio_lame["integer_version"][0] *
                                1000 +
                                $thisfile_mpeg_audio_lame[
                                    "integer_version"
                                ][1] >=
                            ...
                            $thisfile_mpeg_audio_lame_RGAD_track =
                                &$thisfile_mpeg_audio_lame_RGAD["track"];
                            $thisfile_mpeg_audio_lame_RGAD_album =
                                &$thisfile_mpeg_audio_lame_RGAD["album"];
                            $thisfile_mpeg_audio_lame["raw"] = [];
                            ...
                            $thisfile_mpeg_audio_lame["short_version"] = substr(
                                $headerstring,
                                $LAMEtagOffsetContant + 0x9c,
                                9
                            );

                            // byte $A5  Info Tag revision + VBR method
                            $LAMEtagRevisionVBRmethod = getid3_lib::BigEndian2Int(
                                substr(
                                    $headerstring,
                            ...
                            $thisfile_mpeg_audio_lame["tag_revision"] =
                                ($LAMEtagRevisionVBRmethod & 0xf0) >> 4;
                            $thisfile_mpeg_audio_lame_raw["vbr_method"] =
                                $LAMEtagRevisionVBRmethod & 0x0f;
                            $thisfile_mpeg_audio_lame[
                                "vbr_method"
                            ] = self::LAMEvbrMethodLookup(
                                $thisfile_mpeg_audio_lame_raw["vbr_method"]
                            );
                            $thisfile_mpeg_audio["bitrate_mode"] = substr(
                                $thisfile_mpeg_audio_lame["vbr_method"],
                                0,
                                3
                            ...
                            if (
                                ...
                                $thisfile_mpeg_audio_lame_RGAD[
                                    ...
                                    (float) (getid3_lib::BigEndian2Int(
                                        substr(
                                            $headerstring,
                            ...
                            if (
                                $thisfile_mpeg_audio_lame_raw["RGAD_track"] != 0
                            ) {
                                ...
                                if (
                                    ...
                                    $info["replay_gain"]["track"]["peak"] =
                                        $thisfile_mpeg_audio_lame_RGAD[
                                            "peak_amplitude"
                                        ];
                                }
                                $info["replay_gain"]["track"]["originator"] =
                                    $thisfile_mpeg_audio_lame_RGAD_track[
                                        "originator"
                                    ];
                                $info["replay_gain"]["track"]["adjustment"] =
                                    $thisfile_mpeg_audio_lame_RGAD_track[
                                        "gain_db"
                                    ];
                            } else {
                            ...
                            if (
                                $thisfile_mpeg_audio_lame_raw["RGAD_album"] != 0
                            ) {
                                ...
                                if (
                                    ...
                                    $info["replay_gain"]["album"]["peak"] =
                                        $thisfile_mpeg_audio_lame_RGAD[
                                            "peak_amplitude"
                                        ];
                                }
                                $info["replay_gain"]["album"]["originator"] =
                                    $thisfile_mpeg_audio_lame_RGAD_album[
                                        "originator"
                                    ];
                                $info["replay_gain"]["album"]["adjustment"] =
                                    $thisfile_mpeg_audio_lame_RGAD_album[
                                        "gain_db"
                                    ];
                            } else {
                            ...
                            $EncodingFlagsATHtype = getid3_lib::BigEndian2Int(
                                substr(
                                    $headerstring,
                            ...
                            $thisfile_mpeg_audio_lame["encoding_flags"][
                                "nspsytune"
                            ] = (bool) ($EncodingFlagsATHtype & 0x10);
                            $thisfile_mpeg_audio_lame["encoding_flags"][
                                "nssafejoint"
                            ] = (bool) ($EncodingFlagsATHtype & 0x20);
                            $thisfile_mpeg_audio_lame["encoding_flags"][
                                "nogap_next"
                            ] = (bool) ($EncodingFlagsATHtype & 0x40);
                            $thisfile_mpeg_audio_lame["encoding_flags"][
                                "nogap_prev"
                            ] = (bool) ($EncodingFlagsATHtype & 0x80);
                            $thisfile_mpeg_audio_lame["ath_type"] =
                                $EncodingFlagsATHtype & 0x0f;
                            ...
                            if (
                                ...
                                $thisfile_mpeg_audio_lame_raw["vbr_method"] == 1
                            ) {
                            ...
                            $EncoderDelays = getid3_lib::BigEndian2Int(
                                substr(
                                    $headerstring,
                            ...
                            $thisfile_mpeg_audio_lame["encoder_delay"] =
                                ($EncoderDelays & 0xfff000) >> 12;
                            $thisfile_mpeg_audio_lame["end_padding"] =
                                $EncoderDelays & 0x000fff;

                            // byte $B4  Misc
                            $MiscByte = getid3_lib::BigEndian2Int(
                                substr(
                                    $headerstring,
                            ...
                            $thisfile_mpeg_audio_lame_raw["noise_shaping"] =
                                $MiscByte & 0x03;
                            $thisfile_mpeg_audio_lame_raw["stereo_mode"] =
                                ($MiscByte & 0x1c) >> 2;
                            $thisfile_mpeg_audio_lame_raw[
                                "not_optimal_quality"
                            ] = ($MiscByte & 0x20) >> 5;
                            ...
                            $thisfile_mpeg_audio_lame["noise_shaping"] =
                                $thisfile_mpeg_audio_lame_raw["noise_shaping"];
                            $thisfile_mpeg_audio_lame[
                                "stereo_mode"
                            ] = self::LAMEmiscStereoModeLookup(
                                $thisfile_mpeg_audio_lame_raw["stereo_mode"]
                            );
                            $thisfile_mpeg_audio_lame["not_optimal_quality"] =
                                (bool) $thisfile_mpeg_audio_lame_raw[
                                    "not_optimal_quality"
                                ];
                            $thisfile_mpeg_audio_lame[
                                "source_sample_freq"
                            ] = self::LAMEmiscSourceSampleFrequencyLookup(
                                $thisfile_mpeg_audio_lame_raw[
                                    "source_sample_freq"
                                ]
                            );
                            ...
                            $thisfile_mpeg_audio_lame["mp3_gain_db"] =
                                (getid3_lib::RGADamplitude2dB(2) / 4) *
                                $thisfile_mpeg_audio_lame_raw["mp3_gain"];
                            $thisfile_mpeg_audio_lame["mp3_gain_factor"] = pow(
                                2,
                                $thisfile_mpeg_audio_lame["mp3_gain_db"] / 6
                            );

                            // bytes $B6-$B7  Preset and surround info
                            $PresetSurroundBytes = getid3_lib::BigEndian2Int(
                                substr(
                                    $headerstring,
                            ...
                            $thisfile_mpeg_audio_lame_raw["surround_info"] =
                                $PresetSurroundBytes & 0x3800;
                            $thisfile_mpeg_audio_lame[
                                "surround_info"
                            ] = self::LAMEsurroundInfoLookup(
                                $thisfile_mpeg_audio_lame_raw["surround_info"]
                            );
                            $thisfile_mpeg_audio_lame["preset_used_id"] =
                                $PresetSurroundBytes & 0x07ff;
                            $thisfile_mpeg_audio_lame[
                                "preset_used"
                            ] = self::LAMEpresetUsedLookup(
                                $thisfile_mpeg_audio_lame
                            );
                            if (
                                !empty(
                            ...
                            $ExpectedNumberOfAudioBytes =
                                $thisfile_mpeg_audio_lame["audio_bytes"] > 0
                                    ? $thisfile_mpeg_audio_lame["audio_bytes"]
                                    : $thisfile_mpeg_audio["VBR_bytes"];
                            ...
                            if (
                                ...
                                $thisfile_mpeg_audio[
                                    "bitrate"
                                ] = self::ClosestStandardMP3Bitrate(
                                    $thisfile_mpeg_audio["bitrate"]
                                );
                                $info["audio"]["bitrate"] =
                                    $thisfile_mpeg_audio["bitrate"];
        ...
        if (
            ...
            if (
                ...
                if (
                    ...
                    $this->warning(
                        "Too much data in file: expecting " .
                            $ExpectedNumberOfAudioBytes .
        ...
        if (
            ...
            if (
                $offset == $info["avdataoffset"] &&
                empty($thisfile_mpeg_audio["VBR_frames"])
            ) {
                ...
                if ($framebytelength > 0) {
                    ...
                    if ($thisfile_mpeg_audio["layer"] == "1") {
                        ...
                        $info["audio"]["bitrate"] =
                            (($framebytelength / 4 -
                                intval($thisfile_mpeg_audio["padding"])) *
                                $thisfile_mpeg_audio["sample_rate"]) /
                            12;
                    } else {
                        // Bitrate = ((FrameLengthInBytes - Padding) * SampleRate) / 144
        ...
        if (
            isset($thisfile_mpeg_audio["VBR_frames"])
                ? $thisfile_mpeg_audio["VBR_frames"]
                : ""
        ) {
                ...
                case "abr":
                    ...
                    if (
                        ...
                        ($thisfile_mpeg_audio["version"] == "2" ||
                            $thisfile_mpeg_audio["version"] == "2.5") &&
                        $thisfile_mpeg_audio["layer"] == 3
                    ) {
                        $bytes_per_frame = 576;
                    }
                    $thisfile_mpeg_audio["VBR_bitrate"] = isset(
                        $thisfile_mpeg_audio["VBR_bytes"]
                    )
                        ? ($thisfile_mpeg_audio["VBR_bytes"] /
                                $thisfile_mpeg_audio["VBR_frames"]) *
                            8 *
                            ($info["audio"]["sample_rate"] / $bytes_per_frame)
                        : 0;
                    if ($thisfile_mpeg_audio["VBR_bitrate"] > 0) {
                        $info["audio"]["bitrate"] =
                            $thisfile_mpeg_audio["VBR_bitrate"];
                        $thisfile_mpeg_audio["bitrate"] =
                            $thisfile_mpeg_audio["VBR_bitrate"]; // to avoid confusion
                    }
                    break;
            }
        }
        ...
        if ($recursivesearch) {
            ...
            if (
                !empty($this->getid3->info["mp3_validity_check_bitrates"]) &&
                !empty($thisfile_mpeg_audio["bitrate_mode"]) &&
                $thisfile_mpeg_audio["bitrate_mode"] == "vbr" &&
                !empty($thisfile_mpeg_audio["VBR_bitrate"])
            ) {
                // https://github.com/JamesHeinrich/getID3/issues/287
                if (
                    count(
                        array_keys(
                            $this->getid3->info["mp3_validity_check_bitrates"]
                        )
                    ) == 1
                ) {
                    list($cbr_bitrate_in_short_scan) = array_keys(
                        $this->getid3->info["mp3_validity_check_bitrates"]
                    );
     ...
     * @return bool
     */
    public function RecursiveFrameScanning(
        &$offset,
        &$nextframetestoffset,
        $ScanAsCBR
    ) {
        ...
        for ($i = 0; $i < $this->mp3_valid_check_frames; $i++) {
            ...
            if (
                ...
                getid3_lib::safe_inc(
                    $info["mp3_validity_check_bitrates"][
                        $nextframetestarray["mpeg"]["audio"]["bitrate"]
                    ]
                );
                if ($ScanAsCBR) {
                    ...
                    if (
                        ...
                        !isset(
                            $firstframetestarray["mpeg"]["audio"]["bitrate"]
                        ) ||
                        $nextframetestarray["mpeg"]["audio"]["bitrate"] !=
                            $firstframetestarray["mpeg"]["audio"]["bitrate"]
                    ) {
                ...
                if (
                    isset(
                        $nextframetestarray["mpeg"]["audio"]["framelength"]
                    ) &&
                    $nextframetestarray["mpeg"]["audio"]["framelength"] > 0
                ) {
                    $nextframetestoffset +=
                        $nextframetestarray["mpeg"]["audio"]["framelength"];
                } else {
                ...
                !empty($firstframetestarray["mpeg"]["audio"]["framelength"]) &&
                $nextframetestoffset +
                    $firstframetestarray["mpeg"]["audio"]["framelength"] >
                    $info["avdataend"]
            ) {
    ...
    public function FreeFormatFrameLength($offset, $deepscan = false)
    {
        ...
        $SyncPattern2 =
            $SyncPattern1[0] .
            $SyncPattern1[1] .
            chr(ord($SyncPattern1[2]) | 0x02) .
            $SyncPattern1[3];
        if ($SyncPattern2 === $SyncPattern1) {
            $SyncPattern2 =
                $SyncPattern1[0] .
                $SyncPattern1[1] .
                chr(ord($SyncPattern1[2]) & 0xfd) .
                $SyncPattern1[3];
        }
        ...
        if (!$framelength) {
            ...
            $framelength1 = strpos(
                $MPEGaudioData,
                substr($SyncPattern1, 0, 3),
                4
            );
            $framelength2 = strpos(
                $MPEGaudioData,
                substr($SyncPattern2, 0, 3),
                4
            );
            ...
            if (!$framelength) {
                $this->error(
                    "Cannot find next free-format synch pattern (" .
                        getid3_lib::PrintHexBytes($SyncPattern1) .
                        " or " .
                        getid3_lib::PrintHexBytes($SyncPattern2) .
                        ") after offset " .
                        $offset
                );
                return false;
        ...
        if ($deepscan) {
            ...
            while ($nextoffset < $info["avdataend"] - 6) {
                ...
                if (
                    substr($NextSyncPattern, 1, strlen($SyncPattern1)) ==
                        $SyncPattern1 ||
                    substr($NextSyncPattern, 1, strlen($SyncPattern2)) ==
                        $SyncPattern2
                ) {
                    // good - found where expected
                    $ActualFrameLengthValues[] = $framelength;
                } elseif (
                    substr($NextSyncPattern, 0, strlen($SyncPattern1)) ==
                        $SyncPattern1 ||
                    substr($NextSyncPattern, 0, strlen($SyncPattern2)) ==
                        $SyncPattern2
                ) {
                    ...
                    substr($NextSyncPattern, 2, strlen($SyncPattern1)) ==
                        $SyncPattern1 ||
                    substr($NextSyncPattern, 2, strlen($SyncPattern2)) ==
                        $SyncPattern2
                ) {
                    ...
                    $this->error(
                        "Did not find expected free-format sync pattern at offset " .
                            $nextoffset
                    );
                    return false;
                }
            ...
            if (count($ActualFrameLengthValues) > 0) {
                $framelength = intval(
                    round(
                        array_sum($ActualFrameLengthValues) /
                            count($ActualFrameLengthValues)
                    )
                );
            }
        }
    ...
    public function getOnlyMPEGaudioInfoBruteForce()
    {
        ...
        while ($this->ftell() < $info["avdataend"]) {
            ...
            if (!isset($MPEGaudioHeaderDecodeCache[$head4])) {
                $MPEGaudioHeaderDecodeCache[
                    $head4
                ] = self::MPEGaudioHeaderDecode($head4);
            }
            if (!isset($MPEGaudioHeaderValidCache[$head4])) {
                $MPEGaudioHeaderValidCache[$head4] = self::MPEGaudioHeaderValid(
                ...
                if (!isset($MPEGaudioHeaderLengthCache[$head4])) {
                    $LongMPEGversionLookup[$head4] =
                        $MPEGaudioVersionLookup[
                            $MPEGaudioHeaderDecodeCache[$head4]["version"]
                        ];
                    $LongMPEGlayerLookup[$head4] =
                        $MPEGaudioLayerLookup[
                            $MPEGaudioHeaderDecodeCache[$head4]["layer"]
                        ];
                    $LongMPEGbitrateLookup[$head4] =
                        $MPEGaudioBitrateLookup[$LongMPEGversionLookup[$head4]][
                            $LongMPEGlayerLookup[$head4]
                        ][$MPEGaudioHeaderDecodeCache[$head4]["bitrate"]];
                    $LongMPEGpaddingLookup[$head4] =
                        (bool) $MPEGaudioHeaderDecodeCache[$head4]["padding"];
                    $LongMPEGfrequencyLookup[$head4] =
                        $MPEGaudioFrequencyLookup[
                            $LongMPEGversionLookup[$head4]
                        ][$MPEGaudioHeaderDecodeCache[$head4]["sample_rate"]];
                    $MPEGaudioHeaderLengthCache[
                        $head4
                    ] = self::MPEGaudioFrameLength(
                        $LongMPEGbitrateLookup[$head4],
                        $LongMPEGversionLookup[$head4],
                        $LongMPEGlayerLookup[$head4],
                        $LongMPEGpaddingLookup[$head4],
                ...
                if ($MPEGaudioHeaderLengthCache[$head4] > 4) {
                    ...
                    if ($next4[0] == "\xFF") {
                        if (!isset($MPEGaudioHeaderDecodeCache[$next4])) {
                            $MPEGaudioHeaderDecodeCache[
                                $next4
                            ] = self::MPEGaudioHeaderDecode($next4);
                        }
                        if (!isset($MPEGaudioHeaderValidCache[$next4])) {
                            $MPEGaudioHeaderValidCache[
                                $next4
                            ] = self::MPEGaudioHeaderValid(
                                $MPEGaudioHeaderDecodeCache[$next4],
                                false,
                                false
                            );
                        }
                        if ($MPEGaudioHeaderValidCache[$next4]) {
                            ...
                            $Distribution["version"][
                                ...
                                : 1;
                            $Distribution["padding"][
                                intval($LongMPEGpaddingLookup[$head4])
                            ] = isset(
                                $Distribution["padding"][
                                    intval($LongMPEGpaddingLookup[$head4])
                                ]
                            ...
                            if (++$frames_scanned >= $max_frames_scan) {
                                $pct_data_scanned = getid3_lib::SafeDiv(
                                    $this->ftell() - $info["avdataoffset"],
                                    $info["avdataend"] - $info["avdataoffset"]
                                );
                                $this->warning(
                                    "too many MPEG audio frames to scan, only scanned first " .
                                        $max_frames_scan .
                                        " frames (" .
                                        number_format(
                                            $pct_data_scanned * 100,
                                            1
                                        ) .
        ...
        $info["mpeg"]["audio"]["bitrate_distribution"] =
            $Distribution["bitrate"];
        $info["mpeg"]["audio"]["frequency_distribution"] =
            $Distribution["frequency"];
        $info["mpeg"]["audio"]["layer_distribution"] = $Distribution["layer"];
        $info["mpeg"]["audio"]["version_distribution"] =
            $Distribution["version"];
        $info["mpeg"]["audio"]["padding_distribution"] =
            $Distribution["padding"];
        ...
        $info["mpeg"]["audio"]["frame_count"] = array_sum(
            $Distribution["bitrate"]
        );
        ...
        $info["mpeg"]["audio"]["bitrate"] =
            $bittotal / $info["mpeg"]["audio"]["frame_count"];
        $info["mpeg"]["audio"]["bitrate_mode"] =
            count($Distribution["bitrate"]) > 0 ? "vbr" : "cbr";
        $info["mpeg"]["audio"]["sample_rate"] = getid3_lib::array_max(
            $Distribution["frequency"],
            true
        );
        ...
        $info["audio"]["dataformat"] =
            "mp" . getid3_lib::array_max($Distribution["layer"], true);
        $info["fileformat"] = $info["audio"]["dataformat"];
     ...
     * @return bool
     */
    public function getOnlyMPEGaudioInfo(
        $avdataoffset,
        ...
        $sync_seek_buffer_size = min(
            128 * 1024,
            $info["avdataend"] - $avdataoffset
        );
        ...
        while ($SynchSeekOffset < $sync_seek_buffer_size) {
            if (
                $avdataoffset + $SynchSeekOffset < $info["avdataend"] &&
                !$this->feof()
            ) {
                if ($SynchSeekOffset > $sync_seek_buffer_size) {
                    // if a synch's not found within the first 128k bytes, then give up
                    $this->error(
                        "Could not find valid MPEG audio synch within the first " .
                            round($sync_seek_buffer_size / 1024) .
                            "kB"
                    );
            ...
            if (
                $header[$SynchSeekOffset] == "\xFF" &&
                $header[$SynchSeekOffset + 1] > "\xE0"
            ) {
                ...
                if (++$SyncSeekAttempts >= $SyncSeekAttemptsMax) {
                    ...
                    // if a synch's not found within the first 128k bytes, then give up
                    $this->error(
                        "Could not find valid MPEG audio synch after scanning " .
                            $SyncSeekAttempts .
                            " candidate offsets"
                    );
                    if (isset($info["audio"]["bitrate"])) {
                ...
                if (
                    !isset($FirstFrameThisfileInfo) &&
                    !isset($info["mpeg"]["audio"])
                ) {
                ...
                if (
                    ...
                    switch (
                        isset($info["fileformat"]) ? $info["fileformat"] : ""
                    ) {
                        case "":
                        case "id3":
                        case "ape":
                    ...
                    if (
                        isset($FirstFrameThisfileInfo) &&
                        isset(
                            $FirstFrameThisfileInfo["mpeg"]["audio"][
                                "bitrate_mode"
                            ]
                        ) &&
                        $FirstFrameThisfileInfo["mpeg"]["audio"][
                    ...
                    if (
                        isset($info["mpeg"]["audio"]["bitrate_mode"]) &&
                        $info["mpeg"]["audio"]["bitrate_mode"] == "vbr" &&
                        !isset($info["mpeg"]["audio"]["VBR_method"])
                    ) {
                    ...
                    if ($BitrateHistogram) {
                        ...
                        $frames_scanned = 0;
                        $this_scan_segment = 0;
                        $frames_scan_per_segment = ceil(
                            $max_frames_scan / $max_scan_segments
                        );
                        $pct_data_scanned = 0;
                        for (
                            $current_segment = 0;
                            $current_segment < $max_scan_segments;
                            $current_segment++
                        ) {
                            ...
                            $scan_start_offset[$current_segment] = max(
                                $this->ftell(),
                                $info["avdataoffset"] +
                                    round(
                                        $current_segment *
                            ...
                            if ($current_segment > 0) {
                                $this->fseek(
                                    $scan_start_offset[$current_segment]
                                );
                                $buffer_4k = $this->fread(4096);
                                for (
                                    $j = 0;
                                    $j < strlen($buffer_4k) - 4;
                                    $j++
                                ) {
                                    if (
                                        $buffer_4k[$j] == "\xFF" &&
                            ...
                            $synchstartoffset =
                                $scan_start_offset[$current_segment];
                            while (
                                $synchstartoffset < $info["avdataend"] &&
                                $this->decodeMPEGaudioHeader(
                                    $synchstartoffset,
                                    $dummy,
                                    false,
                                ...
                                if (
                                    ...
                                    $this_pct_scanned = getid3_lib::SafeDiv(
                                        $this->ftell() -
                                            $scan_start_offset[
                                                $current_segment
                                            ],
                        ...
                        if ($pct_data_scanned > 0) {
                            $this->warning(
                                "too many MPEG audio frames to scan, only scanned " .
                                    $frames_scanned .
                                    " frames in " .
                                    $max_scan_segments .
                                    " segments (" .
                                    number_format($pct_data_scanned * 100, 1) .
                                    "% of file) and extrapolated distribution, playtime and bitrate may be incorrect."
                            );
                            foreach (
                                $info["mpeg"]["audio"]
                        ...
                        $info["mpeg"]["audio"][
                            "frame_count"
                        ] = getid3_lib::CastAsInt($framecounter);
                        $info["mpeg"]["audio"]["bitrate"] =
                            $bittotal / $framecounter;
                        ...
                        foreach (
                            $info["mpeg"]["audio"]["bitrate_distribution"]
                            as $bitrate_value => $bitrate_count
                        ) {
                            if ($bitrate_count > 0) {
                                $distinct_bitrates++;
                            }
            ...
            if ($avdataoffset + $SynchSeekOffset >= $info["avdataend"]) {
                ...
                if (empty($info["mpeg"]["audio"])) {
                    ...
                    if (
                        isset($info["mpeg"]) &&
                        (!is_array($info["mpeg"]) || empty($info["mpeg"]))
                    ) {
                        unset($info["mpeg"]);
                    }
                    return false;
     ...
     * @return bool
     */
    public static function MPEGaudioHeaderBytesValid(
        $head4,
        $allowBitrate15 = false
    ) {
        return self::MPEGaudioHeaderValid(
            self::MPEGaudioHeaderDecode($head4),
            false,
            $allowBitrate15
        );
     ...
     * @return bool
     */
    public static function MPEGaudioHeaderValid(
        $rawarray,
        $echoerrors = false,
        $allowBitrate15 = false
    ) {
        if (
            !isset($rawarray["synch"]) ||
        ...
        if (
            !isset(
                $MPEGaudioBitrateLookup[$decodedVersion][$decodedLayer][
                    $rawarray["bitrate"]
                ]
            )
        ) {
        ...
        if (
            !isset(
                $MPEGaudioFrequencyLookup[$decodedVersion][
                    $rawarray["sample_rate"]
                ]
            )
        ) {
            echo $echoerrors
        ...
        if (
            !isset(
                $MPEGaudioModeExtensionLookup[$decodedLayer][
                    $rawarray["modeextension"]
                ]
            )
        ) {
            echo $echoerrors
                ? "\n" .
                    "invalid Mode Extension (" .
                    $rawarray["modeextension"] .
                    ")"
                : "";
            return false;
    ...
    public static function MPEGaudioHeaderDecode($Header4Bytes)
    {
        ...
        $MPEGrawHeader = [];
        $MPEGrawHeader["synch"] =
            (getid3_lib::BigEndian2Int(substr($Header4Bytes, 0, 2)) & 0xffe0) >>
            4;
     ...
     * @return int|false
     */
    public static function MPEGaudioFrameLength(
        &$bitrate,
        &$version,
        &$layer,
        $padding,
        ...
        if (
            !isset(
                $AudioFrameLengthCache[$bitrate][$version][$layer][$padding][
                    $samplerate
                ]
            )
        ) {
            ...
            if ($bitrate != "free") {
                ...
                if ($samplerate > 0) {
                    $NewFramelength =
                        ($FrameLengthCoefficient * $bitrate) / $samplerate;
                    $NewFramelength =
                        floor($NewFramelength / $SlotLength) * $SlotLength; // round to next-lower multiple of SlotLength (1 byte for Layer 2/3, 4 bytes for Layer I)
                    if ($padding) {
                        $NewFramelength += $SlotLength;
                    }
                    $AudioFrameLengthCache[$bitrate][$version][$layer][
                        $padding
                    ][$samplerate] = (int) $NewFramelength;
                }
            }
        }
        return $AudioFrameLengthCache[$bitrate][$version][$layer][$padding][
            $samplerate
        ];
    }
    ...
    public static function ClosestStandardMP3Bitrate($bit_rate)
    {
        ...
        if (!isset($bit_rate_table[$round_bit_rate])) {
            if ($round_bit_rate > max($standard_bit_rates)) {
                $bit_rate_table[$round_bit_rate] = round(
                    $bit_rate,
                    2 - strlen($bit_rate)
                );
            } else {
    ...
    public static function LAMEvbrMethodLookup($VBRmethodID)
    {
        ...
        return isset($LAMEvbrMethodLookup[$VBRmethodID])
    ...
    public static function LAMEmiscStereoModeLookup($StereoModeID)
    {
        ...
        return isset($LAMEmiscStereoModeLookup[$StereoModeID])
     ...
     * @return string
     */
    public static function LAMEmiscSourceSampleFrequencyLookup(
    ...
    public static function LAMEsurroundInfoLookup($SurroundInfoID)
    {
        ...
        return isset($LAMEsurroundInfoLookup[$SurroundInfoID])
    ...
    public static function LAMEpresetUsedLookup($LAMEtag)
    {
        ...
        for ($i = 8; $i <= 320; $i++) {
            switch ($LAMEtag["vbr_method"]) {
                case "cbr":
                    $LAMEpresetUsedLookup[$i] =
                        "--alt-preset " . $LAMEtag["vbr_method"] . " " . $i;
                    break;
                case "abr":
                default:
        ...
        $LAMEpresetUsedLookup[450] =
            "--preset " .
            ($LAMEtag["raw"]["vbr_method"] == 4 ? "fast " : "") .
            "portable"; // 3.94a15 Nov 12 2003
        $LAMEpresetUsedLookup[460] =
            "--preset " .
            ($LAMEtag["raw"]["vbr_method"] == 4 ? "fast " : "") .
            "medium"; // 3.94a15 Nov 12 2003
        $LAMEpresetUsedLookup[470] = "--r3mix"; // 3.94b1  Dec 18 2003
        $LAMEpresetUsedLookup[480] =
            "--preset " .
            ($LAMEtag["raw"]["vbr_method"] == 4 ? "fast " : "") .
            "standard"; // 3.94a15 Nov 12 2003
        $LAMEpresetUsedLookup[490] = "-V1";
        $LAMEpresetUsedLookup[500] =
            "--preset " .
            ($LAMEtag["raw"]["vbr_method"] == 4 ? "fast " : "") .
            "extreme"; // 3.94a15 Nov 12 2003

        return isset($LAMEpresetUsedLookup[$LAMEtag["preset_used_id"]])
            ? $LAMEpresetUsedLookup[$LAMEtag["preset_used_id"]]
            : "new/unknown preset: " .
                    $LAMEtag["preset_used_id"] .
