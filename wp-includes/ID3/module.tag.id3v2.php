...
class getid3_id3v2 extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        if ($id3v2_majorversion > 4) {
            ...
            $this->error(
                "this script only parses up to ID3v2.4.x - this tag is ID3v2." .
                    $id3v2_majorversion .
                    "." .
                    $thisfile_id3v2["minorversion"]
            );
            return false;
        }
        ...
        switch ($id3v2_majorversion) {
            case 2:
                ...
                $thisfile_id3v2_flags["compression"] =
                    (bool) ($id3_flags & 0x40); // b - Compression
                break;
        ...
        $thisfile_id3v2["headerlength"] =
            getid3_lib::BigEndian2Int(substr($header, 6, 4), 1) + 10; // length of ID3v2 tag in 10-byte header doesn't include 10-byte header length

        $thisfile_id3v2["tag_offset_start"] = $this->StartingOffset;
        $thisfile_id3v2["tag_offset_end"] =
            $thisfile_id3v2["tag_offset_start"] +
            $thisfile_id3v2["headerlength"];
        ...
        if ($sizeofframes > 0) {
            ...
            if (
                !empty($thisfile_id3v2_flags["unsynch"]) &&
            ...
            if (!empty($thisfile_id3v2_flags["exthead"])) {
                ...
                if ($id3v2_majorversion == 3) {
                    ...
                    $thisfile_id3v2["exthead"][
                        "length"
                    ] = getid3_lib::BigEndian2Int(
                        substr($framedata, $extended_header_offset, 4),
                        0
                    );
                    ...
                    $thisfile_id3v2["exthead"]["flags"]["crc"] =
                        (bool) ($thisfile_id3v2["exthead"]["flag_raw"] &
                            0x8000);
                    ...
                    if ($thisfile_id3v2["exthead"]["flags"]["crc"]) {
                        $thisfile_id3v2["exthead"]["flag_data"][
                            "crc"
                        ] = getid3_lib::BigEndian2Int(
                            substr($framedata, $extended_header_offset, 4)
                        );
                    ...
                    $thisfile_id3v2["exthead"][
                        ...
                        substr($framedata, $extended_header_offset, 1)
                    ); // should always be 1
                    ...
                    if ($thisfile_id3v2["exthead"]["flags"]["restrictions"]) {
                        ...
                        // %ppqrrstt
                        $restrictions_raw = getid3_lib::BigEndian2Int(
                            substr($framedata, $extended_header_offset, 1)
                        );
                        $extended_header_offset += 1;
                        $thisfile_id3v2["exthead"]["flags"]["restrictions"][
                            "tagsize"
                        ] = ($restrictions_raw & 0xc0) >> 6; // p - Tag size restrictions
                        $thisfile_id3v2["exthead"]["flags"]["restrictions"][
                            "textenc"
                        ] = ($restrictions_raw & 0x20) >> 5; // q - Text encoding restrictions
                        $thisfile_id3v2["exthead"]["flags"]["restrictions"][
                            "textsize"
                        ] = ($restrictions_raw & 0x18) >> 3; // r - Text fields size restrictions
                        $thisfile_id3v2["exthead"]["flags"]["restrictions"][
                            "imgenc"
                        ] = ($restrictions_raw & 0x04) >> 2; // s - Image encoding restrictions
                        $thisfile_id3v2["exthead"]["flags"]["restrictions"][
                            "imgsize"
                        ] = ($restrictions_raw & 0x03) >> 0; // t - Image size restrictions

                        $thisfile_id3v2["exthead"]["flags"][
                            "restrictions_text"
                        ][
                            "tagsize"
                        ] = $this->LookupExtendedHeaderRestrictionsTagSizeLimits(
                            $thisfile_id3v2["exthead"]["flags"]["restrictions"][
                                "tagsize"
                            ]
                        );
                        $thisfile_id3v2["exthead"]["flags"][
                            ...
                            "textenc"
                        ] = $this->LookupExtendedHeaderRestrictionsTextEncodings(
                            $thisfile_id3v2["exthead"]["flags"]["restrictions"][
                                "textenc"
                            ]
                        );
                        $thisfile_id3v2["exthead"]["flags"][
                            ...
                            "textsize"
                        ] = $this->LookupExtendedHeaderRestrictionsTextFieldSize(
                            $thisfile_id3v2["exthead"]["flags"]["restrictions"][
                                "textsize"
                            ]
                        );
                        $thisfile_id3v2["exthead"]["flags"][
                            ...
                            "imgenc"
                        ] = $this->LookupExtendedHeaderRestrictionsImageEncoding(
                            $thisfile_id3v2["exthead"]["flags"]["restrictions"][
                                "imgenc"
                            ]
                        );
                        $thisfile_id3v2["exthead"]["flags"][
                            ...
                            "imgsize"
                        ] = $this->LookupExtendedHeaderRestrictionsImageSizeSize(
                            $thisfile_id3v2["exthead"]["flags"]["restrictions"][
                                "imgsize"
                            ]
                        );
                    ...
                    if (
                        ...
                        $this->warning(
                            "ID3v2.4 extended header length mismatch (expecting " .
                                intval($thisfile_id3v2["exthead"]["length"]) .
                                ", found " .
                                intval($extended_header_offset) .
                                ")"
                        );
                    }
                }
            ...
            while (isset($framedata) && strlen($framedata) > 0) {
                ...
                if (
                    ...
                    for (
                        $i = 0;
                        $i < $thisfile_id3v2["padding"]["length"];
                        $i++
                    ) {
                        if ($framedata[$i] != "\x00") {
                            $thisfile_id3v2["padding"]["valid"] = false;
                            $thisfile_id3v2["padding"]["errorpos"] =
                                $thisfile_id3v2["padding"]["start"] + $i;
                            $this->warning(
                                "Invalid ID3v2 padding found at offset " .
                                    $thisfile_id3v2["padding"]["errorpos"] .
                                    " (the remaining " .
                                    ($thisfile_id3v2["padding"]["length"] -
                                        $i) .
                ...
                if ($id3v2_majorversion == 2) {
                    ...
                    $frame_size = getid3_lib::BigEndian2Int(
                        substr($frame_header, 3, 3),
                        0
                    );
                    ...
                    if ($frame_size < strlen($framedata) + 4) {
                        ...
                        if (
                            ...
                            $this->warning(
                                "ID3v2 tag written as ID3v2.4, but with non-synchsafe integers (ID3v2.3 style). Older versions of (Helium2; iTunes) are known culprits of this. Tag has been parsed as ID3v2.3"
                            );
                            $id3v2_majorversion = 3;
                            $frame_size = getid3_lib::BigEndian2Int(
                                substr($frame_header, 4, 4),
                    ...
                    $frame_flags = getid3_lib::BigEndian2Int(
                        substr($frame_header, 8, 2)
                    );
                }

                if (
                    ($id3v2_majorversion == 2 &&
                        $frame_name == "\x00\x00\x00") ||
                    ...
                    $thisfile_id3v2["padding"]["start"] = $framedataoffset;
                    $thisfile_id3v2["padding"]["length"] =
                        strlen($frame_header) + strlen($framedata);
                    $thisfile_id3v2["padding"]["valid"] = true;
                ...
                if (
                    $iTunesBrokenFrameNameFixed = self::ID3v22iTunesBrokenFrameName(
                        $frame_name
                    )
                ) {
                    $this->warning(
                        'error parsing "' .
                            ...
                            '" (' .
                            $framedataoffset .
                            " bytes into the ID3v2." .
                            $id3v2_majorversion .
                            ' tag). (ERROR: IsValidID3v2FrameName("' .
                            str_replace("\x00", " ", $frame_name) .
                            '", ' .
                            $id3v2_majorversion .
                            '))). [Note: this particular error has been known to happen with tags edited by iTunes (versions "X v2.0.3", "v3.0.1", "v7.0.0.70" are known-guilty, probably others too)]. Translated frame name from "' .
                            str_replace("\x00", " ", $frame_name) .
                            '" to "' .
                ...
                if (
                    ...
                    $parsedFrame["datalength"] = getid3_lib::CastAsInt(
                        $frame_size
                    );
                    ...
                    if ($frame_size <= strlen($framedata)) {
                        if (
                            ...
                            $framedata = substr($framedata, $frame_size);
                            $this->warning(
                                "Next ID3v2 frame is valid, skipping current frame."
                            );
                        } else {
                            ...
                            case "MP3":
                                $this->warning(
                                    'error parsing "' .
                                        ...
                                        '", ' .
                                        $id3v2_majorversion .
                                        '))). [Note: this particular error has been known to happen with tags edited by "MP3ext (www.mutschler.de/mp3ext/)"]'
                                );
                                break;
                ...
                $framedataoffset +=
                    $frame_size + $this->ID3v2HeaderLength($id3v2_majorversion);
            }
        }
        ...
        if (
            isset($thisfile_id3v2_flags["isfooter"]) &&
            ...
            if ($thisfile_id3v2["majorversion_footer"] <= 4) {
                ...
                $thisfile_id3v2_flags["unsynch_footer"] =
                    (bool) ($id3_flags & 0x80);
                ...
                $thisfile_id3v2["footerlength"] = getid3_lib::BigEndian2Int(
                    substr($footer, 6, 4),
                    1
                );
            }
        ...
        if (isset($thisfile_id3v2["comments"]["track_number"])) {
            foreach (
                $thisfile_id3v2["comments"]["track_number"]
                as $key => $value
            ) {
                if (strstr($value, "/")) {
                    list(
        ...
        if (
            !isset($thisfile_id3v2["comments"]["year"]) &&
            !empty($thisfile_id3v2["comments"]["recording_time"][0]) &&
            preg_match(
                "#^([0-9]{4})#",
                trim($thisfile_id3v2["comments"]["recording_time"][0]),
                $matches
            )
        ) {
                ...
                switch ($txxx_array["description"]) {
                    case "replaygain_track_gain":
                        if (
                            ...
                            !empty($txxx_array["data"])
                        ) {
                            $info["replay_gain"]["track"][
                                "adjustment"
                            ] = floatval(
                                trim(str_replace("dB", "", $txxx_array["data"]))
                            );
                        }
                        break;
                    case "replaygain_track_peak":
                        if (
                            empty($info["replay_gain"]["track"]["peak"]) &&
                            !empty($txxx_array["data"])
                        ) {
                            $info["replay_gain"]["track"]["peak"] = floatval(
                                $txxx_array["data"]
                            );
                        }
                        break;
        ...
        if (
            ...
            if (strpos($genrestring, "/") !== false) {
                ...
                foreach ($LegitimateSlashedGenreList as $SlashedGenre) {
                    $genrestring = str_ireplace(
                        str_replace("/", "\x00", $SlashedGenre),
                        $SlashedGenre,
                        $genrestring
                    );
                }
    ...
    public function ParseID3v2Frame(&$parsedFrame)
    {
        ...
        $parsedFrame["framenamelong"] = $this->FrameNameLongLookup(
            $parsedFrame["frame_name"]
        );
        if (empty($parsedFrame["framenamelong"])) {
            unset($parsedFrame["framenamelong"]);
        }
        $parsedFrame["framenameshort"] = $this->FrameNameShortLookup(
            $parsedFrame["frame_name"]
        );
        ...
        if ($id3v2_majorversion >= 3) {
            ...
            if ($id3v2_majorversion == 3) {
                ...
                $parsedFrame["flags"]["ReadOnly"] =
                    (bool) ($parsedFrame["frame_flags_raw"] & 0x2000); // c - Read only
                ...
                $parsedFrame["flags"]["ReadOnly"] =
                    (bool) ($parsedFrame["frame_flags_raw"] & 0x1000); // c - Read only
                $parsedFrame["flags"]["GroupingIdentity"] =
                ...
                if ($parsedFrame["flags"]["Unsynchronisation"]) {
                    $parsedFrame["data"] = $this->DeUnsynchronise(
                        $parsedFrame["data"]
                    );
                }
            ...
            if ($parsedFrame["flags"]["compression"]) {
                $parsedFrame["decompressed_size"] = getid3_lib::BigEndian2Int(
                    substr($parsedFrame["data"], 0, 4)
                );
                if (!function_exists("gzuncompress")) {
                    $this->warning(
                        'gzuncompress() support required to decompress ID3v2 frame "' .
                            $parsedFrame["frame_name"] .
                            '"'
                    );
                } else {
                    if (
                        $decompresseddata = @gzuncompress(
                        ...
                        $this->warning(
                            'gzuncompress() failed on compressed contents of ID3v2 frame "' .
                                $parsedFrame["frame_name"] .
                                '"'
                        );
                    }
        ...
        if (!empty($parsedFrame["flags"]["DataLengthIndicator"])) {
            if (
                $parsedFrame["data_length_indicator"] !=
                strlen($parsedFrame["data"])
            ) {
                $this->warning(
                    'ID3v2 frame "' .
                        $parsedFrame["frame_name"] .
                        '" should be ' .
                        $parsedFrame["data_length_indicator"] .
                        " bytes long according to DataLengthIndicator, but found " .
                        strlen($parsedFrame["data"]) .
                        " bytes of data"
                );
            }
        ...
        if (
            isset($parsedFrame["datalength"]) &&
            $parsedFrame["datalength"] == 0
        ) {
            $warning =
                'Frame "' .
                $parsedFrame["frame_name"] .
            ...
            ($id3v2_majorversion >= 3 &&
                $parsedFrame["frame_name"] == "UFID") || // 4.1   UFID Unique file identifier
            ...
            ($id3v2_majorversion >= 3 &&
                $parsedFrame["frame_name"] == "TXXX") || // 4.2.2 TXXX User defined text information frame
            ...
            $frame_offset = 0;
            $frame_textencoding = ord(
                substr($parsedFrame["data"], $frame_offset++, 1)
            );
            $frame_textencoding_terminator = $this->TextEncodingTerminatorLookup(
                $frame_textencoding
            );
            if (
                ($id3v2_majorversion <= 3 && $frame_textencoding > 1) ||
            ...
            $parsedFrame["description"] = substr(
                $parsedFrame["data"],
                $frame_offset,
                $frame_terminatorpos - $frame_offset
            );
            $parsedFrame["description"] = $this->MakeUTF16emptyStringEmpty(
                $parsedFrame["description"]
            );
            $parsedFrame["encodingid"] = $frame_textencoding;
            $parsedFrame["encoding"] = $this->TextEncodingNameLookup(
                $frame_textencoding
            );

            $parsedFrame["description"] = trim(
            ...
            if (
                ...
                $commentkey = $parsedFrame["description"]
                    ? $parsedFrame["description"]
                    : (isset(
                        $info["id3v2"]["comments"][
            ...
            $parsedFrame["data"] = (string) substr(
                $parsedFrame["data"],
                $frame_offset
            );
            $parsedFrame["data"] = $this->RemoveStringTerminator(
            ...
            if (
                ...
                for (
                    $i = 0;
                    $i < strlen($parsedFrame["data"]);
                    $i += $wordsize
                ) {
                    if (
                        substr($parsedFrame["data"], $i, $wordsize) ==
                        str_repeat("\x00", $wordsize)
                    ) {
                        $Txxx_elements[] = substr(
                            $parsedFrame["data"],
                ...
                foreach ($Txxx_elements as $Txxx_element) {
                    $string = getid3_lib::iconv_fallback(
                        $parsedFrame["encoding"],
                        $info["id3v2"]["encoding"],
                        $Txxx_element
                    );
            ...
            ($id3v2_majorversion >= 3 &&
                $parsedFrame["frame_name"] == "WXXX") || // 4.3.2 WXXX User defined URL link frame
            ...
            $parsedFrame["url"] = substr(
                $parsedFrame["data"],
                $frame_terminatorpos + strlen($frame_textencoding_terminator)
            ); // always ISO-8859-1
            $parsedFrame["description"] = $this->RemoveStringTerminator(
                $parsedFrame["description"],
                $frame_textencoding_terminator
            );
            $parsedFrame["description"] = $this->MakeUTF16emptyStringEmpty(
            ...
            ($id3v2_majorversion == 3 &&
                $parsedFrame["frame_name"] == "IPLS") || // 4.4  IPLS Involved people list (ID3v2.3 only)
            ...
            $parsedFrame["data_raw"] = (string) substr(
                $parsedFrame["data"],
                $frame_offset
            );
            ...
            if (strpos($parsedFrame["data_raw"], "\x00") !== false) {
                $IPLS_parts_unsorted = [];
                if (
                    strlen($parsedFrame["data_raw"]) % 2 == 0 &&
                    (substr($parsedFrame["data_raw"], 0, 2) == "\xFF\xFE" ||
                    ...
                    for (
                        $i = 0;
                        $i < strlen($parsedFrame["data_raw"]);
                        $i += 2
                    ) {
                        $twobytes = substr($parsedFrame["data_raw"], $i, 2);
                        if ($twobytes === "\x00\x00") {
                            $IPLS_parts_unsorted[] = getid3_lib::iconv_fallback(
                                $parsedFrame["encoding"],
                                $info["id3v2"]["encoding"],
                                $thisILPS
                            );
            ...
            ($id3v2_majorversion >= 3 &&
                $parsedFrame["frame_name"] == "MCDI") || // 4.4   MCDI Music CD identifier
            ...
            ($id3v2_majorversion >= 3 &&
                $parsedFrame["frame_name"] == "ETCO") || // 4.5   ETCO Event timing codes
            ...
            $frame_offset = 0;
            $parsedFrame["timestampformat"] = ord(
                substr($parsedFrame["data"], $frame_offset++, 1)
            );

            while ($frame_offset < strlen($parsedFrame["data"])) {
                $parsedFrame["typeid"] = substr(
                    $parsedFrame["data"],
                    $frame_offset++,
                    1
                );
                $parsedFrame["type"] = $this->ETCOEventLookup(
                    $parsedFrame["typeid"]
                );
                $parsedFrame["timestamp"] = getid3_lib::BigEndian2Int(
                    substr($parsedFrame["data"], $frame_offset, 4)
                );
                $frame_offset += 4;
            }
            unset($parsedFrame["data"]);
            ...
            ($id3v2_majorversion >= 3 &&
                $parsedFrame["frame_name"] == "MLLT") || // 4.6   MLLT MPEG location lookup table
            ...
            $frame_offset = 0;
            $parsedFrame["framesbetweenreferences"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], 0, 2)
            );
            $parsedFrame["bytesbetweenreferences"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], 2, 3)
            );
            $parsedFrame["msbetweenreferences"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], 5, 3)
            );
            $parsedFrame["bitsforbytesdeviation"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], 8, 1)
            );
            $parsedFrame["bitsformsdeviation"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], 9, 1)
            );
            $parsedFrame["data"] = substr($parsedFrame["data"], 10);
            $deviationbitstream = "";
            while ($frame_offset < strlen($parsedFrame["data"])) {
                $deviationbitstream .= getid3_lib::BigEndian2Bin(
                    substr($parsedFrame["data"], $frame_offset++, 1)
                );
            }
            $reference_counter = 0;
            while (strlen($deviationbitstream) > 0) {
                $parsedFrame[$reference_counter]["bytedeviation"] = bindec(
                    substr(
                        $deviationbitstream,
                        0,
                        $parsedFrame["bitsforbytesdeviation"]
                    )
                );
                $parsedFrame[$reference_counter]["msdeviation"] = bindec(
                    substr(
                        $deviationbitstream,
                        $parsedFrame["bitsforbytesdeviation"],
            ...
            ($id3v2_majorversion >= 3 &&
                $parsedFrame["frame_name"] == "SYTC") || // 4.7   SYTC Synchronised tempo codes
            ...
            $timestamp_counter = 0;
            while ($frame_offset < strlen($parsedFrame["data"])) {
                $parsedFrame[$timestamp_counter]["tempo"] = ord(
                    substr($parsedFrame["data"], $frame_offset++, 1)
                );
            ...
            ($id3v2_majorversion >= 3 &&
                $parsedFrame["frame_name"] == "USLT") || // 4.8   USLT Unsynchronised lyric/text transcription
            ...
            if (
                strlen($parsedFrame["data"]) >=
                4 + strlen($frame_textencoding_terminator)
            ) {
                ...
                $parsedFrame["languagename"] = $this->LanguageLookup(
                    $frame_language,
                    false
                );
                if (
            ...
            ($id3v2_majorversion >= 3 &&
                $parsedFrame["frame_name"] == "SYLT") || // 4.9   SYLT Synchronised lyric/text
            ...
            $parsedFrame["contenttypeid"] = ord(
                substr($parsedFrame["data"], $frame_offset++, 1)
            );
            $parsedFrame["contenttype"] = $this->SYTLContentTypeLookup(
                $parsedFrame["contenttypeid"]
            );
            $parsedFrame["encodingid"] = $frame_textencoding;
            $parsedFrame["encoding"] = $this->TextEncodingNameLookup(
                $frame_textencoding
            ...
            while (strlen($frame_remainingdata)) {
                ...
                if ($frame_terminatorpos === false) {
                    ...
                    $parsedFrame["lyrics"][$timestampindex]["data"] = substr(
                        $frame_remainingdata,
                        $frame_offset,
                        $frame_terminatorpos - $frame_offset
                    );

                    $frame_remainingdata = substr(
                        $frame_remainingdata,
                        $frame_terminatorpos +
                            strlen($frame_textencoding_terminator)
                    );
                    if (
                        $timestampindex == 0 &&
                        ord($frame_remainingdata[0]) != 0
                    ) {
                        // timestamp probably omitted for first data item
                    } else {
                        $parsedFrame["lyrics"][$timestampindex][
                            "timestamp"
                        ] = getid3_lib::BigEndian2Int(
                            substr($frame_remainingdata, 0, 4)
                        );
            ...
            ($id3v2_majorversion >= 3 &&
                $parsedFrame["frame_name"] == "COMM") || // 4.10  COMM Comments
            ...
            if (strlen($parsedFrame["data"]) < 5) {
                ...
                $frame_text = (string) substr(
                    $parsedFrame["data"],
                    $frame_terminatorpos +
                        strlen($frame_textencoding_terminator)
                );
                $frame_text = $this->RemoveStringTerminator(
                    $frame_text,
                    $frame_textencoding_terminator
                );
                ...
                if (
                    ...
                    if (
                        ...
                        $info["id3v2"]["comments"][
                            $parsedFrame["framenameshort"]
                        ][$commentkey] = getid3_lib::iconv_fallback(
                            $parsedFrame["encoding"],
                            $info["id3v2"]["encoding"],
                            $parsedFrame["data"]
                        );
            ...
            $frame_remainingdata = substr(
                $parsedFrame["data"],
                $frame_terminatorpos + strlen("\x00")
            );
            $parsedFrame["description"] = $frame_idstring;
            $RVA2channelcounter = 0;
            while (strlen($frame_remainingdata) >= 5) {
                $frame_offset = 0;
                $frame_channeltypeid = ord(
                    substr($frame_remainingdata, $frame_offset++, 1)
                );
                $parsedFrame[$RVA2channelcounter][
                    "channeltypeid"
                ] = $frame_channeltypeid;
                $parsedFrame[$RVA2channelcounter][
                    "channeltype"
                ] = $this->RVA2ChannelTypeLookup($frame_channeltypeid);
                $parsedFrame[$RVA2channelcounter][
                    "volumeadjust"
                ] = getid3_lib::BigEndian2Int(
                    substr($frame_remainingdata, $frame_offset, 2),
                    false,
                    true
                ); // 16-bit signed
                $frame_offset += 2;
                $parsedFrame[$RVA2channelcounter]["bitspeakvolume"] = ord(
                    substr($frame_remainingdata, $frame_offset++, 1)
                );
                if (
                    $parsedFrame[$RVA2channelcounter]["bitspeakvolume"] < 1 ||
                ...
                $frame_bytespeakvolume = ceil(
                    $parsedFrame[$RVA2channelcounter]["bitspeakvolume"] / 8
                );
                $parsedFrame[$RVA2channelcounter][
                    "peakvolume"
                ] = getid3_lib::BigEndian2Int(
                ...
                $frame_remainingdata = substr(
                    $frame_remainingdata,
                    $frame_offset + $frame_bytespeakvolume
                );
                $RVA2channelcounter++;
            }
            unset($parsedFrame["data"]);
            ...
            ($id3v2_majorversion == 3 &&
                $parsedFrame["frame_name"] == "RVAD") || // 4.12  RVAD Relative volume adjustment (ID3v2.3 only)
            ...
            $frame_offset = 0;
            $frame_incrdecrflags = getid3_lib::BigEndian2Bin(
                substr($parsedFrame["data"], $frame_offset++, 1)
            );
            $parsedFrame["incdec"]["right"] = (bool) substr(
                $frame_incrdecrflags,
                6,
                1
            );
            $parsedFrame["incdec"]["left"] = (bool) substr(
                $frame_incrdecrflags,
                7,
                1
            );
            $parsedFrame["bitsvolume"] = ord(
                substr($parsedFrame["data"], $frame_offset++, 1)
            );
            $frame_bytesvolume = ceil($parsedFrame["bitsvolume"] / 8);
            $parsedFrame["volumechange"]["right"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], $frame_offset, $frame_bytesvolume)
            );
            if ($parsedFrame["incdec"]["right"] === false) {
                $parsedFrame["volumechange"]["right"] *= -1;
            }
            $frame_offset += $frame_bytesvolume;
            $parsedFrame["volumechange"]["left"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], $frame_offset, $frame_bytesvolume)
            );
            ...
            $frame_offset += $frame_bytesvolume;
            $parsedFrame["peakvolume"]["right"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], $frame_offset, $frame_bytesvolume)
            );
            $frame_offset += $frame_bytesvolume;
            $parsedFrame["peakvolume"]["left"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], $frame_offset, $frame_bytesvolume)
            );
            $frame_offset += $frame_bytesvolume;
            if ($id3v2_majorversion == 3) {
                ...
                if (strlen($parsedFrame["data"]) > 0) {
                    $parsedFrame["incdec"]["rightrear"] = (bool) substr(
                        $frame_incrdecrflags,
                        4,
                        1
                    );
                    $parsedFrame["incdec"]["leftrear"] = (bool) substr(
                        $frame_incrdecrflags,
                        5,
                        1
                    );
                    $parsedFrame["volumechange"][
                        "rightrear"
                    ] = getid3_lib::BigEndian2Int(
                        substr(
                            $parsedFrame["data"],
                ...
                if (strlen($parsedFrame["data"]) > 0) {
                    $parsedFrame["incdec"]["center"] = (bool) substr(
                        $frame_incrdecrflags,
                        3,
                        1
                    );
                ...
                if (strlen($parsedFrame["data"]) > 0) {
                    $parsedFrame["incdec"]["bass"] = (bool) substr(
                        $frame_incrdecrflags,
                        2,
                        1
                    );
            ...
            while (strlen($frame_remainingdata)) {
                $frame_frequency =
                    getid3_lib::BigEndian2Int(
                        substr($frame_remainingdata, 0, 2)
                    ) / 2;
                $parsedFrame["data"][
                    $frame_frequency
                ] = getid3_lib::BigEndian2Int(
                    substr($frame_remainingdata, 2, 2),
                    false,
                    true
                );
                $frame_remainingdata = substr($frame_remainingdata, 4);
            ...
            ($id3v2_majorversion == 3 &&
                $parsedFrame["frame_name"] == "EQUA") || // 4.12  EQUA Equalisation (ID3v2.3 only)
            ...
            $frame_offset = 0;
            $parsedFrame["adjustmentbits"] = substr(
                $parsedFrame["data"],
                $frame_offset++,
                1
            );
            ...
            $frame_remainingdata = (string) substr(
                $parsedFrame["data"],
                $frame_offset
            );
            while (strlen($frame_remainingdata) > 0) {
                $frame_frequencystr = getid3_lib::BigEndian2Bin(
                    substr($frame_remainingdata, 0, 2)
                );
                $frame_incdec = (bool) substr($frame_frequencystr, 0, 1);
                $frame_frequency = bindec(substr($frame_frequencystr, 1, 15));
                $parsedFrame[$frame_frequency]["incdec"] = $frame_incdec;
                $parsedFrame[$frame_frequency][
                    "adjustment"
                ] = getid3_lib::BigEndian2Int(
                    substr($frame_remainingdata, 2, $frame_adjustmentbytes)
                );
                ...
                $frame_remainingdata = substr(
                    $frame_remainingdata,
                    2 + $frame_adjustmentbytes
                );
            }
            unset($parsedFrame["data"]);
        } elseif (
            ($id3v2_majorversion >= 3 &&
                $parsedFrame["frame_name"] == "RVRB") || // 4.13  RVRB Reverb
            ...
            $frame_offset = 0;
            $parsedFrame["left"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], $frame_offset, 2)
            );
            $frame_offset += 2;
            $parsedFrame["right"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], $frame_offset, 2)
            );
            $frame_offset += 2;
            $parsedFrame["bouncesL"] = ord(
                substr($parsedFrame["data"], $frame_offset++, 1)
            );
            $parsedFrame["bouncesR"] = ord(
                substr($parsedFrame["data"], $frame_offset++, 1)
            );
            $parsedFrame["feedbackLL"] = ord(
                substr($parsedFrame["data"], $frame_offset++, 1)
            );
            $parsedFrame["feedbackLR"] = ord(
                substr($parsedFrame["data"], $frame_offset++, 1)
            );
            $parsedFrame["feedbackRR"] = ord(
                substr($parsedFrame["data"], $frame_offset++, 1)
            );
            $parsedFrame["feedbackRL"] = ord(
                substr($parsedFrame["data"], $frame_offset++, 1)
            );
            $parsedFrame["premixLR"] = ord(
                substr($parsedFrame["data"], $frame_offset++, 1)
            );
            $parsedFrame["premixRL"] = ord(
                substr($parsedFrame["data"], $frame_offset++, 1)
            );
            unset($parsedFrame["data"]);
        } elseif (
            ($id3v2_majorversion >= 3 &&
                $parsedFrame["frame_name"] == "APIC") || // 4.14  APIC Attached picture
            ...
            if (
                $id3v2_majorversion == 2 &&
                strlen($parsedFrame["data"]) > $frame_offset
            ) {
                $frame_imagetype = substr(
                    $parsedFrame["data"],
                    $frame_offset,
                    3
                );
                if (strtolower($frame_imagetype) == "ima") {
                    ...
                    $frame_imagetype = strtoupper(
                        str_replace("image/", "", strtolower($frame_mimetype))
                    );
            ...
            $frame_picturetype = ord(
                substr($parsedFrame["data"], $frame_offset++, 1)
            );

            if ($frame_offset >= $parsedFrame["datalength"]) {
                $this->warning(
                    "data portion of APIC frame is missing at offset " .
                        ($parsedFrame["dataoffset"] + 8 + $frame_offset)
                );
            } else {
                $frame_terminatorpos = strpos(
                    $parsedFrame["data"],
                ...
                if ($id3v2_majorversion == 2) {
                    $parsedFrame["imagetype"] = isset($frame_imagetype)
                        ? $frame_imagetype
                        : null;
                } else {
                    $parsedFrame["mime"] = isset($frame_mimetype)
                        ? $frame_mimetype
                        : null;
                }
                $parsedFrame["picturetypeid"] = $frame_picturetype;
                $parsedFrame["picturetype"] = $this->APICPictureTypeLookup(
                    $frame_picturetype
                );
                $parsedFrame["data"] = substr(
                    $parsedFrame["data"],
                ...
                $imageinfo = [];
                if (
                    $imagechunkcheck = getid3_lib::GetDataImageSize(
                        $parsedFrame["data"],
                        $imageinfo
                    )
                ) {
                    if ($imagechunkcheck[2] >= 1 && $imagechunkcheck[2] <= 3) {
                        $parsedFrame["image_mime"] = image_type_to_mime_type(
                            $imagechunkcheck[2]
                        );
...
*/
                    ...
                    if (is_string($this->getid3->option_save_attachments)) {
                        $destination_filename =
                            $dir .
                            DIRECTORY_SEPARATOR .
                            md5($info["filenamepath"]) .
                            "_" .
                            $frame_offset;
                        if (
                            !file_exists($destination_filename) ||
                            getID3::is_writable($destination_filename)
                        ) {
                            file_put_contents(
                                $destination_filename,
                                $parsedFrame["data"]
            ...
            ($id3v2_majorversion >= 3 &&
                $parsedFrame["frame_name"] == "GEOB") || // 4.15  GEOB General encapsulated object
            ...
            $parsedFrame["objectdata"] = (string) substr(
                $parsedFrame["data"],
                $frame_offset
            );
            $parsedFrame["encodingid"] = $frame_textencoding;
            ...
            ($id3v2_majorversion >= 3 &&
                $parsedFrame["frame_name"] == "PCNT") || // 4.16  PCNT Play counter
            ...
            $parsedFrame["data"] = getid3_lib::BigEndian2Int(
                $parsedFrame["data"]
            );
        } elseif (
            ($id3v2_majorversion >= 3 &&
                $parsedFrame["frame_name"] == "POPM") || // 4.17  POPM Popularimeter
            ...
            $parsedFrame["counter"] = getid3_lib::BigEndian2Int(
            ...
            ($id3v2_majorversion >= 3 &&
                $parsedFrame["frame_name"] == "RBUF") || // 4.18  RBUF Recommended buffer size
            ...
            $frame_offset = 0;
            $parsedFrame["buffersize"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], $frame_offset, 3)
            );
            $frame_offset += 3;

            $frame_embeddedinfoflags = getid3_lib::BigEndian2Bin(
                substr($parsedFrame["data"], $frame_offset++, 1)
            );
            $parsedFrame["flags"]["embededinfo"] = (bool) substr(
                $frame_embeddedinfoflags,
                7,
                1
            );
            $parsedFrame["nexttagoffset"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], $frame_offset, 4)
            );
            unset($parsedFrame["data"]);
        } elseif (
            $id3v2_majorversion == 2 &&
            $parsedFrame["frame_name"] == "CRM"
        ) {
            ...
            ($id3v2_majorversion >= 3 &&
                $parsedFrame["frame_name"] == "AENC") || // 4.19  AENC Audio encryption
            ...
            $frame_offset = $frame_terminatorpos + strlen("\x00");
            $parsedFrame["ownerid"] = $frame_ownerid;
            $parsedFrame["previewstart"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], $frame_offset, 2)
            );
            $frame_offset += 2;
            $parsedFrame["previewlength"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], $frame_offset, 2)
            );
            $frame_offset += 2;
            $parsedFrame["encryptioninfo"] = (string) substr(
                $parsedFrame["data"],
                $frame_offset
            );
            unset($parsedFrame["data"]);
            ...
            ($id3v2_majorversion >= 3 &&
                $parsedFrame["frame_name"] == "LINK") || // 4.20  LINK Linked information
            ...
            $parsedFrame["additionaldata"] = (string) substr(
                $parsedFrame["data"],
                $frame_offset
            );
            if (!empty($parsedFrame["framenameshort"]) && $parsedFrame["url"]) {
            ...
            $parsedFrame["position"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], $frame_offset)
            );
            unset($parsedFrame["data"]);
        } elseif (
            ...
            $parsedFrame["pricepaid"]["currencyid"] = substr(
                $frame_pricepaid,
                0,
                3
            );
            $parsedFrame["pricepaid"]["currency"] = $this->LookupCurrencyUnits(
                $parsedFrame["pricepaid"]["currencyid"]
            );
            $parsedFrame["pricepaid"]["value"] = substr($frame_pricepaid, 3);

            $parsedFrame["purchasedate"] = substr(
                $parsedFrame["data"],
                $frame_offset,
                8
            );
            if ($this->IsValidDateStampString($parsedFrame["purchasedate"])) {
                $parsedFrame["purchasedateunix"] = mktime(
                    0,
                    0,
                    0,
                    substr($parsedFrame["purchasedate"], 4, 2),
                    substr($parsedFrame["purchasedate"], 6, 2),
                    substr($parsedFrame["purchasedate"], 0, 4)
                );
            }
            $frame_offset += 8;

            $parsedFrame["seller"] = (string) substr(
                $parsedFrame["data"],
                $frame_offset
            );
            ...
            foreach ($frame_rawpricearray as $key => $val) {
                ...
                $parsedFrame["price"][$frame_currencyid][
                    "currency"
                ] = $this->LookupCurrencyUnits($frame_currencyid);
                $parsedFrame["price"][$frame_currencyid]["value"] = substr(
                    $val,
                    3
                );
            }
            ...
            $parsedFrame["receivedas"] = $this->COMRReceivedAsLookup(
                $frame_receivedasid
            );
            ...
            $frame_offset = 0;
            $parsedFrame["datastart"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], $frame_offset, 4)
            );
            $frame_offset += 4;
            $parsedFrame["indexeddatalength"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], $frame_offset, 4)
            );
            $frame_offset += 4;
            $parsedFrame["indexpoints"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], $frame_offset, 2)
            );
            $frame_offset += 2;
            $parsedFrame["bitsperpoint"] = ord(
                substr($parsedFrame["data"], $frame_offset++, 1)
            );
            $frame_bytesperpoint = ceil($parsedFrame["bitsperpoint"] / 8);
            for ($i = 0; $i < $parsedFrame["indexpoints"]; $i++) {
                $parsedFrame["indexes"][$i] = getid3_lib::BigEndian2Int(
                    substr(
                        $parsedFrame["data"],
                        $frame_offset,
                        $frame_bytesperpoint
            ...
            $frame_offset = 0;
            $parsedFrame["peakamplitude"] = getid3_lib::BigEndian2Float(
                substr($parsedFrame["data"], $frame_offset, 4)
            );
            $frame_offset += 4;
            foreach (["track", "album"] as $rgad_entry_type) {
                $rg_adjustment_word = getid3_lib::BigEndian2Int(
                    substr($parsedFrame["data"], $frame_offset, 2)
                );
                $frame_offset += 2;
                $parsedFrame["raw"][$rgad_entry_type]["name"] =
                    ($rg_adjustment_word & 0xe000) >> 13;
                $parsedFrame["raw"][$rgad_entry_type]["originator"] =
                    ($rg_adjustment_word & 0x1c00) >> 10;
                $parsedFrame["raw"][$rgad_entry_type]["signbit"] =
                    ($rg_adjustment_word & 0x0200) >> 9;
                $parsedFrame["raw"][$rgad_entry_type]["adjustment"] =
                    $rg_adjustment_word & 0x0100;
            }
            $parsedFrame["track"]["name"] = getid3_lib::RGADnameLookup(
                $parsedFrame["raw"]["track"]["name"]
            );
            $parsedFrame["track"][
                "originator"
            ] = getid3_lib::RGADoriginatorLookup(
                $parsedFrame["raw"]["track"]["originator"]
            );
            $parsedFrame["track"][
                "adjustment"
            ] = getid3_lib::RGADadjustmentLookup(
                $parsedFrame["raw"]["track"]["adjustment"],
                $parsedFrame["raw"]["track"]["signbit"]
            );
            $parsedFrame["album"]["name"] = getid3_lib::RGADnameLookup(
                $parsedFrame["raw"]["album"]["name"]
            );
            $parsedFrame["album"][
                "originator"
            ] = getid3_lib::RGADoriginatorLookup(
                $parsedFrame["raw"]["album"]["originator"]
            );
            $parsedFrame["album"][
                "adjustment"
            ] = getid3_lib::RGADadjustmentLookup(
                $parsedFrame["raw"]["album"]["adjustment"],
                $parsedFrame["raw"]["album"]["signbit"]
            );

            $info["replay_gain"]["track"]["peak"] =
                $parsedFrame["peakamplitude"];
            $info["replay_gain"]["track"]["originator"] =
                $parsedFrame["track"]["originator"];
            $info["replay_gain"]["track"]["adjustment"] =
                $parsedFrame["track"]["adjustment"];
            $info["replay_gain"]["album"]["originator"] =
                $parsedFrame["album"]["originator"];
            $info["replay_gain"]["album"]["adjustment"] =
                $parsedFrame["album"]["adjustment"];

            unset($parsedFrame["data"]);
        } elseif (
            $id3v2_majorversion >= 3 &&
            $parsedFrame["frame_name"] == "CHAP"
        ) {
            ...
            $frame_offset = 0;
            @list($parsedFrame["element_id"]) = explode(
                "\x00",
                $parsedFrame["data"],
                2
            );
            $frame_offset += strlen($parsedFrame["element_id"] . "\x00");
            $parsedFrame["time_begin"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], $frame_offset, 4)
            );
            $frame_offset += 4;
            $parsedFrame["time_end"] = getid3_lib::BigEndian2Int(
                substr($parsedFrame["data"], $frame_offset, 4)
            );
            $frame_offset += 4;
            if (
                ...
                $parsedFrame["offset_begin"] = getid3_lib::BigEndian2Int(
                    substr($parsedFrame["data"], $frame_offset, 4)
                );
            }
            $frame_offset += 4;
            if (
                ...
                // "If these bytes are all set to 0xFF then the value should be ignored and the start time value should be utilized."
                $parsedFrame["offset_end"] = getid3_lib::BigEndian2Int(
                    substr($parsedFrame["data"], $frame_offset, 4)
                );
            }
            $frame_offset += 4;
            ...
            if ($frame_offset < strlen($parsedFrame["data"])) {
                ...
                while ($frame_offset < strlen($parsedFrame["data"])) {
                    // <Optional embedded sub-frames>
                    $subframe = [];
                    $subframe["name"] = substr(
                        $parsedFrame["data"],
                        $frame_offset,
                        4
                    );
                    $frame_offset += 4;
                    $subframe["size"] = getid3_lib::BigEndian2Int(
                        substr($parsedFrame["data"], $frame_offset, 4)
                    );
                    $frame_offset += 4;
                    $subframe["flags_raw"] = getid3_lib::BigEndian2Int(
                        substr($parsedFrame["data"], $frame_offset, 2)
                    );
                    $frame_offset += 2;
                    if (
                        ...
                        $this->warning(
                            'CHAP subframe "' .
                                ...
                                ' claims to be "' .
                                $subframe["size"] .
                                '" bytes, which is more than the available data (' .
                                (strlen($parsedFrame["data"]) - $frame_offset) .
                                " bytes)"
                        );
                        break;
                    }
                    $subframe_rawdata = substr(
                        $parsedFrame["data"],
                        $frame_offset,
                        $subframe["size"]
                    );
                    ...
                    $subframe["encodingid"] = ord(
                        substr($subframe_rawdata, 0, 1)
                    );
                    $subframe["text"] = substr($subframe_rawdata, 1);
                    $subframe["encoding"] = $this->TextEncodingNameLookup(
                        $subframe["encodingid"]
                    );
                    $encoding_converted_text = trim(
                        getid3_lib::iconv_fallback(
                            $subframe["encoding"],
                            $info["encoding"],
                            $subframe["text"]
                    ...
                    switch (substr($encoding_converted_text, 0, 2)) {
                        ...
                        case "\xFE\xFF":
                            switch (strtoupper($info["id3v2"]["encoding"])) {
                                case "ISO-8859-1":
                                case "UTF-8":
                                    $encoding_converted_text = substr(
                    ...
                    switch ($subframe["name"]) {
                        ...
                        case "WXXX":
                            @list(
                                $subframe["chapter_url_description"],
                                $subframe["chapter_url"],
                            ) = explode("\x00", $encoding_converted_text, 2);
                        ...
                        case "APIC":
                            if (
                                ...
                                $subframe[
                                    "picture_type"
                                ] = $this->APICPictureTypeLookup(
                                    $subframe_apic_picturetype
                                );
                                $subframe["description"] = trim(
                                    getid3_lib::iconv_fallback(
                                        $subframe["encoding"],
                                        $info["encoding"],
                                        $subframe_apic_description
                                ...
                                if (
                                    ...
                                    $subframe_apic_picturedata = substr(
                                        $subframe_apic_picturedata,
                                        1
                                    );
                                }
                        ...
                        default:
                            $this->warning(
                                'ID3v2.CHAP subframe "' .
                                    $subframe["name"] .
                                    '" not handled (supported: TIT2, TIT3, WXXX, APIC)'
                            );
                            break;
                    }
                }
            ...
            for ($i = 0; $i < $parsedFrame["entry_count"]; $i++) {
                $terminator_position = strpos(
                    $parsedFrame["data"],
                    "\x00",
                    $frame_offset
                );
                $parsedFrame["child_element_ids"][$i] = substr(
                    $parsedFrame["data"],
                    $frame_offset,
                    $terminator_position - $frame_offset
                );
                $frame_offset = $terminator_position + 1;
            }

            $parsedFrame["ctoc_flags"]["ordered"] =
                (bool) ($ctoc_flags_raw & 0x01);
            $parsedFrame["ctoc_flags"]["top_level"] =
                (bool) ($ctoc_flags_raw & 0x03);
    ...
    public function LookupExtendedHeaderRestrictionsTagSizeLimits($index)
    {
        ...
        return isset($LookupExtendedHeaderRestrictionsTagSizeLimits[$index])
    ...
    public function LookupExtendedHeaderRestrictionsTextEncodings($index)
    {
        ...
        return isset($LookupExtendedHeaderRestrictionsTextEncodings[$index])
    ...
    public function LookupExtendedHeaderRestrictionsTextFieldSize($index)
    {
        ...
        return isset($LookupExtendedHeaderRestrictionsTextFieldSize[$index])
    ...
    public function LookupExtendedHeaderRestrictionsImageEncoding($index)
    {
        ...
        return isset($LookupExtendedHeaderRestrictionsImageEncoding[$index])
    ...
    public function LookupExtendedHeaderRestrictionsImageSizeSize($index)
    {
        ...
        return isset($LookupExtendedHeaderRestrictionsImageSizeSize[$index])
    ...
    public static function SYTLContentTypeLookup($index)
    {
        ...
        return isset($SYTLContentTypeLookup[$index])
    ...
    public static function APICPictureTypeLookup($index, $returnarray = false)
    {
        ...
        return isset($APICPictureTypeLookup[$index])
    ...
    public static function COMRReceivedAsLookup($index)
    {
        ...
        return isset($COMRReceivedAsLookup[$index])
    ...
    public static function RVA2ChannelTypeLookup($index)
    {
        ...
        return isset($RVA2ChannelTypeLookup[$index])
    ...
    public static function TextEncodingTerminatorLookup($encoding)
    {
        ...
        return isset($TextEncodingTerminatorLookup[$encoding])
    ...
    public static function TextEncodingNameLookup($encoding)
    {
        ...
        return isset($TextEncodingNameLookup[$encoding])
    ...
    public static function RemoveStringTerminator($string, $terminator)
    {
        ...
        if (
            substr($string, -strlen($terminator), strlen($terminator)) ===
            $terminator
        ) {
    ...
    public static function ID3v22iTunesBrokenFrameName($frame_name)
    {
        ...
        static $ID3v22_iTunes_BrokenFrames = [
        ...
        if (strlen($frame_name) == 4) {
            if (
                substr($frame_name, 3, 1) == " " ||
                substr($frame_name, 3, 1) == "\x00"
            ) {
                if (
                    isset(
                        $ID3v22_iTunes_BrokenFrames[substr($frame_name, 0, 3)]
                    )
                ) {
                    return $ID3v22_iTunes_BrokenFrames[
                        substr($frame_name, 0, 3)
                    ];
                }
            }
        }
