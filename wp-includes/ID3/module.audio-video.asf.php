...
getid3_lib::IncludeDependency(
    GETID3_INCLUDEPATH . "module.audio-video.riff.php",
    __FILE__,
    true
);
...
class getid3_asf extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        $thisfile_asf_headerobject["objectid"] = substr(
            $HeaderObjectData,
            0,
            16
        );
        $thisfile_asf_headerobject["objectid_guid"] = $this->BytestringToGUID(
            $thisfile_asf_headerobject["objectid"]
        );
        if (
            $thisfile_asf_headerobject["objectid"] != GETID3_ASF_Header_Object
        ) {
            unset($info["fileformat"], $info["asf"]);
            return $this->error(
                "ASF header GUID {" .
                    $this->BytestringToGUID(
                        $thisfile_asf_headerobject["objectid"]
                    ) .
                    '} does not match expected "GETID3_ASF_Header_Object" GUID {' .
                    $this->BytestringToGUID(GETID3_ASF_Header_Object) .
                    "}"
            );
        }
        $thisfile_asf_headerobject["objectsize"] = getid3_lib::LittleEndian2Int(
            substr($HeaderObjectData, 16, 8)
        );
        $thisfile_asf_headerobject[
            "headerobjects"
        ] = getid3_lib::LittleEndian2Int(substr($HeaderObjectData, 24, 4));
        $thisfile_asf_headerobject["reserved1"] = getid3_lib::LittleEndian2Int(
            substr($HeaderObjectData, 28, 1)
        );
        $thisfile_asf_headerobject["reserved2"] = getid3_lib::LittleEndian2Int(
            substr($HeaderObjectData, 29, 1)
        );

        $NextObjectOffset = $this->ftell();
        $ASFHeaderData = $this->fread(
            $thisfile_asf_headerobject["objectsize"] - 30
        );
        $offset = 0;
        ...
        for (
            ...
            $HeaderObjectsCounter < $thisfile_asf_headerobject["headerobjects"];
            $HeaderObjectsCounter++
        ) {
            $NextObjectGUID = substr($ASFHeaderData, $offset, 16);
            $offset += 16;
            $NextObjectGUIDtext = $this->BytestringToGUID($NextObjectGUID);
            $NextObjectSize = getid3_lib::LittleEndian2Int(
                substr($ASFHeaderData, $offset, 8)
            );
            $offset += 8;
            switch ($NextObjectGUID) {
                case GETID3_ASF_File_Properties_Object:
                    ...
                    $thisfile_asf_filepropertiesobject["offset"] =
                    ...
                    $thisfile_asf_filepropertiesobject["fileid"] = substr(
                        $ASFHeaderData,
                        $offset,
                        16
                    );
                    ...
                    $thisfile_asf_filepropertiesobject[
                        ...
                        $thisfile_asf_filepropertiesobject["fileid"]
                    );
                    $thisfile_asf_filepropertiesobject[
                        "filesize"
                    ...
                    $thisfile_asf_filepropertiesobject[
                        "creation_date_unix"
                    ] = $this->FILETIMEtoUNIXtime(
                        $thisfile_asf_filepropertiesobject["creation_date"]
                    );
                    $offset += 8;
                    $thisfile_asf_filepropertiesobject[
                        "data_packets"
                    ...
                    $thisfile_asf_filepropertiesobject[
                        ...
                        substr($ASFHeaderData, $offset, 4)
                    );
                    $offset += 4;
                    $thisfile_asf_filepropertiesobject["flags"]["broadcast"] =
                        (bool) ($thisfile_asf_filepropertiesobject[
                            "flags_raw"
                        ] & 0x0001);
                    $thisfile_asf_filepropertiesobject["flags"]["seekable"] =
                        (bool) ($thisfile_asf_filepropertiesobject[
                            "flags_raw"
                        ] & 0x0002);
                    ...
                    if (
                        ...
                        unset(
                            $thisfile_asf_filepropertiesobject["data_packets"]
                        );
                        unset(
                            $thisfile_asf_filepropertiesobject["play_duration"]
                        );
                        unset(
                            $thisfile_asf_filepropertiesobject["send_duration"]
                        );
                        unset(
                            $thisfile_asf_filepropertiesobject[
                                "min_packet_size"
                        ...
                        $info["playtime_seconds"] =
                            $thisfile_asf_filepropertiesobject[
                                ...
                                10000000 -
                            $thisfile_asf_filepropertiesobject["preroll"] /
                                1000;

                        //$info['bitrate'] = $thisfile_asf_filepropertiesobject['max_bitrate'];
                        $info["bitrate"] = getid3_lib::SafeDiv(
                            $thisfile_asf_filepropertiesobject["filesize"] * 8,
                            $info["playtime_seconds"]
                        );
                    }
                    break;
                ...
                case GETID3_ASF_Stream_Properties_Object:
                    ...
                    $StreamPropertiesObjectData["offset"] =
                        $NextObjectOffset + $offset;
                    ...
                    $StreamPropertiesObjectData["stream_type"] = substr(
                        $ASFHeaderData,
                        $offset,
                        16
                    );
                    ...
                    $StreamPropertiesObjectData[
                        ...
                        $StreamPropertiesObjectData["stream_type"]
                    );
                    $StreamPropertiesObjectData["error_correct_type"] = substr(
                        $ASFHeaderData,
                        $offset,
                        16
                    );
                    ...
                    $StreamPropertiesObjectData[
                        ...
                        $StreamPropertiesObjectData["error_correct_type"]
                    );
                    $StreamPropertiesObjectData[
                        "time_offset"
                    ] = getid3_lib::LittleEndian2Int(
                    ...
                    $StreamPropertiesObjectData[
                        ...
                        substr($ASFHeaderData, $offset, 2)
                    );
                    $offset += 2;
                    $StreamPropertiesObjectStreamNumber =
                        $StreamPropertiesObjectData["flags_raw"] & 0x007f;
                    $StreamPropertiesObjectData["flags"]["encrypted"] =
                        (bool) ($StreamPropertiesObjectData["flags_raw"] &
                            0x8000);

                    $offset += 4; // reserved - DWORD
                    $StreamPropertiesObjectData["type_specific_data"] = substr(
                        $ASFHeaderData,
                        $offset,
                        $StreamPropertiesObjectData["type_data_length"]
                    );
                    $offset += $StreamPropertiesObjectData["type_data_length"];
                    $StreamPropertiesObjectData["error_correct_data"] = substr(
                        $ASFHeaderData,
                        $offset,
                    ...
                    switch ($StreamPropertiesObjectData["stream_type"]) {
                        case GETID3_ASF_Audio_Media:
                            $thisfile_audio["dataformat"] = !empty(
                                $thisfile_audio["dataformat"]
                            )
                                ? $thisfile_audio["dataformat"]
                                : "asf";
                            $thisfile_audio["bitrate_mode"] = !empty(
                                $thisfile_audio["bitrate_mode"]
                            )
                                ? $thisfile_audio["bitrate_mode"]
                                : "cbr";

                            $audiodata = getid3_riff::parseWAVEFORMATex(
                                substr(
                                    $StreamPropertiesObjectData[
                                        "type_specific_data"
                                    ],
                        ...
                        case GETID3_ASF_Video_Media:
                            $thisfile_video["dataformat"] = !empty(
                                $thisfile_video["dataformat"]
                            )
                                ? $thisfile_video["dataformat"]
                                : "asf";
                            $thisfile_video["bitrate_mode"] = !empty(
                                $thisfile_video["bitrate_mode"]
                            )
                                ? $thisfile_video["bitrate_mode"]
                                : "cbr";
                            break;
                    ...
                    $thisfile_asf["stream_properties_object"][
                        $StreamPropertiesObjectStreamNumber
                    ] = $StreamPropertiesObjectData;
                ...
                case GETID3_ASF_Header_Extension_Object:
                    ...
                    $thisfile_asf_headerextensionobject["offset"] =
                        $NextObjectOffset + $offset;
                    $thisfile_asf_headerextensionobject[
                        "objectid"
                    ] = $NextObjectGUID;
                    ...
                    $thisfile_asf_headerextensionobject["reserved_1"] = substr(
                        $ASFHeaderData,
                        $offset,
                        16
                    );
                    ...
                    if (
                        ...
                        $this->warning(
                            "header_extension_object.reserved_1 GUID (" .
                                ...
                                $this->BytestringToGUID(GETID3_ASF_Reserved_1) .
                                ")"
                        );
                        //return false;
                        break;
                    ...
                    ] = $this->HeaderExtensionObjectDataParse(
                        $thisfile_asf_headerextensionobject["extension_data"],
                        $unhandled_sections
                    );
                ...
                case GETID3_ASF_Codec_List_Object:
                    ...
                    $thisfile_asf_codeclistobject["offset"] =
                        $NextObjectOffset + $offset;
                    ...
                    $thisfile_asf_codeclistobject["reserved"] = substr(
                        $ASFHeaderData,
                        $offset,
                        16
                    );
                    ...
                    $thisfile_asf_codeclistobject[
                        ...
                        $thisfile_asf_codeclistobject["reserved"]
                    );
                    if (
                        $thisfile_asf_codeclistobject["reserved"] !=
                        $this->GUIDtoBytestring(
                    ...
                    if (
                        $thisfile_asf_codeclistobject["codec_entries_count"] > 0
                    ) {
                    ...
                    for (
                        $CodecEntryCounter = 0;
                        $CodecEntryCounter <
                        $thisfile_asf_codeclistobject["codec_entries_count"];
                        $CodecEntryCounter++
                    ) {
                        // shortcut
                        $thisfile_asf_codeclistobject["codec_entries"][
                        ...
                        $thisfile_asf_codeclistobject_codecentries_current[
                            "type"
                        ] = self::codecListObjectTypeLookup(
                            $thisfile_asf_codeclistobject_codecentries_current[
                                "type_raw"
                            ]
                        );
                        ...
                        $CodecNameLength =
                            getid3_lib::LittleEndian2Int(
                                substr($ASFHeaderData, $offset, 2)
                            ) * 2; // 2 bytes per character
                        $offset += 2;
                        $thisfile_asf_codeclistobject_codecentries_current[
                            "name"
                        ] = substr($ASFHeaderData, $offset, $CodecNameLength);
                        ...
                        $CodecInformationLength = getid3_lib::LittleEndian2Int(
                            substr($ASFHeaderData, $offset, 2)
                        );
                        $offset += 2;
                        $thisfile_asf_codeclistobject_codecentries_current[
                        ...
                        if (
                            ...
                            if (
                                ...
                                $this->warning(
                                    "[asf][codec_list_object][codec_entries][" .
                                        $CodecEntryCounter .
                                        '][description] expected to contain comma-separated list of parameters: "' .
                                        $thisfile_asf_codeclistobject_codecentries_current[
                                            "description"
                                        ] .
                                        '"'
                                ...
                                $thisfile_audio["codec"] = $this->TrimConvert(
                                    $thisfile_asf_codeclistobject_codecentries_current[
                                        "name"
                                    ]
                                );
                                ...
                                if (
                                    empty($thisfile_video["bitrate"]) &&
                                    !empty($thisfile_audio["bitrate"]) &&
                                    !empty($info["bitrate"])
                                ) {
                                ...
                                $AudioCodecFrequency = (int) trim(
                                    str_replace("kHz", "", $AudioCodecFrequency)
                                );
                                ...
                                if (!isset($thisfile_audio["channels"])) {
                                    if (strstr($AudioCodecChannels, "stereo")) {
                                        ...
                                        strstr($AudioCodecChannels, "mono")
                                    ) {
                ...
                case GETID3_ASF_Script_Command_Object:
                    ...
                    $thisfile_asf_scriptcommandobject["offset"] =
                        $NextObjectOffset + $offset;
                    $thisfile_asf_scriptcommandobject[
                        "objectid"
                    ] = $NextObjectGUID;
                    ...
                    $thisfile_asf_scriptcommandobject["reserved"] = substr(
                        $ASFHeaderData,
                        $offset,
                        16
                    );
                    ...
                    $thisfile_asf_scriptcommandobject[
                        ...
                        $thisfile_asf_scriptcommandobject["reserved"]
                    );
                    if (
                        $thisfile_asf_scriptcommandobject["reserved"] !=
                        $this->GUIDtoBytestring(
                    ...
                    for (
                        ...
                        $offset += 2;
                        $thisfile_asf_scriptcommandobject["command_types"][
                            $CommandTypesCounter
                        ]["name"] = substr(
                            $ASFHeaderData,
                            $offset,
                    ...
                    for (
                        $CommandsCounter = 0;
                        $CommandsCounter <
                        $thisfile_asf_scriptcommandobject["commands_count"];
                        $CommandsCounter++
                    ) {
                        $thisfile_asf_scriptcommandobject["commands"][
                            $CommandsCounter
                        ]["presentation_time"] = getid3_lib::LittleEndian2Int(
                            substr($ASFHeaderData, $offset, 4)
                        );
                        $offset += 4;
                        $thisfile_asf_scriptcommandobject["commands"][
                            $CommandsCounter
                        ]["type_index"] = getid3_lib::LittleEndian2Int(
                            substr($ASFHeaderData, $offset, 2)
                        );
                        $offset += 2;
                ...
                case GETID3_ASF_Marker_Object:
                    ...
                    $thisfile_asf_markerobject["offset"] =
                        $NextObjectOffset + $offset;
                    ...
                    $thisfile_asf_markerobject["reserved"] = substr(
                        $ASFHeaderData,
                        $offset,
                        16
                    );
                    ...
                    $thisfile_asf_markerobject[
                        ...
                        $thisfile_asf_markerobject["reserved"]
                    );
                    if (
                        $thisfile_asf_markerobject["reserved"] !=
                        $this->GUIDtoBytestring(
                    ...
                    if ($thisfile_asf_markerobject["reserved_2"] != 0) {
                        $this->warning(
                            "marker_object.reserved_2 (" .
                                $thisfile_asf_markerobject["reserved_2"] .
                    ...
                    for (
                        $MarkersCounter = 0;
                        $MarkersCounter <
                        $thisfile_asf_markerobject["markers_count"];
                        $MarkersCounter++
                    ) {
                        $thisfile_asf_markerobject["markers"][$MarkersCounter][
                            "offset"
                        ] = getid3_lib::LittleEndian2Int(
                            substr($ASFHeaderData, $offset, 8)
                        );
                        ...
                        $thisfile_asf_markerobject["markers"][$MarkersCounter][
                            ...
                            $ASFHeaderData,
                            $offset,
                            $thisfile_asf_markerobject["markers"][
                                $MarkersCounter
                            ]["marker_description_length"]
                        );
                        $offset +=
                ...
                case GETID3_ASF_Bitrate_Mutual_Exclusion_Object:
                    ...
                    $thisfile_asf_bitratemutualexclusionobject["offset"] =
                        $NextObjectOffset + $offset;
                    $thisfile_asf_bitratemutualexclusionobject[
                        "objectid"
                    ] = $NextObjectGUID;
                    ...
                    $thisfile_asf_bitratemutualexclusionobject[
                        "reserved"
                    ] = substr($ASFHeaderData, $offset, 16);
                    $thisfile_asf_bitratemutualexclusionobject[
                        "reserved_guid"
                    ] = $this->BytestringToGUID(
                        $thisfile_asf_bitratemutualexclusionobject["reserved"]
                    );
                    $offset += 16;
                    if (
                        $thisfile_asf_bitratemutualexclusionobject[
                    ...
                    for (
                        ...
                        $thisfile_asf_bitratemutualexclusionobject[
                            "stream_numbers"
                        ][$StreamNumberCounter] = getid3_lib::LittleEndian2Int(
                            substr($ASFHeaderData, $offset, 2)
                        );
                        $offset += 2;
                    }
                ...
                case GETID3_ASF_Error_Correction_Object:
                    ...
                    $thisfile_asf_errorcorrectionobject["offset"] =
                        $NextObjectOffset + $offset;
                    $thisfile_asf_errorcorrectionobject[
                        "objectid"
                    ] = $NextObjectGUID;
                    ...
                    switch (
                        ...
                        case GETID3_ASF_Audio_Spread:
                            ...
                            $thisfile_asf_errorcorrectionobject[
                                ...
                                substr($ASFHeaderData, $offset, 1)
                            );
                            $offset += 1;
                            $thisfile_asf_errorcorrectionobject[
                                "virtual_packet_length"
                            ] = getid3_lib::LittleEndian2Int(
                                substr($ASFHeaderData, $offset, 2)
                            );
                            $offset += 2;
                            $thisfile_asf_errorcorrectionobject[
                                "virtual_chunk_length"
                            ] = getid3_lib::LittleEndian2Int(
                                substr($ASFHeaderData, $offset, 2)
                            );
                            $offset += 2;
                ...
                case GETID3_ASF_Content_Description_Object:
                    ...
                    $thisfile_asf_contentdescriptionobject["offset"] =
                        $NextObjectOffset + $offset;
                    $thisfile_asf_contentdescriptionobject[
                        "objectid"
                    ] = $NextObjectGUID;
                    ...
                    $offset += 2;
                    $thisfile_asf_contentdescriptionobject["title"] = substr(
                        $ASFHeaderData,
                        $offset,
                    ...
                    $offset +=
                        $thisfile_asf_contentdescriptionobject["title_length"];
                    $thisfile_asf_contentdescriptionobject["author"] = substr(
                        $ASFHeaderData,
                        $offset,
                    ...
                    $thisfile_asf_contentdescriptionobject["rating"] = substr(
                        $ASFHeaderData,
                        $offset,
                ...
                case GETID3_ASF_Extended_Content_Description_Object:
                    ...
                    $thisfile_asf_extendedcontentdescriptionobject["offset"] =
                        $NextObjectOffset + $offset;
                    $thisfile_asf_extendedcontentdescriptionobject[
                        "objectid"
                    ] = $NextObjectGUID;
                    ...
                    for (
                        ...
                        switch (
                            ...
                            case 0x0002: // BOOL
                                $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current[
                                    "value"
                                ] = (bool) getid3_lib::LittleEndian2Int(
                                    $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current[
                                        "value"
                                    ]
                                );
                            ...
                            default:
                                $this->warning(
                                    "extended_content_description.content_descriptors." .
                                        $ExtendedContentDescriptorsCounter .
                        ...
                        switch (
                            ...
                            case "artist":
                                ...
                                $thisfile_asf_comments["albumartist"] = [
                                    $this->TrimTerm(
                                        $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current[
                                            "value"
                                        ]
                            ...
                            case "wm/partofset":
                                $thisfile_asf_comments["partofset"] = [
                                    $this->TrimTerm(
                                        $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current[
                                            "value"
                                        ]
                            ...
                            case "tracknumber":
                                ...
                                $thisfile_asf_comments["track_number"] = [
                                    $this->TrimTerm(
                                        $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current[
                                            "value"
                                        ]
                            ...
                            case "wm/encodingtime":
                                ...
                                $thisfile_asf_comments["encoding_time_unix"] = [
                                    $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current[
                                        "encoding_time_unix"
                                    ],
                                ];
...
*/
                ...
                case GETID3_ASF_Stream_Bitrate_Properties_Object:
                    ...
                    $thisfile_asf_streambitratepropertiesobject["offset"] =
                        $NextObjectOffset + $offset;
                    $thisfile_asf_streambitratepropertiesobject[
                        "objectid"
                    ] = $NextObjectGUID;
                    ...
                    for (
                        ...
                        $thisfile_asf_streambitratepropertiesobject[
                            "bitrate_records"
                        ][$BitrateRecordsCounter]["flags"]["stream_number"] =
                            $thisfile_asf_streambitratepropertiesobject[
                                "bitrate_records"
                            ][$BitrateRecordsCounter]["flags_raw"] & 0x007f;
                        $thisfile_asf_streambitratepropertiesobject[
                            "bitrate_records"
                        ][$BitrateRecordsCounter][
                            "bitrate"
                ...
                case GETID3_ASF_Padding_Object:
                    ...
                    $thisfile_asf_paddingobject["offset"] =
                        $NextObjectOffset + $offset;
                    ...
                    $thisfile_asf_paddingobject["padding_length"] =
                        $thisfile_asf_paddingobject["objectsize"] - 16 - 8;
                    $thisfile_asf_paddingobject["padding"] = substr(
                        $ASFHeaderData,
                        $offset,
                        $thisfile_asf_paddingobject["padding_length"]
                    );
                ...
                default:
                    ...
                    if ($this->GUIDname($NextObjectGUIDtext)) {
                        $this->warning(
                            'unhandled GUID "' .
                                $this->GUIDname($NextObjectGUIDtext) .
                                '" {' .
                                $NextObjectGUIDtext .
                                "} in ASF header at offset " .
                                ($offset - 16 - 8)
                        );
                    } else {
                        $this->warning(
        ...
        if (
            isset($thisfile_asf["stream_properties_object"]) &&
            is_array($thisfile_asf["stream_properties_object"])
        ) {
            ...
            foreach (
                ...
                switch ($streamdata["stream_type"]) {
                    case GETID3_ASF_Audio_Media:
                        ...
                        $thisfile_asf_audiomedia_currentstream = getid3_riff::parseWAVEFORMATex(
                            substr(
                                $streamdata["type_specific_data"],
                                $audiomediaoffset,
                                16
                            )
                        );
                        ...
                        switch (
                            $thisfile_asf_audiomedia_currentstream["raw"][
                                "wFormatTag"
                            ]
                        ) {
                            case 0x0001: // PCM
                        ...
                        $thisfile_audio["streams"][$streamnumber]["lossless"] =
                    ...
                    case GETID3_ASF_Video_Media:
                        ...
                        $videomediaoffset += 2;
                        $thisfile_asf_videomedia_currentstream["format_data"][
                            "format_data_size"
                        ] = getid3_lib::LittleEndian2Int(
                            substr(
                                $streamdata["type_specific_data"],
                        ...
                        if (
                            ...
                            foreach (
                                ...
                                if (
                                    ...
                                    $thisfile_video["streams"][$streamnumber][
                                        "bitrate"
                                    ] = $dataarray["bitrate"];
                                    $thisfile_video["bitrate"] +=
                                        $dataarray["bitrate"];
                        ...
                        $thisfile_video["streams"][$streamnumber]["fourcc"] =
                            $thisfile_asf_videomedia_currentstream[
                                "format_data"
                            ]["codec_fourcc"];
                        $thisfile_video["streams"][$streamnumber]["codec"] =
                            $thisfile_asf_videomedia_currentstream[
                                "format_data"
                            ]["codec"];
                        $thisfile_video["streams"][$streamnumber][
        ...
        while ($this->ftell() < $info["avdataend"]) {
            ...
            $NextObjectGUIDtext = $this->BytestringToGUID($NextObjectGUID);
            $NextObjectSize = getid3_lib::LittleEndian2Int(
                substr($NextObjectDataHeader, $offset, 8)
            );
            $offset += 8;
            ...
            switch ($NextObjectGUID) {
                case GETID3_ASF_Data_Object:
                    ...
                    $DataObjectData =
                        $NextObjectDataHeader . $this->fread(50 - 24);
                    $offset = 24;
                    ...
                    $thisfile_asf_dataobject["fileid"] = substr(
                        $DataObjectData,
                        $offset,
                        16
                    );
                    ...
                    $thisfile_asf_dataobject[
                        ...
                        $thisfile_asf_dataobject["fileid"]
                    );
                    $thisfile_asf_dataobject[
                        "total_data_packets"
                    ] = getid3_lib::LittleEndian2Int(
                        substr($DataObjectData, $offset, 8)
                    );
                    $offset += 8;
                    $thisfile_asf_dataobject[
                        "reserved"
                    ] = getid3_lib::LittleEndian2Int(
                        substr($DataObjectData, $offset, 2)
                    );
                    $offset += 2;
                    if ($thisfile_asf_dataobject["reserved"] != 0x0101) {
                        $this->warning(
                            "data_object.reserved (0x" .
                                sprintf(
                                    "%04X",
                                    $thisfile_asf_dataobject["reserved"]
                                ) .
                    ...
                    $this->fseek(
                        $thisfile_asf_dataobject["objectsize"] - 50,
                        SEEK_CUR
                ...
                case GETID3_ASF_Simple_Index_Object:
                    ...
                    $SimpleIndexObjectData =
                        $NextObjectDataHeader . $this->fread(56 - 24);
                    $offset = 24;
                    ...
                    $thisfile_asf_simpleindexobject["fileid"] = substr(
                        $SimpleIndexObjectData,
                        $offset,
                        16
                    );
                    ...
                    $thisfile_asf_simpleindexobject[
                        ...
                        $thisfile_asf_simpleindexobject["fileid"]
                    );
                    $thisfile_asf_simpleindexobject[
                        "index_entry_time_interval"
                    ] = getid3_lib::LittleEndian2Int(
                        substr($SimpleIndexObjectData, $offset, 8)
                    );
                    $offset += 8;
                    $thisfile_asf_simpleindexobject[
                        "maximum_packet_count"
                    ] = getid3_lib::LittleEndian2Int(
                        substr($SimpleIndexObjectData, $offset, 4)
                    );
                    $offset += 4;
                    $thisfile_asf_simpleindexobject[
                        "index_entries_count"
                    ...
                    for (
                        ...
                        $IndexEntriesCounter <
                        $thisfile_asf_simpleindexobject["index_entries_count"];
                        $IndexEntriesCounter++
                    ) {
                        $thisfile_asf_simpleindexobject["index_entries"][
                            $IndexEntriesCounter
                        ]["packet_number"] = getid3_lib::LittleEndian2Int(
                            substr($IndexEntriesData, $offset, 4)
                        );
                        $offset += 4;
                        $thisfile_asf_simpleindexobject["index_entries"][
                            $IndexEntriesCounter
                        ]["packet_count"] = getid3_lib::LittleEndian2Int(
                            substr($IndexEntriesData, $offset, 4)
                        );
                        $offset += 2;
                    }
                ...
                case GETID3_ASF_Index_Object:
                    ...
                    $ASFIndexObjectData =
                        $NextObjectDataHeader . $this->fread(34 - 24);
                    $offset = 24;
                    ...
                    $thisfile_asf_asfindexobject[
                        ...
                        substr($ASFIndexObjectData, $offset, 4)
                    );
                    $offset += 4;
                    $thisfile_asf_asfindexobject[
                        "index_specifiers_count"
                    ] = getid3_lib::LittleEndian2Int(
                        substr($ASFIndexObjectData, $offset, 2)
                    );
                    $offset += 2;
                    $thisfile_asf_asfindexobject[
                        "index_blocks_count"
                    ...
                    for (
                        ...
                        $thisfile_asf_asfindexobject["index_specifiers_count"];
                        $IndexSpecifiersCounter++
                    ) {
                        $IndexSpecifierStreamNumber = getid3_lib::LittleEndian2Int(
                            substr($ASFIndexObjectData, $offset, 2)
                        );
                        $offset += 2;
                        $thisfile_asf_asfindexobject["index_specifiers"][
                            $IndexSpecifiersCounter
                        ]["stream_number"] = $IndexSpecifierStreamNumber;
                        $thisfile_asf_asfindexobject["index_specifiers"][
                            $IndexSpecifiersCounter
                        ]["index_type"] = getid3_lib::LittleEndian2Int(
                            substr($ASFIndexObjectData, $offset, 2)
                        );
                        $offset += 2;
                        $thisfile_asf_asfindexobject["index_specifiers"][
                            ...
                            "index_type_text"
                        ] = $this->ASFIndexObjectIndexTypeLookup(
                            $thisfile_asf_asfindexobject["index_specifiers"][
                                $IndexSpecifiersCounter
                            ]["index_type"]
                        );
                    ...
                    for (
                        ...
                        $thisfile_asf_asfindexobject["block_positions"][
                            $IndexSpecifiersCounter
                        ] = getid3_lib::LittleEndian2Int(
                            substr($ASFIndexObjectData, $offset, 8)
                        );
                        $offset += 8;
                    }
                    ...
                    $ASFIndexObjectData .= $this->fread(
                        4 *
                            ...
                            $thisfile_asf_asfindexobject["index_entry_count"]
                    );
                    for (
                        $IndexEntryCounter = 0;
                        $IndexEntryCounter <
                        ...
                        for (
                            ...
                            $thisfile_asf_asfindexobject["offsets"][
                                $IndexSpecifiersCounter
                            ][
                                $IndexEntryCounter
                            ] = getid3_lib::LittleEndian2Int(
        ...
        if (
            isset($thisfile_asf_codeclistobject["codec_entries"]) &&
            is_array($thisfile_asf_codeclistobject["codec_entries"])
        ) {
            foreach (
                $thisfile_asf_codeclistobject["codec_entries"]
                as $streamnumber => $streamdata
                    ...
                    default:
                        switch ($streamdata["type_raw"]) {
                            case 1:
                                if (
                                    strstr(
                                        $this->TrimConvert($streamdata["name"]),
                                        "Windows Media"
                                    )
                                ) {
                                    $thisfile_video["dataformat"] = "wmv";
        ...
        switch (
            isset($thisfile_audio["codec"]) ? $thisfile_audio["codec"] : ""
        ) {
            case "MPEG Layer-3":
        ...
        if (isset($thisfile_asf_codeclistobject["codec_entries"])) {
            foreach (
                ...
                switch ($streamdata["type_raw"]) {
                    case 1: // video
                        $thisfile_video["encoder"] = $this->TrimConvert(
                            $thisfile_asf_codeclistobject["codec_entries"][
                                $streamnumber
                            ]["name"]
                        );
                    ...
                    case 2: // audio
                        $thisfile_audio["encoder"] = $this->TrimConvert(
                            $thisfile_asf_codeclistobject["codec_entries"][
                                $streamnumber
                            ]["name"]
                        );
                        ...
                        // AH 2003-10-01
                        $thisfile_audio["encoder_options"] = $this->TrimConvert(
                            $thisfile_asf_codeclistobject["codec_entries"][0][
                                "description"
                            ]
                        );
                    ...
                    default:
                        $this->warning(
                            "Unknown streamtype: [codec_list_object][codec_entries][" .
                                $streamnumber .
                                "][type_raw] == " .
                                $streamdata["type_raw"]
                        );
        ...
        if (isset($info["audio"])) {
            $thisfile_audio["lossless"] = isset($thisfile_audio["lossless"])
                ? $thisfile_audio["lossless"]
                : false;
            $thisfile_audio["dataformat"] = !empty(
                $thisfile_audio["dataformat"]
        ...
        if (!empty($thisfile_video["dataformat"])) {
            $thisfile_video["lossless"] = isset($thisfile_audio["lossless"])
                ? $thisfile_audio["lossless"]
                : false;
            $thisfile_video["pixel_aspect_ratio"] = isset(
                $thisfile_audio["pixel_aspect_ratio"]
            )
                ? $thisfile_audio["pixel_aspect_ratio"]
                : (float) 1;
            $thisfile_video["dataformat"] = !empty(
        ...
        if (!empty($thisfile_video["streams"])) {
            ...
            foreach ($thisfile_video["streams"] as $key => $valuearray) {
                if (
                    $valuearray["resolution_x"] >
                        $thisfile_video["resolution_x"] ||
                    $valuearray["resolution_y"] >
    ...
    public static function codecListObjectTypeLookup($CodecListType)
    {
        ...
        return isset($lookup[$CodecListType])
            ? $lookup[$CodecListType]
            : "Invalid Codec Type";
    }
    ...
    public static function KnownGUIDs()
    {
        static $GUIDarray = [
            ...
            "GETID3_ASF_Index_Placeholder_Object" =>
                "D9AADE20-7C17-4F9C-BC28-8555DD98E2A2", // https://metacpan.org/dist/Audio-WMA/source/WMA.pm
            "GETID3_ASF_Compatibility_Object" =>
                "26F18B5D-4584-47EC-9F5F-0E651F0452C9", // https://metacpan.org/dist/Audio-WMA/source/WMA.pm
            "GETID3_ASF_Media_Object_Index_Parameters_Object" =>
    ...
    public static function ASFIndexObjectIndexTypeLookup($id)
    {
        ...
        return isset($ASFIndexObjectIndexTypeLookup[$id])
    ...
    {
        $GUIDstring = str_pad(
            dechex(ord($Bytestring[3])),
            2,
            "0",
            STR_PAD_LEFT
        );
        $GUIDstring .= str_pad(
            dechex(ord($Bytestring[2])),
            2,
            "0",
            STR_PAD_LEFT
        );
        $GUIDstring .= str_pad(
            dechex(ord($Bytestring[1])),
            2,
            "0",
            STR_PAD_LEFT
        );
        $GUIDstring .= str_pad(
            dechex(ord($Bytestring[0])),
            2,
            "0",
            STR_PAD_LEFT
        );
        $GUIDstring .= "-";
        $GUIDstring .= str_pad(
            dechex(ord($Bytestring[5])),
            2,
            "0",
            STR_PAD_LEFT
        );
        $GUIDstring .= str_pad(
            dechex(ord($Bytestring[4])),
            2,
            "0",
            STR_PAD_LEFT
        );
        $GUIDstring .= "-";
        $GUIDstring .= str_pad(
            dechex(ord($Bytestring[7])),
            2,
            "0",
            STR_PAD_LEFT
        );
        $GUIDstring .= str_pad(
            dechex(ord($Bytestring[6])),
            2,
            "0",
            STR_PAD_LEFT
        );
        $GUIDstring .= "-";
        $GUIDstring .= str_pad(
            dechex(ord($Bytestring[8])),
            2,
            "0",
            STR_PAD_LEFT
        );
        $GUIDstring .= str_pad(
            dechex(ord($Bytestring[9])),
            2,
            "0",
            STR_PAD_LEFT
        );
        $GUIDstring .= "-";
        $GUIDstring .= str_pad(
            dechex(ord($Bytestring[10])),
            2,
            "0",
            STR_PAD_LEFT
        );
        $GUIDstring .= str_pad(
            dechex(ord($Bytestring[11])),
            2,
            "0",
            STR_PAD_LEFT
        );
        $GUIDstring .= str_pad(
            dechex(ord($Bytestring[12])),
            2,
            "0",
            STR_PAD_LEFT
        );
        $GUIDstring .= str_pad(
            dechex(ord($Bytestring[13])),
            2,
            "0",
            STR_PAD_LEFT
        );
        $GUIDstring .= str_pad(
            dechex(ord($Bytestring[14])),
            2,
            "0",
            STR_PAD_LEFT
        );
        $GUIDstring .= str_pad(
            dechex(ord($Bytestring[15])),
            2,
            "0",
            STR_PAD_LEFT
        );
     ...
     * @return array
     */
    public function HeaderExtensionObjectDataParse(
        ...
        while ($objectOffset < strlen($asf_header_extension_object_data)) {
            ...
            $thisObject["guid"] = substr(
                $asf_header_extension_object_data,
                $offset,
                16
            );
            $offset += 16;
            $thisObject["guid_text"] = $this->BytestringToGUID(
                $thisObject["guid"]
            );
            $thisObject["guid_name"] = $this->GUIDname(
                $thisObject["guid_text"]
            );

            $thisObject["size"] = getid3_lib::LittleEndian2Int(
                substr($asf_header_extension_object_data, $offset, 8)
            );
            $offset += 8;
            ...
            switch ($thisObject["guid"]) {
                case GETID3_ASF_Extended_Stream_Properties_Object:
                    $thisObject["start_time"] = getid3_lib::LittleEndian2Int(
                        substr($asf_header_extension_object_data, $offset, 8)
                    );
                    $offset += 8;
                    $thisObject["start_time_unix"] = $this->FILETIMEtoUNIXtime(
                        $thisObject["start_time"]
                    );

                    $thisObject["end_time"] = getid3_lib::LittleEndian2Int(
                        substr($asf_header_extension_object_data, $offset, 8)
                    );
                    $offset += 8;
                    $thisObject["end_time_unix"] = $this->FILETIMEtoUNIXtime(
                        $thisObject["end_time"]
                    );

                    $thisObject["data_bitrate"] = getid3_lib::LittleEndian2Int(
                        substr($asf_header_extension_object_data, $offset, 4)
                    );
                    $offset += 4;

                    $thisObject["buffer_size"] = getid3_lib::LittleEndian2Int(
                        substr($asf_header_extension_object_data, $offset, 4)
                    );
                    $offset += 4;
                    ...
                    $thisObject["flags_raw"] = getid3_lib::LittleEndian2Int(
                        substr($asf_header_extension_object_data, $offset, 4)
                    );
                    $offset += 4;
                    $thisObject["flags"]["reliable"] =
                        (bool) $thisObject["flags_raw"] & 0x00000001;
                    $thisObject["flags"]["seekable"] =
                        (bool) $thisObject["flags_raw"] & 0x00000002;
                    $thisObject["flags"]["no_cleanpoints"] =
                        (bool) $thisObject["flags_raw"] & 0x00000004;
                    $thisObject["flags"]["resend_live_cleanpoints"] =
                        (bool) $thisObject["flags_raw"] & 0x00000008;

                    $thisObject["stream_number"] = getid3_lib::LittleEndian2Int(
                        substr($asf_header_extension_object_data, $offset, 2)
                    );
                    $offset += 2;
                    ...
                    for (
                        $i = 0;
                        $i < $thisObject["payload_extension_system_count"];
                        $i++
                    ) {
                        $payloadExtensionSystem = [];

                        $payloadExtensionSystem["extension_system_id"] = substr(
                            $asf_header_extension_object_data,
                            $offset,
                            16
                        );
                        $offset += 16;
                        $payloadExtensionSystem[
                            "extension_system_id_text"
                        ] = $this->BytestringToGUID(
                            $payloadExtensionSystem["extension_system_id"]
                        );
                        ...
                        $offset += 2;
                        if (
                            $payloadExtensionSystem["extension_system_size"] <=
                            0
                        ) {
                            break 2;
                        }
                        ...
                        $thisObject["payload_extension_systems"][
                            $i
                        ] = $payloadExtensionSystem;
                    }
                ...
                case GETID3_ASF_Advanced_Mutual_Exclusion_Object:
                    $thisObject["exclusion_type"] = substr(
                        $asf_header_extension_object_data,
                        $offset,
                        16
                    );
                    ...
                    $thisObject[
                        "exclusion_type_text"
                    ] = $this->BytestringToGUID($thisObject["exclusion_type"]);
                    ...
                    for (
                        $i = 0;
                        $i < $thisObject["stream_numbers_count"];
                        $i++
                    ) {
                        $thisObject["stream_numbers"][
                            $i
                        ] = getid3_lib::LittleEndian2Int(
                            substr(
                                $asf_header_extension_object_data,
                ...
                case GETID3_ASF_Stream_Prioritization_Object:
                    ...
                    for (
                        $i = 0;
                        $i < $thisObject["priority_records_count"];
                        $i++
                    ) {
                        $priorityRecord = [];
                        ...
                        $offset += 2;
                        $priorityRecord["flags"]["mandatory"] =
                            (bool) $priorityRecord["flags_raw"] & 0x00000001;
                ...
                case GETID3_ASF_Metadata_Object:
                    ...
                    for (
                        $i = 0;
                        $i < $thisObject["description_record_counts"];
                        $i++
                    ) {
                        $descriptionRecord = [];
                        ...
                        $descriptionRecord[
                            "data_type_text"
                        ] = self::metadataLibraryObjectDataTypeLookup(
                            $descriptionRecord["data_type"]
                        );
                ...
                case GETID3_ASF_Language_List_Object:
                    ...
                    for (
                        $i = 0;
                        $i < $thisObject["language_id_record_counts"];
                        $i++
                    ) {
                        $languageIDrecord = [];
                        ...
                        $languageIDrecord["language_id"] = substr(
                            $asf_header_extension_object_data,
                            $offset,
                ...
                case GETID3_ASF_Metadata_Library_Object:
                    ...
                    for (
                        $i = 0;
                        $i < $thisObject["description_records_count"];
                        $i++
                    ) {
                        $descriptionRecord = [];
                ...
                case GETID3_ASF_Index_Parameters_Object:
                    ...
                    for (
                        $i = 0;
                        $i < $thisObject["index_specifiers_count"];
                        $i++
                    ) {
                        $indexSpecifier = [];
                        ...
                        $offset += 2;
                        $indexSpecifier["index_type_text"] = isset(
                            static
                ...
                case GETID3_ASF_Compatibility_Object:
                    $thisObject["profile"] = getid3_lib::LittleEndian2Int(
                        substr($asf_header_extension_object_data, $offset, 1)
                    );
                    $offset += 1;

                    $thisObject["mode"] = getid3_lib::LittleEndian2Int(
                        substr($asf_header_extension_object_data, $offset, 1)
                    );
                    $offset += 1;
                ...
                default:
                    ...
                    if ($this->GUIDname($thisObject["guid_text"])) {
                        $this->warning(
                            'unhandled Header Extension Object GUID "' .
                                $this->GUIDname($thisObject["guid_text"]) .
                                '" {' .
                                $thisObject["guid_text"] .
                                "} at offset " .
                                ($offset - 16 - 8)
                        ...
                        $this->warning(
                            "unknown Header Extension Object GUID {" .
                                $thisObject["guid_text"] .
                                "} in at offset " .
                                ($offset - 16 - 8)
                        );
    ...
    public function ASF_WMpicture(&$data)
    {
        ...
        $offset = 0;
        $WMpicture["image_type_id"] = getid3_lib::LittleEndian2Int(
            substr($data, $offset, 1)
        );
        $offset += 1;
        $WMpicture["image_type"] = self::WMpictureTypeLookup(
            $WMpicture["image_type_id"]
        );
        $WMpicture["image_size"] = getid3_lib::LittleEndian2Int(
        ...
        unset($imageinfo);
        if (!empty($imagechunkcheck)) {
            $WMpicture["image_mime"] = image_type_to_mime_type(
                $imagechunkcheck[2]
            );
        }
