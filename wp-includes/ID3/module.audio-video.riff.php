        ...
        switch ($RIFFtype) {
            ...
            case "RMP3": // RMP3 is identical to RIFF, just renamed. Used by [unknown program] when creating RIFF-MP3s
                ...
                while (
                    ...
                    $nextRIFFsize = $this->EitherEndian2Int(
                        substr($nextRIFFheader, 4, 4)
                    );
                    ...
                    switch ($nextRIFFheaderID) {
                        case "RIFF":
                            $chunkdata["chunks"] = $this->ParseRIFF(
                                $chunkdata["offset"] + 4,
                                $nextRIFFoffset
                            );
                        ...
                        case "IDVX":
                            $info["divxtag"]["comments"] = self::ParseDIVXTAG(
                                $this->fread($chunkdata["size"])
                            );
                            break;
                        ...
                        default:
                            if (
                                $info["filesize"] ==
                                $chunkdata["offset"] - 8 + 128
                            ) {
                                $DIVXTAG =
                                    $nextRIFFheader . $this->fread(128 - 12);
                                if (substr($DIVXTAG, -7) == "DIVXTAG") {
                                    // DIVXTAG is supposed to be inside an IDVX chunk in a LIST chunk, but some bad encoders just slap it on the end of a file
                                    $this->warning(
                                        "Found wrongly-structured DIVXTAG at offset " .
                                            ($this->ftell() - 128) .
                                            ", parsing anyway"
                                    );
                                    $info["divxtag"][
                                        "comments"
                                    ] = self::ParseDIVXTAG($DIVXTAG);
                                    break 2;
                                }
                            }
                            $this->warning(
                                'Expecting "RIFF|JUNK|IDVX" at ' .
                                    $nextRIFFoffset .
                                    ', found "' .
                                    $nextRIFFheaderID .
                                    '" (' .
            ...
            default:
                $this->error(
                    'Cannot parse RIFF (this is maybe not a RIFF / WAV / AVI file?) - expecting "FORM|RIFF|SDSS|RMP3" found "' .
                        $RIFFsubtype .
                        '" instead'
                );
        ...
        switch ($RIFFsubtype) {
            ...
            case "WAVE":
                ...
                if (isset($thisfile_riff_WAVE["data"][0]["offset"])) {
                    $info["avdataoffset"] =
                        $thisfile_riff_WAVE["data"][0]["offset"] + 8;
                    $info["avdataend"] =
                        $info["avdataoffset"] +
                ...
                if (isset($thisfile_riff_WAVE["fmt "][0]["data"])) {
                    $thisfile_riff_audio[
                        $streamindex
                    ] = self::parseWAVEFORMATex(
                        $thisfile_riff_WAVE["fmt "][0]["data"]
                    );
                    $thisfile_audio["wformattag"] =
                        $thisfile_riff_audio[$streamindex]["raw"]["wFormatTag"];
                    if (
                        !isset($thisfile_riff_audio[$streamindex]["bitrate"]) ||
                    ...
                    $thisfile_riff_raw["fmt "] =
                        $thisfile_riff_audio[$streamindex]["raw"];
                    unset($thisfile_riff_audio[$streamindex]["raw"]);
                    $thisfile_audio["streams"][$streamindex] =
                        $thisfile_riff_audio[$streamindex];

                    $thisfile_audio = (array) getid3_lib::array_merge_noclobber(
                        $thisfile_audio,
                        $thisfile_riff_audio[$streamindex]
                    );
                    if (
                        ...
                        $this->warning(
                            "Audio codec = " . $thisfile_audio["codec"]
                        );
                    }
                    $thisfile_audio["bitrate"] =
                        $thisfile_riff_audio[$streamindex]["bitrate"];

                    if (empty($info["playtime_seconds"])) {
                        // may already be set (e.g. DTS-WAV)
                        $info["playtime_seconds"] = (float) getid3_lib::SafeDiv(
                    ...
                    if (
                        isset($thisfile_riff_WAVE["data"][0]["offset"]) &&
                        isset($thisfile_riff_raw["fmt "]["wFormatTag"])
                    ) {
                    ...
                    $thisfile_audio["streams"][$streamindex]["wformattag"] =
                        $thisfile_audio["wformattag"];
                    $thisfile_audio["streams"][$streamindex]["bitrate_mode"] =
                        $thisfile_audio["bitrate_mode"];
                    $thisfile_audio["streams"][$streamindex]["lossless"] =
                        $thisfile_audio["lossless"];
                    $thisfile_audio["streams"][$streamindex][
                        "dataformat"
                ...
                if (isset($thisfile_riff_WAVE["rgad"][0]["data"])) {
                    ...
                    $thisfile_riff_raw_rgad[
                        "fPeakAmplitude"
                    ] = getid3_lib::LittleEndian2Float(substr($rgadData, 0, 4));
                    $thisfile_riff_raw_rgad[
                        "nRadioRgAdjust"
                    ] = $this->EitherEndian2Int(substr($rgadData, 4, 2));
                    $thisfile_riff_raw_rgad[
                        "nAudiophileRgAdjust"
                    ] = $this->EitherEndian2Int(substr($rgadData, 6, 2));

                    $nRadioRgAdjustBitstring = str_pad(
                        getid3_lib::Dec2Bin(
                    ...
                    $nAudiophileRgAdjustBitstring = str_pad(
                        getid3_lib::Dec2Bin(
                    ...
                    $thisfile_riff_raw_rgad_track["name"] = getid3_lib::Bin2Dec(
                        substr($nRadioRgAdjustBitstring, 0, 3)
                    );
                    $thisfile_riff_raw_rgad_track[
                        "originator"
                    ] = getid3_lib::Bin2Dec(
                        substr($nRadioRgAdjustBitstring, 3, 3)
                    );
                    $thisfile_riff_raw_rgad_track[
                        "signbit"
                    ] = getid3_lib::Bin2Dec(
                        substr($nRadioRgAdjustBitstring, 6, 1)
                    );
                    $thisfile_riff_raw_rgad_track[
                        "adjustment"
                    ] = getid3_lib::Bin2Dec(
                        substr($nRadioRgAdjustBitstring, 7, 9)
                    );
                    $thisfile_riff_raw_rgad_album["name"] = getid3_lib::Bin2Dec(
                        substr($nAudiophileRgAdjustBitstring, 0, 3)
                    );
                    $thisfile_riff_raw_rgad_album[
                        "originator"
                    ] = getid3_lib::Bin2Dec(
                        substr($nAudiophileRgAdjustBitstring, 3, 3)
                    );
                    $thisfile_riff_raw_rgad_album[
                        "signbit"
                    ] = getid3_lib::Bin2Dec(
                        substr($nAudiophileRgAdjustBitstring, 6, 1)
                    );
                    $thisfile_riff_raw_rgad_album[
                        "adjustment"
                    ] = getid3_lib::Bin2Dec(
                        substr($nAudiophileRgAdjustBitstring, 7, 9)
                    );

                    $thisfile_riff["rgad"]["peakamplitude"] =
                        $thisfile_riff_raw_rgad["fPeakAmplitude"];
                    if (
                        $thisfile_riff_raw_rgad_track["name"] != 0 &&
                        $thisfile_riff_raw_rgad_track["originator"] != 0
                    ) {
                        $thisfile_riff["rgad"]["track"][
                            "name"
                    ...
                    if (
                        $thisfile_riff_raw_rgad_album["name"] != 0 &&
                        $thisfile_riff_raw_rgad_album["originator"] != 0
                    ) {
                        $thisfile_riff["rgad"]["album"][
                            "name"
                        ] = getid3_lib::RGADnameLookup(
                ...
                if (isset($thisfile_riff_WAVE["fact"][0]["data"])) {
                    $thisfile_riff_raw["fact"][
                        "NumberOfSamples"
                    ] = $this->EitherEndian2Int(
                        substr($thisfile_riff_WAVE["fact"][0]["data"], 0, 4)
                    );
                ...
                if (!empty($thisfile_riff_raw["fmt "]["nAvgBytesPerSec"])) {
                    $thisfile_audio["bitrate"] = getid3_lib::CastAsInt(
                        $thisfile_riff_raw["fmt "]["nAvgBytesPerSec"] * 8
                    );
                }
                ...
                if (isset($thisfile_riff_WAVE["bext"][0]["data"])) {
                    ...
                    $thisfile_riff_WAVE_bext_0 =
                        &$thisfile_riff_WAVE["bext"][0];

                    $thisfile_riff_WAVE_bext_0["title"] = substr(
                        $thisfile_riff_WAVE_bext_0["data"],
                        0,
                        256
                    );
                    $thisfile_riff_WAVE_bext_0["author"] = substr(
                        $thisfile_riff_WAVE_bext_0["data"],
                        256,
                        32
                    );
                    $thisfile_riff_WAVE_bext_0["reference"] = substr(
                        $thisfile_riff_WAVE_bext_0["data"],
                        288,
                        32
                    );
                    foreach (["title", "author", "reference"] as $bext_key) {
                        ...
                        $null_terminator_offset = strpos(
                            $thisfile_riff_WAVE_bext_0[$bext_key],
                            "\x00"
                        );
                        $thisfile_riff_WAVE_bext_0[$bext_key] = substr(
                            $thisfile_riff_WAVE_bext_0[$bext_key],
                            0,
                    ...
                    $thisfile_riff_WAVE_bext_0["origin_date"] = substr(
                        $thisfile_riff_WAVE_bext_0["data"],
                        320,
                        10
                    );
                    $thisfile_riff_WAVE_bext_0["origin_time"] = substr(
                        $thisfile_riff_WAVE_bext_0["data"],
                        330,
                        8
                    );
                    $thisfile_riff_WAVE_bext_0[
                        ...
                        substr($thisfile_riff_WAVE_bext_0["data"], 338, 8)
                    );
                    $thisfile_riff_WAVE_bext_0[
                        "bwf_version"
                    ] = getid3_lib::LittleEndian2Int(
                        substr($thisfile_riff_WAVE_bext_0["data"], 346, 1)
                    );
                    $thisfile_riff_WAVE_bext_0["reserved"] = substr(
                        $thisfile_riff_WAVE_bext_0["data"],
                        347,
                        254
                    );
                    ...
                    $thisfile_riff["comments"]["author"][] =
                        $thisfile_riff_WAVE_bext_0["author"];
                    $thisfile_riff["comments"]["title"][] =
                ...
                if (isset($thisfile_riff_WAVE["MEXT"][0]["data"])) {
                    ...
                    $thisfile_riff_WAVE_MEXT_0 =
                        &$thisfile_riff_WAVE["MEXT"][0];

                    $thisfile_riff_WAVE_MEXT_0["raw"][
                        "sound_information"
                    ] = getid3_lib::LittleEndian2Int(
                        substr($thisfile_riff_WAVE_MEXT_0["data"], 0, 2)
                    );
                    $thisfile_riff_WAVE_MEXT_0["flags"]["homogenous"] =
                        (bool) ($thisfile_riff_WAVE_MEXT_0["raw"][
                            "sound_information"
                        ] & 0x0001);
                    if ($thisfile_riff_WAVE_MEXT_0["flags"]["homogenous"]) {
                        $thisfile_riff_WAVE_MEXT_0["flags"]["padding"] =
                            $thisfile_riff_WAVE_MEXT_0["raw"][
                                "sound_information"
                            ] & 0x0002
                                ? false
                                : true;
                        $thisfile_riff_WAVE_MEXT_0["flags"]["22_or_44"] =
                            (bool) ($thisfile_riff_WAVE_MEXT_0["raw"][
                                "sound_information"
                            ] & 0x0004);
                        $thisfile_riff_WAVE_MEXT_0["flags"]["free_format"] =
                            (bool) ($thisfile_riff_WAVE_MEXT_0["raw"][
                                "sound_information"
                            ] & 0x0008);
                        ...
                        $thisfile_riff_WAVE_MEXT_0[
                            ...
                            substr($thisfile_riff_WAVE_MEXT_0["data"], 2, 2)
                        );
                    }
                    $thisfile_riff_WAVE_MEXT_0[
                        "anciliary_data_length"
                    ] = getid3_lib::LittleEndian2Int(
                        substr($thisfile_riff_WAVE_MEXT_0["data"], 6, 2)
                    );
                    $thisfile_riff_WAVE_MEXT_0["raw"][
                        "anciliary_data_def"
                    ] = getid3_lib::LittleEndian2Int(
                        substr($thisfile_riff_WAVE_MEXT_0["data"], 8, 2)
                    );
                    $thisfile_riff_WAVE_MEXT_0["flags"]["anciliary_data_left"] =
                        (bool) ($thisfile_riff_WAVE_MEXT_0["raw"][
                            "anciliary_data_def"
                        ] & 0x0001);
                    $thisfile_riff_WAVE_MEXT_0["flags"]["anciliary_data_free"] =
                        (bool) ($thisfile_riff_WAVE_MEXT_0["raw"][
                            "anciliary_data_def"
                        ] & 0x0002);
                    $thisfile_riff_WAVE_MEXT_0["flags"][
                        "anciliary_data_right"
                    ] =
                        (bool) ($thisfile_riff_WAVE_MEXT_0["raw"][
                            "anciliary_data_def"
                        ] & 0x0004);
                ...
                if (isset($thisfile_riff_WAVE["cart"][0]["data"])) {
                    ...
                    $thisfile_riff_WAVE_cart_0 =
                        &$thisfile_riff_WAVE["cart"][0];

                    $thisfile_riff_WAVE_cart_0["version"] = substr(
                        $thisfile_riff_WAVE_cart_0["data"],
                        0,
                        4
                    );
                    $thisfile_riff_WAVE_cart_0["title"] = trim(
                        substr($thisfile_riff_WAVE_cart_0["data"], 4, 64)
                    );
                    $thisfile_riff_WAVE_cart_0["artist"] = trim(
                        substr($thisfile_riff_WAVE_cart_0["data"], 68, 64)
                    );
                    $thisfile_riff_WAVE_cart_0["cut_id"] = trim(
                        substr($thisfile_riff_WAVE_cart_0["data"], 132, 64)
                    );
                    $thisfile_riff_WAVE_cart_0["client_id"] = trim(
                        substr($thisfile_riff_WAVE_cart_0["data"], 196, 64)
                    );
                    $thisfile_riff_WAVE_cart_0["category"] = trim(
                        substr($thisfile_riff_WAVE_cart_0["data"], 260, 64)
                    );
                    $thisfile_riff_WAVE_cart_0["classification"] = trim(
                        substr($thisfile_riff_WAVE_cart_0["data"], 324, 64)
                    );
                    $thisfile_riff_WAVE_cart_0["out_cue"] = trim(
                        substr($thisfile_riff_WAVE_cart_0["data"], 388, 64)
                    );
                    $thisfile_riff_WAVE_cart_0["start_date"] = trim(
                        substr($thisfile_riff_WAVE_cart_0["data"], 452, 10)
                    );
                    $thisfile_riff_WAVE_cart_0["start_time"] = trim(
                        substr($thisfile_riff_WAVE_cart_0["data"], 462, 8)
                    );
                    $thisfile_riff_WAVE_cart_0["end_date"] = trim(
                        substr($thisfile_riff_WAVE_cart_0["data"], 470, 10)
                    );
                    $thisfile_riff_WAVE_cart_0["end_time"] = trim(
                        substr($thisfile_riff_WAVE_cart_0["data"], 480, 8)
                    );
                    $thisfile_riff_WAVE_cart_0["producer_app_id"] = trim(
                        substr($thisfile_riff_WAVE_cart_0["data"], 488, 64)
                    );
                    $thisfile_riff_WAVE_cart_0["producer_app_version"] = trim(
                        substr($thisfile_riff_WAVE_cart_0["data"], 552, 64)
                    );
                    $thisfile_riff_WAVE_cart_0["user_defined_text"] = trim(
                        substr($thisfile_riff_WAVE_cart_0["data"], 616, 64)
                    );
                    $thisfile_riff_WAVE_cart_0[
                        "zero_db_reference"
                    ] = getid3_lib::LittleEndian2Int(
                        substr($thisfile_riff_WAVE_cart_0["data"], 680, 4),
                        true
                    );
                    for ($i = 0; $i < 8; $i++) {
                        $thisfile_riff_WAVE_cart_0["post_time"][$i][
                            "usage_fourcc"
                        ] = substr(
                            $thisfile_riff_WAVE_cart_0["data"],
                            684 + $i * 8,
                    ...
                    $thisfile_riff_WAVE_cart_0["url"] = trim(
                        substr($thisfile_riff_WAVE_cart_0["data"], 748, 1024)
                    );
                    $thisfile_riff_WAVE_cart_0["tag_text"] = explode(
                        "\r\n",
                        trim(substr($thisfile_riff_WAVE_cart_0["data"], 1772))
                    );
                    $thisfile_riff["comments"]["tag_text"][] = substr(
                        $thisfile_riff_WAVE_cart_0["data"],
                        1772
                    );

                    $thisfile_riff["comments"]["artist"][] =
                        $thisfile_riff_WAVE_cart_0["artist"];
                    $thisfile_riff["comments"]["title"][] =
                        $thisfile_riff_WAVE_cart_0["title"];
                }
                ...
                if (isset($thisfile_riff_WAVE["SNDM"][0]["data"])) {
                    ...
                    while ($SNDM_startoffset < $SNDM_endoffset) {
                        ...
                        $SNDM_thisTagSize = getid3_lib::BigEndian2Int(
                            substr(
                                $thisfile_riff_WAVE_SNDM_0_data,
                                $SNDM_startoffset + $SNDM_thisTagOffset,
                                4
                            )
                        );
                        $SNDM_thisTagOffset += 4;
                        $SNDM_thisTagKey = substr(
                            $thisfile_riff_WAVE_SNDM_0_data,
                            $SNDM_startoffset + $SNDM_thisTagOffset,
                            4
                        );
                        $SNDM_thisTagOffset += 4;
                        $SNDM_thisTagDataSize = getid3_lib::BigEndian2Int(
                            substr(
                                $thisfile_riff_WAVE_SNDM_0_data,
                                $SNDM_startoffset + $SNDM_thisTagOffset,
                                2
                        ...
                        $SNDM_thisTagDataFlags = getid3_lib::BigEndian2Int(
                            substr(
                                $thisfile_riff_WAVE_SNDM_0_data,
                                $SNDM_startoffset + $SNDM_thisTagOffset,
                                2
                        ...
                        if (
                            $SNDM_thisTagSize !=
                            4 + 4 + 2 + 2 + $SNDM_thisTagDataSize
                        ) {
                            $this->warning(
                                "RIFF.WAVE.SNDM.data contains tag not expected length (expected: " .
                                    $SNDM_thisTagSize .
                                    ", found: " .
                                    (4 + 4 + 2 + 2 + $SNDM_thisTagDataSize) .
                                    ") at offset " .
                                    $SNDM_startoffset .
                                    " (file offset " .
                                    ($thisfile_riff_WAVE_SNDM_0["offset"] +
                                        $SNDM_startoffset) .
                                    ")"
                            );
                            break;
                            ...
                            $this->warning(
                                "RIFF.WAVE.SNDM.data contains zero-size tag at offset " .
                                    $SNDM_startoffset .
                                    " (file offset " .
                                    ($thisfile_riff_WAVE_SNDM_0["offset"] +
                                        $SNDM_startoffset) .
                        ...
                        $thisfile_riff_WAVE_SNDM_0["parsed_raw"][
                            $SNDM_thisTagKey
                        ] = $SNDM_thisTagDataText;
                        if (
                            $parsedkey = self::waveSNDMtagLookup(
                                $SNDM_thisTagKey
                            )
                        ) {
                            ...
                            $this->warning(
                                'RIFF.WAVE.SNDM contains unknown tag "' .
                                    $SNDM_thisTagKey .
                                    '" at offset ' .
                                    $SNDM_startoffset .
                                    " (file offset " .
                ...
                if (isset($thisfile_riff_WAVE["iXML"][0]["data"])) {
                    ...
                    if (
                        ...
                        if (isset($parsedXML["SPEED"]["TIMECODE_RATE"])) {
                            ...
                            $thisfile_riff_WAVE["iXML"][0]["timecode_rate"] =
                                (int) $numerator /
                                ($denominator ? $denominator : 1000);
                        }
                        if (
                            ...
                            !empty(
                                $parsedXML["SPEED"]["TIMESTAMP_SAMPLE_RATE"]
                            ) &&
                            !empty(
                                $thisfile_riff_WAVE["iXML"][0]["timecode_rate"]
                            )
                        ) {
                            $samples_since_midnight = floatval(
                                ltrim(
                                    $parsedXML["SPEED"][
                            ...
                            $timestamp_sample_rate = is_array(
                                ...
                                : $parsedXML["SPEED"]["TIMESTAMP_SAMPLE_RATE"]; // XML could possibly contain more than one TIMESTAMP_SAMPLE_RATE tag, returning as array instead of integer [why? does it make sense? perhaps doesn't matter but getID3 needs to deal with it] - see https://github.com/JamesHeinrich/getID3/issues/105
                            $thisfile_riff_WAVE["iXML"][0]["timecode_seconds"] =
                                $samples_since_midnight /
                                $timestamp_sample_rate;
                            $h = floor(
                                $thisfile_riff_WAVE["iXML"][0][
                                    "timecode_seconds"
                                ] / 3600
                            );
                            $m = floor(
                ...
                if (isset($thisfile_riff_WAVE["guan"][0]["data"])) {
                    ...
                    $thisfile_riff_WAVE_guan_0 =
                        &$thisfile_riff_WAVE["guan"][0];
                    if (
                        !empty($thisfile_riff_WAVE_guan_0["data"]) &&
                        substr($thisfile_riff_WAVE_guan_0["data"], 0, 14) ==
                            "GUANO|Version:"
                    ) {
                        $thisfile_riff["guano"] = [];
                        foreach (
                            explode("\n", $thisfile_riff_WAVE_guan_0["data"])
                            as $line
                        ) {
                            if ($line) {
                                ...
                                $thisfile_riff["guano"] = array_merge_recursive(
                                    $thisfile_riff["guano"],
                            ...
                            switch ($key) {
                                case "Loc Position":
                                    if (
                                        ...
                                        $thisfile_riff["comments"][
                                            "gps_longitude"
                                        ][0] = floatval($longitude);
                                        $thisfile_riff["guano"][$key] =
                                            floatval($latitude) .
                                            " " .
                                            floatval($longitude);
                                    }
                ...
                if (!empty($info["wavpack"])) {
                    ...
                    $thisfile_audio["encoder"] =
                        "WavPack v" . $info["wavpack"]["version"];

                    // Reset to the way it was - RIFF parsing will have messed this up
                    $info["avdataend"] = $Original["avdataend"];
                    $thisfile_audio["bitrate"] = getid3_lib::SafeDiv(
                        ($info["avdataend"] - $info["avdataoffset"]) * 8,
                    ...
                    $OrignalRIFFheaderSize =
                        getid3_lib::LittleEndian2Int(substr($RIFFdata, 4, 4)) +
                        8;
                    $OrignalRIFFdataSize =
                        getid3_lib::LittleEndian2Int(substr($RIFFdata, 40, 4)) +
                        44;
                    ...
                    $RIFFdata =
                        substr($RIFFdata, 0, 36) .
                        substr($RIFFdata, 44) .
                        substr($RIFFdata, 36, 8);
                ...
                if (isset($thisfile_riff_raw["fmt "]["wFormatTag"])) {
                    switch ($thisfile_riff_raw["fmt "]["wFormatTag"]) {
                        ...
                        case 0x08ae: // ClearJump LiteWave
                            ...
                            $riff_litewave["quality_factor"] =
                                $riff_litewave_raw["m_wQuality"];

                            $riff_litewave["flags"]["raw_source"] =
                                $riff_litewave_raw["compression_flags"] & 0x01
                                    ? false
                                    : true;
                            $riff_litewave["flags"]["vbr_blocksize"] =
                                $riff_litewave_raw["compression_flags"] & 0x02
                                    ? false
                                    : true;
                            $riff_litewave["flags"]["seekpoints"] =
                                (bool) ($riff_litewave_raw[
                                    "compression_flags"
                                ] & 0x04);
                            ...
                            $thisfile_audio["lossless"] =
                                $riff_litewave_raw["m_wQuality"] == 100
                                    ? true
                                    : false;
                            $thisfile_audio["encoder_options"] =
                                "-q" . $riff_litewave["quality_factor"];
                            break;
                            ...
                            if ($info["avdataend"] - $info["filesize"] == 1) {
                                ...
                                $this->warning(
                                    "Probably truncated file - expecting " .
                                        $thisfile_riff[$RIFFsubtype]["data"][0][
                                            "size"
                                        ] .
                        ...
                        default:
                            if (
                                ...
                                $thisfile_riff[$RIFFsubtype]["data"][0][
                                    ...
                                    2 ==
                                    0 &&
                                ($info["filesize"] - $info["avdataoffset"]) %
                                    2 ==
                                    1
                            ) {
                ...
                if ($thisfile_audio_dataformat == "ac3") {
                    ...
                    if (
                        !empty($info["ac3"]["bitrate"]) &&
                        $info["ac3"]["bitrate"] != $thisfile_audio["bitrate"]
                    ) {
            ...
            case "AVI ":
                ...
                if (isset($thisfile_riff[$RIFFsubtype]["movi"]["offset"])) {
                    $info["avdataoffset"] =
                        $thisfile_riff[$RIFFsubtype]["movi"]["offset"] + 8;
                    if (isset($thisfile_riff["AVIX"])) {
                        $info["avdataend"] =
                            $thisfile_riff["AVIX"][
                                count($thisfile_riff["AVIX"]) - 1
                            ]["chunks"]["movi"]["offset"] +
                            $thisfile_riff["AVIX"][
                                count($thisfile_riff["AVIX"]) - 1
                            ]["chunks"]["movi"]["size"];
                ...
                if (isset($thisfile_riff["AVI "]["hdrl"]["strl"]["indx"])) {
                    ...
                    foreach (
                        ...
                        as $streamnumber => $steamdataarray
                    ) {
                        $ahsisd =
                            &$thisfile_riff["AVI "]["hdrl"]["strl"]["indx"][
                                $streamnumber
                        ...
                        $thisfile_riff_raw["indx"][$streamnumber][
                            "wLongsPerEntry"
                        ] = $this->EitherEndian2Int(substr($ahsisd, 0, 2));
                        $thisfile_riff_raw["indx"][$streamnumber][
                            "bIndexSubType"
                        ] = $this->EitherEndian2Int(substr($ahsisd, 2, 1));
                        $thisfile_riff_raw["indx"][$streamnumber][
                            "bIndexType"
                        ] = $this->EitherEndian2Int(substr($ahsisd, 3, 1));
                        $thisfile_riff_raw["indx"][$streamnumber][
                            "nEntriesInUse"
                        ] = $this->EitherEndian2Int(substr($ahsisd, 4, 4));
                        $thisfile_riff_raw["indx"][$streamnumber][
                            "dwChunkId"
                        ] = substr($ahsisd, 8, 4);
                        $thisfile_riff_raw["indx"][$streamnumber][
                            "dwReserved"
                        ] = $this->EitherEndian2Int(substr($ahsisd, 12, 4));
                ...
                if (
                    isset(
                        $thisfile_riff["AVI "]["hdrl"]["avih"][$streamindex][
                            "data"
                        ]
                    )
                ) {
                    ...
                    $thisfile_riff_raw_avih[
                        "dwMicroSecPerFrame"
                    ] = $this->EitherEndian2Int(substr($avihData, 0, 4)); // frame display rate (or 0L)
                    ...
                    foreach ($flags as $flag => $value) {
                        $thisfile_riff_raw_avih["flags"][$flag] =
                            (bool) ($thisfile_riff_raw_avih["dwFlags"] &
                                $value);
                    }
                    ...
                    if ($thisfile_riff_raw_avih["dwWidth"] > 0) {
                        // @phpstan-ignore-line
                        $thisfile_riff_video_current["frame_width"] =
                            $thisfile_riff_raw_avih["dwWidth"];
                        $thisfile_video["resolution_x"] =
                            $thisfile_riff_video_current["frame_width"];
                    }
                    if ($thisfile_riff_raw_avih["dwHeight"] > 0) {
                        // @phpstan-ignore-line
                        $thisfile_riff_video_current["frame_height"] =
                            $thisfile_riff_raw_avih["dwHeight"];
                        $thisfile_video["resolution_y"] =
                            $thisfile_riff_video_current["frame_height"];
                    }
                    if ($thisfile_riff_raw_avih["dwTotalFrames"] > 0) {
                        // @phpstan-ignore-line
                        $thisfile_riff_video_current["total_frames"] =
                            $thisfile_riff_raw_avih["dwTotalFrames"];
                        $thisfile_video["total_frames"] =
                            $thisfile_riff_video_current["total_frames"];
                    }

                    $thisfile_riff_video_current["frame_rate"] = round(
                        1000000 / $thisfile_riff_raw_avih["dwMicroSecPerFrame"],
                        3
                    );
                    $thisfile_video["frame_rate"] =
                        $thisfile_riff_video_current["frame_rate"];
                }
                if (
                    isset(
                        $thisfile_riff["AVI "]["hdrl"]["strl"]["strh"][0][
                            "data"
                        ]
                    )
                ) {
                    if (
                        ...
                        for (
                            ...
                            $i <
                            count(
                                $thisfile_riff["AVI "]["hdrl"]["strl"]["strh"]
                            );
                            $i++
                        ) {
                            if (
                                ...
                                if (
                                    ...
                                    switch ($strhfccType) {
                                        case "auds":
                                            ...
                                            $thisfile_audio_dataformat = "wav";
                                            if (
                                                isset($thisfile_riff_audio) &&
                                                is_array($thisfile_riff_audio)
                                            ) {
                                                $streamindex = count(
                                                    $thisfile_riff_audio
                                                );
                                            ...
                                            $thisfile_audio = getid3_lib::array_merge_noclobber(
                                                $thisfile_audio,
                                                $thisfile_riff_audio[
                                                    $streamindex
                                                ]
                                        ...
                                        case "vids":
                                            ...
                                            $thisfile_riff_raw_strh_current[
                                                "fccType"
                                            ] = substr($strhData, 0, 4); // same as $strhfccType;
                                            $thisfile_riff_raw_strh_current[
                                                "fccHandler"
                                            ] = substr($strhData, 4, 4);
                                            $thisfile_riff_raw_strh_current[
                                            ...
                                            $thisfile_riff_raw_strh_current[
                                                ...
                                                substr($strhData, 12, 2)
                                            );
                                            $thisfile_riff_raw_strh_current[
                                                "wLanguage"
                                            ] = $this->EitherEndian2Int(
                                                substr($strhData, 14, 2)
                                            );
                                            $thisfile_riff_raw_strh_current[
                                                "dwInitialFrames"
                                            ] = $this->EitherEndian2Int(
                                                substr($strhData, 16, 4)
                                            );
                                            $thisfile_riff_raw_strh_current[
                                                "dwScale"
                                            ] = $this->EitherEndian2Int(
                                                substr($strhData, 20, 4)
                                            );
                                            $thisfile_riff_raw_strh_current[
                                                "dwRate"
                                            ] = $this->EitherEndian2Int(
                                                substr($strhData, 24, 4)
                                            );
                                            $thisfile_riff_raw_strh_current[
                                                "dwStart"
                                            ] = $this->EitherEndian2Int(
                                                substr($strhData, 28, 4)
                                            );
                                            $thisfile_riff_raw_strh_current[
                                                "dwLength"
                                            ] = $this->EitherEndian2Int(
                                                substr($strhData, 32, 4)
                                            );
                                            $thisfile_riff_raw_strh_current[
                                                "dwSuggestedBufferSize"
                                            ] = $this->EitherEndian2Int(
                                                substr($strhData, 36, 4)
                                            );
                                            $thisfile_riff_raw_strh_current[
                                                "dwQuality"
                                            ] = $this->EitherEndian2Int(
                                                substr($strhData, 40, 4)
                                            );
                                            $thisfile_riff_raw_strh_current[
                                                "dwSampleSize"
                                            ] = $this->EitherEndian2Int(
                                                substr($strhData, 44, 4)
                                            );
                                            $thisfile_riff_raw_strh_current[
                                                "rcFrame"
                                            ] = $this->EitherEndian2Int(
                                                substr($strhData, 48, 4)
                                            );
                                            ...
                                            switch ($strhfccType) {
                                                case "vids":
                                                    $thisfile_riff_raw_strf_strhfccType_streamindex = self::ParseBITMAPINFOHEADER(
                                                        substr(
                                                            $strfData,
                                                            0,
                                                            40
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    $thisfile_video["codec"] =
                                        $thisfile_riff_video_current["codec"];
                                }
            ...
            case "CDDA":
                ...
                if (isset($thisfile_riff["CDDA"]["fmt "][0]["data"])) {
                    ...
                    $thisfile_riff_CDDA_fmt_0 =
                        &$thisfile_riff["CDDA"]["fmt "][0];

                    $thisfile_riff_CDDA_fmt_0[
                        "unknown1"
                    ] = $this->EitherEndian2Int(
                        substr($thisfile_riff_CDDA_fmt_0["data"], 0, 2)
                    );
                    $thisfile_riff_CDDA_fmt_0[
                        "track_num"
                    ] = $this->EitherEndian2Int(
                        substr($thisfile_riff_CDDA_fmt_0["data"], 2, 2)
                    );
                    $thisfile_riff_CDDA_fmt_0[
                        "disc_id"
                    ] = $this->EitherEndian2Int(
                        substr($thisfile_riff_CDDA_fmt_0["data"], 4, 4)
                    );
                    $thisfile_riff_CDDA_fmt_0[
                        "start_offset_frame"
                    ] = $this->EitherEndian2Int(
                        substr($thisfile_riff_CDDA_fmt_0["data"], 8, 4)
                    );
                    $thisfile_riff_CDDA_fmt_0[
                        "playtime_frames"
                    ] = $this->EitherEndian2Int(
                        substr($thisfile_riff_CDDA_fmt_0["data"], 12, 4)
                    );
                    $thisfile_riff_CDDA_fmt_0[
                        "unknown6"
                    ] = $this->EitherEndian2Int(
                        substr($thisfile_riff_CDDA_fmt_0["data"], 16, 4)
                    );
                    $thisfile_riff_CDDA_fmt_0[
                        "unknown7"
                    ] = $this->EitherEndian2Int(
                        substr($thisfile_riff_CDDA_fmt_0["data"], 20, 4)
                    );

                    $thisfile_riff_CDDA_fmt_0["start_offset_seconds"] =
                        (float) $thisfile_riff_CDDA_fmt_0[
                            "start_offset_frame"
                        ] / 75;
                    $thisfile_riff_CDDA_fmt_0["playtime_seconds"] =
                        (float) $thisfile_riff_CDDA_fmt_0["playtime_frames"] /
                        75;
                    $info["comments"]["track_number"] =
                        $thisfile_riff_CDDA_fmt_0["track_num"];
                    $info["playtime_seconds"] =
                        $thisfile_riff_CDDA_fmt_0["playtime_seconds"];
            ...
            case "AIFC":
                ...
                if (isset($thisfile_riff[$RIFFsubtype]["SSND"][0]["offset"])) {
                    $info["avdataoffset"] =
                        $thisfile_riff[$RIFFsubtype]["SSND"][0]["offset"] + 8;
                    $info["avdataend"] =
                        $info["avdataoffset"] +
                    ...
                    if ($info["avdataend"] > $info["filesize"]) {
                        if (
                            ...
                            $this->warning(
                                "Probable truncated AIFF file: expecting " .
                                    $thisfile_riff[$RIFFsubtype]["SSND"][0][
                                        "size"
                                    ] .
                ...
                if (isset($thisfile_riff[$RIFFsubtype]["COMM"][0]["data"])) {
                    ...
                    $thisfile_riff_audio[
                        ...
                        substr($thisfile_riff_RIFFsubtype_COMM_0_data, 0, 2),
                        true
                    );
                    $thisfile_riff_audio[
                        "total_samples"
                    ] = getid3_lib::BigEndian2Int(
                        substr($thisfile_riff_RIFFsubtype_COMM_0_data, 2, 4),
                        false
                    );
                    $thisfile_riff_audio[
                        "bits_per_sample"
                    ] = getid3_lib::BigEndian2Int(
                        substr($thisfile_riff_RIFFsubtype_COMM_0_data, 6, 2),
                        true
                    );
                    $thisfile_riff_audio[
                        "sample_rate"
                    ] = (int) getid3_lib::BigEndian2Float(
                        substr($thisfile_riff_RIFFsubtype_COMM_0_data, 8, 10)
                    );

                    if ($thisfile_riff[$RIFFsubtype]["COMM"][0]["size"] > 18) {
                        $thisfile_riff_audio["codec_fourcc"] = substr(
                            $thisfile_riff_RIFFsubtype_COMM_0_data,
                            18,
                            4
                        );
                        $CodecNameSize = getid3_lib::BigEndian2Int(
                            substr(
                                $thisfile_riff_RIFFsubtype_COMM_0_data,
                                22,
                                1
                        ...
                        $thisfile_riff_audio["codec_name"] = substr(
                            $thisfile_riff_RIFFsubtype_COMM_0_data,
                            23,
                            $CodecNameSize
                        );
                    ...
                    $thisfile_audio["channels"] =
                        $thisfile_riff_audio["channels"];
                    if ($thisfile_riff_audio["bits_per_sample"] > 0) {
                        $thisfile_audio["bits_per_sample"] =
                            $thisfile_riff_audio["bits_per_sample"];
                    }
                    $thisfile_audio["sample_rate"] =
                ...
                if (isset($thisfile_riff[$RIFFsubtype]["COMT"])) {
                    $offset = 0;
                    $CommentCount = getid3_lib::BigEndian2Int(
                        substr(
                            $thisfile_riff[$RIFFsubtype]["COMT"][0]["data"],
                            $offset,
                            2
                        ),
                        false
                    ...
                    for ($i = 0; $i < $CommentCount; $i++) {
                        ...
                        $offset += 2;
                        $CommentLength = getid3_lib::BigEndian2Int(
                            substr(
                                $thisfile_riff[$RIFFsubtype]["COMT"][0]["data"],
                                $offset,
                                2
                        ...
                        $offset += 2;
                        $info["comments_raw"][$i]["comment"] = substr(
                            $thisfile_riff[$RIFFsubtype]["COMT"][0]["data"],
                            $offset,
                            $CommentLength
                        );
                        ...
                        $info["comments_raw"][$i][
                            ...
                            $info["comments_raw"][$i]["timestamp"]
                        );
                        $thisfile_riff["comments"]["comment"][] =
                            $info["comments_raw"][$i]["comment"];
                    }
                }
...
*/
            ...
            case "8SVX":
                ...
                if (isset($thisfile_riff[$RIFFsubtype]["BODY"][0]["offset"])) {
                    $info["avdataoffset"] =
                        $thisfile_riff[$RIFFsubtype]["BODY"][0]["offset"] + 8;
                    $info["avdataend"] =
                        $info["avdataoffset"] +
                    ...
                    if ($info["avdataend"] > $info["filesize"]) {
                        $this->warning(
                            "Probable truncated AIFF file: expecting " .
                                $thisfile_riff[$RIFFsubtype]["BODY"][0][
                                    "size"
                                ] .
                                " bytes of audio data, only " .
                                ($info["filesize"] - $info["avdataoffset"]) .
                ...
                if (isset($thisfile_riff[$RIFFsubtype]["VHDR"][0]["offset"])) {
                    ...
                    $thisfile_riff_RIFFsubtype_VHDR_0 =
                        &$thisfile_riff[$RIFFsubtype]["VHDR"][0];

                    $thisfile_riff_RIFFsubtype_VHDR_0[
                        "oneShotHiSamples"
                    ] = getid3_lib::BigEndian2Int(
                        substr($thisfile_riff_RIFFsubtype_VHDR_0["data"], 0, 4)
                    );
                    $thisfile_riff_RIFFsubtype_VHDR_0[
                        "repeatHiSamples"
                    ] = getid3_lib::BigEndian2Int(
                        substr($thisfile_riff_RIFFsubtype_VHDR_0["data"], 4, 4)
                    );
                    $thisfile_riff_RIFFsubtype_VHDR_0[
                        "samplesPerHiCycle"
                    ] = getid3_lib::BigEndian2Int(
                        substr($thisfile_riff_RIFFsubtype_VHDR_0["data"], 8, 4)
                    );
                    $thisfile_riff_RIFFsubtype_VHDR_0[
                        "samplesPerSec"
                    ] = getid3_lib::BigEndian2Int(
                        substr($thisfile_riff_RIFFsubtype_VHDR_0["data"], 12, 2)
                    );
                    $thisfile_riff_RIFFsubtype_VHDR_0[
                        "ctOctave"
                    ] = getid3_lib::BigEndian2Int(
                        substr($thisfile_riff_RIFFsubtype_VHDR_0["data"], 14, 1)
                    );
                    $thisfile_riff_RIFFsubtype_VHDR_0[
                        "sCompression"
                    ] = getid3_lib::BigEndian2Int(
                        substr($thisfile_riff_RIFFsubtype_VHDR_0["data"], 15, 1)
                    );
                    $thisfile_riff_RIFFsubtype_VHDR_0[
                        "Volume"
                    ] = getid3_lib::FixedPoint16_16(
                        substr($thisfile_riff_RIFFsubtype_VHDR_0["data"], 16, 4)
                    );

                    $thisfile_audio["sample_rate"] =
                        $thisfile_riff_RIFFsubtype_VHDR_0["samplesPerSec"];
                    ...
                    switch ($thisfile_riff_RIFFsubtype_VHDR_0["sCompression"]) {
                        ...
                        default:
                            $this->warning(
                                'Unexpected sCompression value in 8SVX.VHDR chunk - expecting 0 or 1, found "' .
                                    $thisfile_riff_RIFFsubtype_VHDR_0[
                                        "sCompression"
                                    ] .
                                    '"'
                ...
                if (isset($thisfile_riff[$RIFFsubtype]["CHAN"][0]["data"])) {
                    $ChannelsIndex = getid3_lib::BigEndian2Int(
                        substr(
                    ...
                    switch ($ChannelsIndex) {
                        ...
                        default:
                            $this->warning(
                                'Unexpected value in 8SVX.CHAN chunk - expecting 2 or 4 or 6, found "' .
                                    $ChannelsIndex .
                                    '"'
                            );
                            break;
            ...
            case "CDXA":
                ...
                if (!empty($thisfile_riff["CDXA"]["data"][0]["size"])) {
                    getid3_lib::IncludeDependency(
                        GETID3_INCLUDEPATH . "module.audio-video.mpeg.php",
                        __FILE__,
                        true
                    );
            ...
            case "WEBP":
                ...
                if (!empty($thisfile_riff["WEBP"]["VP8 "][0]["size"])) {
                    ...
                    $this->fseek(
                        $thisfile_riff["WEBP"]["VP8 "][0]["offset"] + 8
                    ...
                    if (substr($WEBP_VP8_header, 3, 3) == "\x9D\x01\x2A") {
                        $thisfile_riff["WEBP"]["VP8 "][0]["keyframe"] = !(
                            getid3_lib::LittleEndian2Int(
                                substr($WEBP_VP8_header, 0, 3)
                            ) & 0x800000
                        );
                        $thisfile_riff["WEBP"]["VP8 "][0]["version"] =
                            (getid3_lib::LittleEndian2Int(
                                substr($WEBP_VP8_header, 0, 3)
                            ) &
                                0x700000) >>
                            20;
                        $thisfile_riff["WEBP"]["VP8 "][0]["show_frame"] =
                            getid3_lib::LittleEndian2Int(
                                substr($WEBP_VP8_header, 0, 3)
                            ) & 0x080000;
                        $thisfile_riff["WEBP"]["VP8 "][0]["data_bytes"] =
                            (getid3_lib::LittleEndian2Int(
                                substr($WEBP_VP8_header, 0, 3)
                            ) &
                                0x07ffff) >>
                        ...
                        $thisfile_riff["WEBP"]["VP8 "][0]["scale_x"] =
                            (getid3_lib::LittleEndian2Int(
                                substr($WEBP_VP8_header, 6, 2)
                            ) &
                                0xc000) >>
                            14;
                        $thisfile_riff["WEBP"]["VP8 "][0]["width"] =
                            getid3_lib::LittleEndian2Int(
                                substr($WEBP_VP8_header, 6, 2)
                            ) & 0x3fff;
                        $thisfile_riff["WEBP"]["VP8 "][0]["scale_y"] =
                            (getid3_lib::LittleEndian2Int(
                                substr($WEBP_VP8_header, 8, 2)
                            ) &
                                0xc000) >>
                            14;
                        $thisfile_riff["WEBP"]["VP8 "][0]["height"] =
                            getid3_lib::LittleEndian2Int(
                                substr($WEBP_VP8_header, 8, 2)
                            ) & 0x3fff;
                        ...
                        $this->error(
                            "Expecting 9D 01 2A at offset " .
                                ($thisfile_riff["WEBP"]["VP8 "][0]["offset"] +
                                    8 +
                                    3) .
                                ', found "' .
                                getid3_lib::PrintHexBytes(
                                    substr($WEBP_VP8_header, 3, 3)
                                ) .
                                '"'
                        );
                    }
                ...
                if (!empty($thisfile_riff["WEBP"]["VP8L"][0]["size"])) {
                    $old_offset = $this->ftell();
                    $this->fseek(
                        $thisfile_riff["WEBP"]["VP8L"][0]["offset"] + 8
                    ); // 4 bytes "VP8L" + 4 bytes chunk size
                    $WEBP_VP8L_header = $this->fread(10);
                    $this->fseek($old_offset);
                    if (substr($WEBP_VP8L_header, 0, 1) == "\x2F") {
                        $width_height_flags = getid3_lib::LittleEndian2Bin(
                            substr($WEBP_VP8L_header, 1, 4)
                        );
                        $thisfile_riff["WEBP"]["VP8L"][0]["width"] =
                            bindec(substr($width_height_flags, 18, 14)) + 1;
                        $thisfile_riff["WEBP"]["VP8L"][0]["height"] =
                            bindec(substr($width_height_flags, 4, 14)) + 1;
                        $thisfile_riff["WEBP"]["VP8L"][0][
                            "alpha_is_used"
                        ] = (bool) bindec(substr($width_height_flags, 3, 1));
                        $thisfile_riff["WEBP"]["VP8L"][0]["version"] = bindec(
                            substr($width_height_flags, 0, 3)
                        );
                        ...
                        $this->error(
                            "Expecting 2F at offset " .
                                ($thisfile_riff["WEBP"]["VP8L"][0]["offset"] +
                                    8) .
                                ', found "' .
                                getid3_lib::PrintHexBytes(
                                    substr($WEBP_VP8L_header, 0, 1)
                                ) .
                                '"'
                        );
                    }
            ...
            default:
                $this->error(
                    'Unknown RIFF type: expecting one of (WAVE|RMP3|AVI |CDDA|AIFF|AIFC|8SVX|CDXA|WEBP), found "' .
                        $RIFFsubtype .
                        '" instead'
                );
            //unset($info['fileformat']);
        ...
        switch ($RIFFsubtype) {
            ...
            case "AIFC":
                ...
                foreach ($ID3v2_keys_bad as $ID3v2_key_bad) {
                    if (
                        isset($thisfile_riff[$RIFFsubtype][$ID3v2_key_bad]) &&
                        !array_key_exists(
                            $ID3v2_key_good,
                            $thisfile_riff[$RIFFsubtype]
                        )
                    ) {
                        $thisfile_riff[$RIFFsubtype][$ID3v2_key_good] =
                            $thisfile_riff[$RIFFsubtype][$ID3v2_key_bad];
                        $this->warning(
                            'mapping "' .
                                $ID3v2_key_bad .
                                '" chunk to "' .
                ...
                if (isset($thisfile_riff[$RIFFsubtype]["id3 "])) {
                    ...
                    $getid3_id3v2->StartingOffset =
                        $thisfile_riff[$RIFFsubtype]["id3 "][0]["offset"] + 8;
                    if (
                        $thisfile_riff[$RIFFsubtype]["id3 "][0][
                            "valid"
        ...
        if (
            isset($thisfile_riff_WAVE["DISP"]) &&
            is_array($thisfile_riff_WAVE["DISP"])
        ) {
            $thisfile_riff["comments"]["title"][] = trim(
                substr(
                    $thisfile_riff_WAVE["DISP"][
                        count($thisfile_riff_WAVE["DISP"]) - 1
                    ]["data"],
                    4
                )
            );
        ...
        if (
            isset($thisfile_riff_WAVE["INFO"]) &&
            is_array($thisfile_riff_WAVE["INFO"])
        ) {
            self::parseComments(
                $thisfile_riff_WAVE["INFO"],
                $thisfile_riff["comments"]
            );
        }
        if (
            isset($thisfile_riff["AVI "]["INFO"]) &&
            is_array($thisfile_riff["AVI "]["INFO"])
        ) {
            self::parseComments(
                $thisfile_riff["AVI "]["INFO"],
                $thisfile_riff["comments"]
            );
        }

        if (
            empty($thisfile_audio["encoder"]) &&
            !empty($info["mpeg"]["audio"]["LAME"]["short_version"])
        ) {
            $thisfile_audio["encoder"] =
                $info["mpeg"]["audio"]["LAME"]["short_version"];
        }
        ...
        if (
            isset($thisfile_riff_raw["strh"][0]["dwLength"]) &&
            isset($thisfile_riff_raw["avih"]["dwMicroSecPerFrame"])
        ) {
            // @phpstan-ignore-line
            // needed for >2GB AVIs where 'avih' chunk only lists number of frames in that chunk, not entire movie
            $info["playtime_seconds"] =
                $thisfile_riff_raw["strh"][0]["dwLength"] *
                ($thisfile_riff_raw["avih"]["dwMicroSecPerFrame"] / 1000000);
        } elseif (
            isset($thisfile_riff_raw["avih"]["dwTotalFrames"]) &&
            isset($thisfile_riff_raw["avih"]["dwMicroSecPerFrame"])
        ) {
            // @phpstan-ignore-line
            $info["playtime_seconds"] =
                $thisfile_riff_raw["avih"]["dwTotalFrames"] *
                ($thisfile_riff_raw["avih"]["dwMicroSecPerFrame"] / 1000000);
        }
        ...
        if (
            ...
            foreach (
                $thisfile_riff_audio
                as $channelnumber => $audioinfoarray
            ) {
        ...
        if (isset($info["mpeg"]["audio"])) {
            ...
            $thisfile_audio["bitrate_mode"] = strtolower(
            ...
            if (!empty($thisfile_audio["streams"])) {
                foreach (
                    $thisfile_audio["streams"]
                    as $streamnumber => $streamdata
                ) {
                    if (
                        $streamdata["dataformat"] == $thisfile_audio_dataformat
                    ) {
                        $thisfile_audio["streams"][$streamnumber][
                            "sample_rate"
                        ] = $thisfile_audio["sample_rate"];
                        $thisfile_audio["streams"][$streamnumber]["channels"] =
                            $thisfile_audio["channels"];
                        $thisfile_audio["streams"][$streamnumber]["bitrate"] =
                            $thisfile_audio["bitrate"];
                        $thisfile_audio["streams"][$streamnumber][
                            "bitrate_mode"
                        ] = $thisfile_audio["bitrate_mode"];
                        $thisfile_audio["streams"][$streamnumber]["codec"] =
                            $thisfile_audio["codec"];
                    }
                }
            }
        ...
        if (
            !empty($thisfile_riff_raw["fmt "]["wBitsPerSample"]) &&
            $thisfile_riff_raw["fmt "]["wBitsPerSample"] > 0
        ) {
            switch ($thisfile_audio_dataformat) {
                case "ac3":
                ...
                default:
                    $thisfile_audio["bits_per_sample"] =
                        $thisfile_riff_raw["fmt "]["wBitsPerSample"];
                    break;
            }
        }
    ...
    public function ParseRIFFAMV($startoffset, $maxoffset)
    {
        ...
        try {
            ...
            if (substr($AMVheader, 0, 8) != "hdrlamvh") {
                throw new Exception(
                    'expecting "hdrlamv" at offset ' .
                        ($startoffset + 0) .
                        ', found "' .
                        substr($AMVheader, 0, 8) .
                        '"'
                );
            }
            if (substr($AMVheader, 8, 4) != "\x38\x00\x00\x00") {
                ...
                throw new Exception(
                    'expecting "0x38000000" at offset ' .
                        ($startoffset + 8) .
                        ', found "' .
            ...
            $RIFFchunk = [];
            $RIFFchunk["amvh"]["us_per_frame"] = getid3_lib::LittleEndian2Int(
                substr($AMVheader, 12, 4)
            );
            $RIFFchunk["amvh"]["reserved28"] = substr($AMVheader, 16, 28); // null? reserved?
            $RIFFchunk["amvh"]["resolution_x"] = getid3_lib::LittleEndian2Int(
                substr($AMVheader, 44, 4)
            );
            $RIFFchunk["amvh"]["resolution_y"] = getid3_lib::LittleEndian2Int(
                substr($AMVheader, 48, 4)
            );
            $RIFFchunk["amvh"]["frame_rate_int"] = getid3_lib::LittleEndian2Int(
                substr($AMVheader, 52, 4)
            );
            $RIFFchunk["amvh"]["reserved0"] = getid3_lib::LittleEndian2Int(
                substr($AMVheader, 56, 4)
            ); // 1? reserved?
            $RIFFchunk["amvh"]["reserved1"] = getid3_lib::LittleEndian2Int(
                substr($AMVheader, 60, 4)
            ); // 0? reserved?
            $RIFFchunk["amvh"]["runtime_sec"] = getid3_lib::LittleEndian2Int(
                substr($AMVheader, 64, 1)
            );
            $RIFFchunk["amvh"]["runtime_min"] = getid3_lib::LittleEndian2Int(
                substr($AMVheader, 65, 1)
            );
            $RIFFchunk["amvh"]["runtime_hrs"] = getid3_lib::LittleEndian2Int(
                substr($AMVheader, 66, 2)
            );

            $info["video"]["frame_rate"] =
                1000000 / $RIFFchunk["amvh"]["us_per_frame"];
            $info["video"]["resolution_x"] = $RIFFchunk["amvh"]["resolution_x"];
            $info["video"]["resolution_y"] = $RIFFchunk["amvh"]["resolution_y"];
            $info["playtime_seconds"] =
                $RIFFchunk["amvh"]["runtime_hrs"] * 3600 +
            ...
            if (
                substr($AMVheader, 68, 20) !=
                "LIST" . "\x00\x00\x00\x00" . "strlstrh" . "\x38\x00\x00\x00"
            ) {
                throw new Exception(
                    'expecting "LIST<0x00000000>strlstrh<0x38000000>" at offset ' .
                        ($startoffset + 68) .
                        ', found "' .
            ...
            if (substr($AMVheader, 144, 8) != "strf" . "\x24\x00\x00\x00") {
                throw new Exception(
                    'expecting "strf<0x24000000>" at offset ' .
                        ($startoffset + 144) .
                        ', found "' .
            ...
            if (
                substr($AMVheader, 188, 20) !=
                "LIST" . "\x00\x00\x00\x00" . "strlstrh" . "\x30\x00\x00\x00"
            ) {
                throw new Exception(
                    'expecting "LIST<0x00000000>strlstrh<0x30000000>" at offset ' .
                        ($startoffset + 188) .
                        ', found "' .
            ...
            if (substr($AMVheader, 256, 8) != "strf" . "\x14\x00\x00\x00") {
                throw new Exception(
                    'expecting "strf<0x14000000>" at offset ' .
                        ($startoffset + 256) .
                        ', found "' .
            ...
            // WORD reserved;
            // } WAVEFORMATEX;
            $RIFFchunk["strf"]["wformattag"] = getid3_lib::LittleEndian2Int(
                substr($AMVheader, 264, 2)
            );
            $RIFFchunk["strf"]["nchannels"] = getid3_lib::LittleEndian2Int(
                substr($AMVheader, 266, 2)
            );
            $RIFFchunk["strf"]["nsamplespersec"] = getid3_lib::LittleEndian2Int(
                substr($AMVheader, 268, 4)
            );
            $RIFFchunk["strf"][
                "navgbytespersec"
            ] = getid3_lib::LittleEndian2Int(substr($AMVheader, 272, 4));
            $RIFFchunk["strf"]["nblockalign"] = getid3_lib::LittleEndian2Int(
                substr($AMVheader, 276, 2)
            );
            $RIFFchunk["strf"]["wbitspersample"] = getid3_lib::LittleEndian2Int(
                substr($AMVheader, 278, 2)
            );
            $RIFFchunk["strf"]["cbsize"] = getid3_lib::LittleEndian2Int(
                substr($AMVheader, 280, 2)
            );
            $RIFFchunk["strf"]["reserved"] = getid3_lib::LittleEndian2Int(
                substr($AMVheader, 282, 2)
            );

            $info["audio"]["lossless"] = false;
            $info["audio"]["sample_rate"] =
                $RIFFchunk["strf"]["nsamplespersec"];
            $info["audio"]["channels"] = $RIFFchunk["strf"]["nchannels"];
            $info["audio"]["bits_per_sample"] =
                $RIFFchunk["strf"]["wbitspersample"];
            $info["audio"]["bitrate"] =
                $info["audio"]["sample_rate"] *
                $info["audio"]["channels"] *
                $info["audio"]["bits_per_sample"];
    ...
    public function ParseRIFF($startoffset, $maxoffset)
    {
        ...
        try {
            ...
            while ($this->ftell() < $maxoffset) {
                ...
                $chunkname = str_replace(
                    "\x00",
                    "_",
                    substr($chunknamesize, 0, 4)
                ...
                $chunksize = $this->EitherEndian2Int(
                    substr($chunknamesize, 4, 4)
                );
                //if (strlen(trim($chunkname, "\x00")) < 4) {
                if (strlen($chunkname) < 4) {
                    $this->error(
                        "Expecting chunk name at offset " .
                            ($this->ftell() - 8) .
                ...
                switch ($chunkname) {
                    case "LIST":
                        ...
                        if (preg_match('#^(movi|rec )$#i', $listname)) {
                            ...
                            if (!$FoundAllChunksWeNeed) {
                                ...
                                $AudioChunkStreamNum = substr(
                                    $AudioChunkHeader,
                                    0,
                                    2
                                );
                                $AudioChunkStreamType = substr(
                                    $AudioChunkHeader,
                                    2,
                                    2
                                );
                                $AudioChunkSize = getid3_lib::LittleEndian2Int(
                                    substr($AudioChunkHeader, 4, 4)
                                );

                                if ($AudioChunkStreamType == "wb") {
                                    $FirstFourBytes = substr(
                                        $AudioChunkHeader,
                                        8,
                                        4
                                    );
                                    if (
                                        preg_match(
                                            '/^\xFF[\xE2-\xE7\xF2-\xF7\xFA-\xFF][\x00-\xEB]/s',
                                            $FirstFourBytes
                                        )
                                    ) {
                                        // MP3
                                        ...
                                        $getid3_temp->info["avdataoffset"] =
                                            $this->ftell() - 4;
                                        $getid3_temp->info["avdataend"] =
                                            $this->ftell() + $AudioChunkSize;
                                        $getid3_ac3 = new getid3_ac3(
                                            $getid3_temp
                                        );
                                        $getid3_ac3->Analyze();
                                        if (
                                            empty($getid3_temp->info["error"])
                                        ) {
                                            $info["audio"] =
                                                $getid3_temp->info["audio"];
                                            $info["ac3"] =
                                                $getid3_temp->info["ac3"];
                                            if (
                                                !empty(
                                                    $getid3_temp->info[
                                                        "warning"
                            ...
                            $LISTchunkMaxOffset =
                                $this->ftell() - 4 + $chunksize;
                            if (
                                $parsedChunk = $this->ParseRIFF(
                                    $this->ftell(),
                                    $LISTchunkMaxOffset
                                )
                            ) {
                                $RIFFchunk[$listname] = array_merge_recursive(
                                    $RIFFchunk[$listname],
                                    $parsedChunk
                                );
                            }
                    ...
                    default:
                        ...
                        $thisindex = 0;
                        if (
                            isset($RIFFchunk[$chunkname]) &&
                            is_array($RIFFchunk[$chunkname])
                        ) {
                        ...
                        switch ($chunkname) {
                            case "data":
                                ...
                                if (
                                    ...
                                    $this->parseWavPackHeader(
                                        substr($testData, 8, 28)
                                    );
                                } else {
                                ...
                                if ($chunksize < 1048576) {
                                    ...
                                    $this->warning(
                                        'Chunk "' .
                                            ...
                                            '" at offset ' .
                                            $this->ftell() .
                                            " is unexpectedly larger than 1MB (claims to be " .
                            ...
                            case "scot":
                                ...
                                $RIFFchunk[$chunkname][$thisindex]["parsed"][
                                    "alter"
                                ] = substr(
                                ...
                                if (
                                    ...
                                    $RIFFchunk[$chunkname][$thisindex][
                                        "parsed"
                                    ]["filelength"] != $info["filesize"]
                                ) {
                                    $this->warning(
                                        "RIFF.WAVE.scot.filelength (" .
                                            $RIFFchunk[$chunkname][$thisindex][
                                                "parsed"
                                            ]["filelength"] .
                                            ") different from actual filesize (" .
                                            $info["filesize"] .
                                            ")"
                                    );
                                }
                            ...
                            default:
                                if (
                                    !empty($LISTchunkParent) &&
                                    isset($LISTchunkMaxOffset) &&
                                    $RIFFchunk[$chunkname][$thisindex][
                                        "offset"
                                    ] +
                                        $RIFFchunk[$chunkname][$thisindex][
                                    ...
                                    $RIFFchunk[$LISTchunkParent][$chunkname][
                                        $thisindex
                                    ]["offset"] =
                                        $RIFFchunk[$chunkname][$thisindex][
                                            "offset"
    ...
    public function ParseRIFFdata(&$RIFFdata)
    {
        ...
        if ($RIFFdata) {
            ...
            $NewLengthString = getid3_lib::LittleEndian2String(
                $RIFFdataLength,
                4
            );
            for ($i = 0; $i < 4; $i++) {
            ...
            $getid3_temp->info["audio"] = isset($info["audio"])
                ? $info["audio"]
                : [];
            $getid3_temp->info["video"] = isset($info["video"])
                ? $info["video"]
                : [];
    ...
    public static function parseWAVEFORMATex($WaveFormatExData)
    {
        ...
        $WaveFormatEx_raw = array_map(
            "getid3_lib::LittleEndian2Int",
            $WaveFormatEx_raw
        );

        $WaveFormatEx["codec"] = self::wFormatTagLookup(
            $WaveFormatEx_raw["wFormatTag"]
        );
    ...
    public function parseWavPackHeader($WavPackChunkData)
    {
        ...
        $thisfile_wavpack["version"] = getid3_lib::LittleEndian2Int(
            substr($WavPackChunkData, 0, 2)
        );
        if ($thisfile_wavpack["version"] >= 2) {
            $thisfile_wavpack["bits"] = getid3_lib::LittleEndian2Int(
                substr($WavPackChunkData, 2, 2)
            );
        }
        if ($thisfile_wavpack["version"] >= 3) {
            $thisfile_wavpack["flags_raw"] = getid3_lib::LittleEndian2Int(
                substr($WavPackChunkData, 4, 2)
            );
            $thisfile_wavpack["shift"] = getid3_lib::LittleEndian2Int(
                substr($WavPackChunkData, 6, 2)
            );
            $thisfile_wavpack["total_samples"] = getid3_lib::LittleEndian2Int(
                substr($WavPackChunkData, 8, 4)
            );
            $thisfile_wavpack["crc1"] = getid3_lib::LittleEndian2Int(
                substr($WavPackChunkData, 12, 4)
            );
            $thisfile_wavpack["crc2"] = getid3_lib::LittleEndian2Int(
                substr($WavPackChunkData, 16, 4)
            );
            $thisfile_wavpack["extension"] = substr($WavPackChunkData, 20, 4);
            $thisfile_wavpack["extra_bc"] = getid3_lib::LittleEndian2Int(
                substr($WavPackChunkData, 24, 1)
            );
            for ($i = 0; $i <= 2; $i++) {
                $thisfile_wavpack["extras"][] = getid3_lib::LittleEndian2Int(
                    substr($WavPackChunkData, 25 + $i, 1)
                );
            }
            ...
            $thisfile_wavpack_flags["mono"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x000001);
            $thisfile_wavpack_flags["fast_mode"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x000002);
            $thisfile_wavpack_flags["raw_mode"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x000004);
            $thisfile_wavpack_flags["calc_noise"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x000008);
            $thisfile_wavpack_flags["high_quality"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x000010);
            $thisfile_wavpack_flags["3_byte_samples"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x000020);
            $thisfile_wavpack_flags["over_20_bits"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x000040);
            $thisfile_wavpack_flags["use_wvc"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x000080);
            $thisfile_wavpack_flags["noiseshaping"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x000100);
            $thisfile_wavpack_flags["very_fast_mode"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x000200);
            $thisfile_wavpack_flags["new_high_quality"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x000400);
            $thisfile_wavpack_flags["cancel_extreme"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x000800);
            $thisfile_wavpack_flags["cross_decorrelation"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x001000);
            $thisfile_wavpack_flags["new_decorrelation"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x002000);
            $thisfile_wavpack_flags["joint_stereo"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x004000);
            $thisfile_wavpack_flags["extra_decorrelation"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x008000);
            $thisfile_wavpack_flags["override_noiseshape"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x010000);
            $thisfile_wavpack_flags["override_jointstereo"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x020000);
            $thisfile_wavpack_flags["copy_source_filetime"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x040000);
            $thisfile_wavpack_flags["create_exe"] =
                (bool) ($thisfile_wavpack["flags_raw"] & 0x080000);
        }
     ...
     * @return array
     */
    public static function ParseBITMAPINFOHEADER(
        $BITMAPINFOHEADER,
        $littleEndian = true
    ) {
        $parsed = [];
        ...
        $parsed = array_map(
            "getid3_lib::" . ($littleEndian ? "Little" : "Big") . "Endian2Int",
            $parsed
        );
    ...
    public static function ParseDIVXTAG($DIVXTAG, $raw = false)
    {
        ...
        $parsed["genre"] = isset($DIVXTAGgenre[$parsed["genre_id"]])
            ? $DIVXTAGgenre[$parsed["genre_id"]]
            : $parsed["genre_id"];
        $parsed["rating"] = isset($DIVXTAGrating[$parsed["rating_id"]])
            ? $DIVXTAGrating[$parsed["rating_id"]]
            : $parsed["rating_id"];
    ...
    public static function waveSNDMtagLookup($tagshortname)
    {
		...
		*/
        ...
        return getid3_lib::EmbeddedLookup(
            $tagshortname,
            $begin,
            __LINE__,
            __FILE__,
    ...
    public static function wFormatTagLookup($wFormatTag)
    {
		...
		*/
        ...
        return getid3_lib::EmbeddedLookup(
            "0x" .
                str_pad(strtoupper(dechex($wFormatTag)), 4, "0", STR_PAD_LEFT),
            $begin,
            __LINE__,
            __FILE__,
            "riff-wFormatTag"
