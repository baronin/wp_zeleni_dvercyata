    ...
    protected function content_template()
    {
     ...
     printf(
      ...
      _e("Menu Options"); ?>
		...
		<?php // NOTE: The following is a workaround for an inability to treat (and thus label) a list of sections as a whole.
        ?>
		<li class="customize-control-title customize-section-title-nav_menus-heading"><?php _e(
      "Menus"
  ); ?></li>
		<?php
    }
