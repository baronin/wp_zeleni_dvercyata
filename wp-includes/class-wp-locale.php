...
class WP_Locale
{
    ...
    public function init()
    {
        ...
        $this->weekday_initial[
            $this->weekday[0]
        ] = /* translators: One-letter abbreviation of the weekday. */ _x(
            "S",
            "Sunday initial"
        );
        $this->weekday_initial[
        ...
        $this->weekday_abbrev[
            $this->weekday[0]
        ] = /* translators: Three-letter abbreviation of the weekday. */ __(
            "Sun"
        );
        $this->weekday_abbrev[
            $this->weekday[1]
        ...
        $this->month_genitive[
            "01"
        ] = /* translators: Month name, genitive. */ _x("January", "genitive");
        $this->month_genitive[
            "02"
        ] = /* translators: Month name, genitive. */ _x("February", "genitive");
        $this->month_genitive[
            "03"
        ] = /* translators: Month name, genitive. */ _x("March", "genitive");
        $this->month_genitive[
            "04"
        ] = /* translators: Month name, genitive. */ _x("April", "genitive");
        $this->month_genitive[
            "05"
        ] = /* translators: Month name, genitive. */ _x("May", "genitive");
        $this->month_genitive[
            "06"
        ] = /* translators: Month name, genitive. */ _x("June", "genitive");
        $this->month_genitive[
            "07"
        ] = /* translators: Month name, genitive. */ _x("July", "genitive");
        $this->month_genitive[
            "08"
        ] = /* translators: Month name, genitive. */ _x("August", "genitive");
        $this->month_genitive[
            "09"
        ] = /* translators: Month name, genitive. */ _x(
            "September",
            "genitive"
        );
        $this->month_genitive[
            "10"
        ] = /* translators: Month name, genitive. */ _x("October", "genitive");
        $this->month_genitive[
            "11"
        ] = /* translators: Month name, genitive. */ _x("November", "genitive");
        $this->month_genitive[
            "12"
        ] = /* translators: Month name, genitive. */ _x("December", "genitive");

        // Abbreviations for each month.
        $this->month_abbrev[
            $this->month["01"]
        ] = /* translators: Three-letter abbreviation of the month. */ _x(
            "Jan",
        ...
        $this->number_format["thousands_sep"] =
            "number_format_thousands_sep" === $thousands_sep
                ? ","
                : $thousands_sep;
        ...
        $this->number_format["decimal_point"] =
            "number_format_decimal_point" === $decimal_point
                ? "."
                : $decimal_point;
    ...
    public function get_word_count_type()
    {
         ...
         */
        $word_count_type = is_null($this->word_count_type)
            ? _x("words", "Word count type. Do not translate!")
            : $this->word_count_type;

        // Check for valid types.
        if (
            "characters_excluding_spaces" !== $word_count_type &&
            "characters_including_spaces" !== $word_count_type
        ) {
            // Defaults to 'words'.
