...
function do_shortcode_tag($m)
{
    ...
    $output =
        $m[1] .
        call_user_func($shortcode_tags[$tag], $attr, $content, $tag) .
        $m[6];
    ...
    foreach ($textarr as &$element) {
        ...
        foreach ($attributes as &$attr) {
            ...
            if (
                 ...
                 */
                $count = 0;
                $new_attr = preg_replace_callback(
                    "/$pattern/",
                    "do_shortcode_tag",
                    $attr,
                    -1,
