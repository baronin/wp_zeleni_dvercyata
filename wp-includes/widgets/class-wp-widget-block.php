...
class WP_Widget_Block extends WP_Widget
{
    ...
    public function __construct()
    {
        ...
        add_filter(
            ...
            [$this, "set_is_wide_widget_in_customizer"],
            10,
            2
        );
    }
    ...
    public function form($instance)
    {
		...
		<p>
			<label for="<?php echo $this->get_field_id("content"); ?>">
				<?php /* translators: HTML code of the block, not an option that blocks HTML. */
    _e("Block HTML:"); ?>
			</label>
			<textarea id="<?php echo $this->get_field_id(
       "content"
   ); ?>" name="<?php echo $this->get_field_name("content"); ?>" rows="6" cols="50" class="widefat code"><?php echo esc_textarea($instance["content"]); ?></textarea>
		</p>
		<?php
    }
