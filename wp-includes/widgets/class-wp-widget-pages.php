...
class WP_Widget_Pages extends WP_Widget
{
   ...
   ); ?>"><?php _e("Exclude:"); ?></label>
			<input type="text" value="<?php echo esc_attr(
       $instance["exclude"]
   ); ?>" name="<?php echo esc_attr($this->get_field_name("exclude")); ?>" id="<?php echo esc_attr($this->get_field_id("exclude")); ?>" class="widefat" />
			<br />
