...
class WP_Widget_Recent_Comments extends WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        $recent_comments_id = $first_instance
            ? "recentcomments"
            : "recentcomments-{$this->number}";
        ...
        if (is_array($comments) && $comments) {
            ...
            $post_ids = array_unique(
                wp_list_pluck($comments, "comment_post_ID")
            );
            _prime_post_caches(
                $post_ids,
    ...
    public function form($instance)
    {
       ...
       "title"
		...
		<p>
			<label for="<?php echo $this->get_field_id(
       "number"
   ); ?>"><?php _e("Number of comments to show:"); ?></label>
			<input class="tiny-text" id="<?php echo $this->get_field_id(
       "number"
   ); ?>" name="<?php echo $this->get_field_name("number"); ?>" type="number" step="1" min="1" value="<?php echo $number; ?>" size="3" />
		</p>
		<?php
    }
