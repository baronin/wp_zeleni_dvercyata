...
class WP_Widget_Tag_Cloud extends WP_Widget
{
  ...
  switch (
      ...
      case 0: ?>
				<input type="hidden" id="<?php echo $this->get_field_id(
        "taxonomy"
         ...
         "The tag cloud will not be displayed since there are no taxonomies that support the tag cloud widget."
				...
				<?php break;// Just a single tag cloud supporting taxonomy found, no need to display a select.
      case 1:
    ...
    "taxonomy"
      ...
      default: ?>
				<p>
					<label for="<?php echo $this->get_field_id("taxonomy"); ?>"><?php _e(
    "Taxonomy:"
); ?></label>
         ...
         "taxonomy"
					...
					<?php foreach ($taxonomies as $taxonomy => $tax): ?>
						<option value="<?php echo esc_attr($taxonomy); ?>" <?php selected(
    $taxonomy,
    $current_taxonomy
); ?>>
  ...
  if (count($taxonomies) > 0) { ?>
        ...
        "count"
    ); ?>" name="<?php echo $this->get_field_name("count"); ?>" <?php checked(
    $count,
    true
); ?> />
				<label for="<?php echo $this->get_field_id("count"); ?>"><?php _e(
    "Show tag counts"
); ?></label>
			</p>
			<?php }
