...
(function() {
    ...
    public function form($instance)
    {
       ...
       $instance["dropdown"]
   ); ?> id="<?php echo $this->get_field_id("dropdown"); ?>" name="<?php echo $this->get_field_name("dropdown"); ?>" />
			<label for="<?php echo $this->get_field_id(
       "dropdown"
   ); ?>"><?php _e("Display as dropdown"); ?></label>
			<br />
			<input class="checkbox" type="checkbox"<?php checked(
       $instance["count"]
   ); ?> id="<?php echo $this->get_field_id("count"); ?>" name="<?php echo $this->get_field_name("count"); ?>" />
			<label for="<?php echo $this->get_field_id(
       "count"
   ); ?>"><?php _e("Show post counts"); ?></label>
		</p>
		<?php
    }
}
