...
class WP_Widget_Custom_HTML extends WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        // Restore post global.
        $post = $original_post;
        remove_filter("shortcode_atts_gallery", [
            $this,
            "_filter_gallery_shortcode_attrs",
        ]);
    ...
    public function form($instance)
    {
      ...
      "content"
  ); ?>" name="<?php echo $this->get_field_name("content"); ?>" class="content sync-input" hidden><?php echo esc_textarea($instance["content"]); ?></textarea>
		<?php
    }
    ...
    public static function render_control_template_scripts()
    {
		...
		<script type="text/html" id="tmpl-widget-custom-html-control-fields">
			...
			<p>
				<label for="{{ elementIdPrefix }}content" id="{{ elementIdPrefix }}content-label"><?php esc_html_e(
        "Content:"
    ); ?></label>
