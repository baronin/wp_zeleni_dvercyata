...
class WP_Network
{
    ...
    private function get_main_site_id()
    {
         ...
         */
        $main_site_id = (int) apply_filters(
        ...
        if (
            (defined("DOMAIN_CURRENT_SITE") &&
                ...
                DOMAIN_CURRENT_SITE === $this->domain &&
                PATH_CURRENT_SITE === $this->path) ||
            (defined("SITE_ID_CURRENT_SITE") &&
                (int) SITE_ID_CURRENT_SITE === $this->id)
        ) {
