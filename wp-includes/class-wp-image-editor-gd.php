...
class WP_Image_Editor_GD extends WP_Image_Editor
{
    ...
    protected function _save($image, $filename = null, $mime_type = null)
    {
        ...
        if (function_exists("imageinterlace")) {
            ...
            imageinterlace(
                $image,
                apply_filters("image_save_progressive", false, $mime_type)
            );
        }

        if ("image/gif" === $mime_type) {
            if (
                !$this->make_image($filename, "imagegif", [$image, $filename])
            ) {
                return new WP_Error(
                    "image_save_error",
            ...
            if (
                !$this->make_image($filename, "imagepng", [$image, $filename])
            ) {
                return new WP_Error(
                    "image_save_error",
                    __("Image Editor Save Failed")
            ...
            if (
                !$this->make_image($filename, "imagejpeg", [
                    $image,
                    $filename,
                    $this->get_quality(),
                ])
            ...
            if (
                ...
                !$this->make_image($filename, "imagewebp", [
                    $image,
                    $filename,
                    $this->get_quality(),
                ])
            ...
            if (
                !function_exists("imageavif") ||
                !$this->make_image($filename, "imageavif", [
                    $image,
                    $filename,
                    $this->get_quality(),
                ])
