...
if (isset($_SERVER["HTTP_USER_AGENT"])) {
    if (str_contains($_SERVER["HTTP_USER_AGENT"], "Lynx")) {
        ...
        str_contains($_SERVER["HTTP_USER_AGENT"], "OPR/")
    ) {
        $is_opera = true;
        ...
        str_contains($_SERVER["HTTP_USER_AGENT"], "MSIE") &&
        str_contains($_SERVER["HTTP_USER_AGENT"], "Mac")
    ) {
        $is_macIE = true;
    } elseif (str_contains($_SERVER["HTTP_USER_AGENT"], "Gecko")) {
        $is_gecko = true;
    } elseif (
        str_contains($_SERVER["HTTP_USER_AGENT"], "Nav") &&
 ...
 */
$is_caddy =
    str_contains($_SERVER["SERVER_SOFTWARE"], "Caddy") ||
