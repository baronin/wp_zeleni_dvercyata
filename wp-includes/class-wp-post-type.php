...
final class WP_Post_Type
{
    ...
    public function set_props($args)
    {
        ...
        if (false !== $args["query_var"]) {
            if (true === $args["query_var"]) {
                ...
                $args["query_var"] = sanitize_title_with_dashes(
                    $args["query_var"]
                );
            }
        }
    ...
    public function add_supports()
    {
        if (!empty($this->supports)) {
            ...
            add_post_type_support($this->name, ["title", "editor", "autosave"]);
        }
    }
        ...
        if (
            ...
            if ($this->hierarchical) {
                ...
                add_rewrite_tag(
                    ...
                    $this->query_var
                        ? "{$this->query_var}="
                        : "post_type=$this->name&name="
                );
            }

            if ($this->has_archive) {
                $archive_slug =
                    true === $this->has_archive
                        ? $this->rewrite["slug"]
                        : $this->has_archive;
                if ($this->rewrite["with_front"]) {
                    $archive_slug =
                        substr($wp_rewrite->front, 1) . $archive_slug;
                } else {
    ...
    public function get_rest_controller()
    {
        ...
        $class = $this->rest_controller_class
    ...
    public function get_revisions_rest_controller()
    {
        ...
        $class = $this->revisions_rest_controller_class
    ...
    public function get_autosave_rest_controller()
    {
        ...
        $class = $this->autosave_rest_controller_class
    ...
    public static function get_default_labels()
    {
        ...
        self::$default_labels = [
            ...
            "add_new" => [__("Add"), __("Add")],
            "add_new_item" => [__("Add Post"), __("Add Page")],
            ...
            "filter_items_list" => [
                __("Filter posts list"),
                __("Filter pages list"),
            ],
            ...
            "item_published_privately" => [
                __("Post published privately."),
                __("Page published privately."),
            ],
            "item_reverted_to_draft" => [
                __("Post reverted to draft."),
                __("Page reverted to draft."),
            ],
