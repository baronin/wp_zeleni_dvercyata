...
class Cookie
{
    ...
    public function __construct(
        ...
        if (
            ...
            InputValidator::is_iterable($attributes) === false
        ) {
            throw InvalidArgument::create(
                3,
                '$attributes',
    ...
    public function path_matches($request_path)
    {
        ...
        if (
            strlen($request_path) > strlen($cookie_path) &&
            substr($request_path, 0, strlen($cookie_path)) === $cookie_path
        ) {
