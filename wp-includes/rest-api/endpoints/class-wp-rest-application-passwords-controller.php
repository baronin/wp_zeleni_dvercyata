...
class WP_REST_Application_Passwords_Controller extends WP_REST_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->rest_base =
            "users/(?P<user_id>(?:[\d]+|me))/application-passwords";
    }
    ...
    public function create_item($request)
    {
        ...
        $password = $created[0];
        $item = WP_Application_Passwords::get_user_application_password(
            $user->ID,
            $created[1]["uuid"]
        );

        $item["new_password"] = WP_Application_Passwords::chunk_password(
            $password
        );
        ...
        $response->header(
            "Location",
            $response->get_links()["self"][0]["href"]
        );
    ...
    public function update_item($request)
    {
        ...
        $saved = WP_Application_Passwords::update_application_password(
            $user->ID,
            $item["uuid"],
            wp_slash((array) $prepared)
        );
    ...
    public function delete_items($request)
    {
        ...
        $deleted = WP_Application_Passwords::delete_all_application_passwords(
            $user->ID
        );
    ...
    public function get_current_item($request)
    {
        ...
        $password = WP_Application_Passwords::get_user_application_password(
            $user->ID,
            $uuid
        );
    ...
    public function prepare_item_for_response($item, $request)
    {
        ...
        $prepared = [
            ...
            "last_used" => $item["last_used"]
                ? gmdate("Y-m-d\TH:i:s", $item["last_used"])
                : null,
        ...
        $prepared = $this->filter_response_by_context(
            $prepared,
            $request["context"]
        );
