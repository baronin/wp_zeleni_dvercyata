    ...
    public function prepare_item_for_response($item, $request)
    {
        ...
        if (in_array("excerpt", $fields, true)) {
            $data["excerpt"] = [
                ...
                "rendered" => $this->prepare_excerpt_response(
                    $post->post_excerpt,
                    $post
                ),
            ];
        ...
        if (!empty($data["parent"])) {
            $response->add_link(
                "parent",
                rest_url(rest_get_route_for_post($data["parent"]))
            );
        }
