...
class WP_REST_Block_Types_Controller extends WP_REST_Controller
{
    ...
    protected function check_read_permission()
    {
        ...
        return new WP_Error(
            ...
            __("Sorry, you are not allowed to manage block types."),
    ...
    public function prepare_item_for_response($item, $request)
    {
        ...
        foreach ($extra_fields as $extra_field) {
            if (rest_is_field_included($extra_field, $fields)) {
                if (isset($block_type->$extra_field)) {
                    ...
                    if (
                        in_array($extra_field, $deprecated_fields, true) &&
                        is_array($field)
                    ) {
        ...
        if (rest_is_field_included("styles", $fields)) {
            $styles = $this->style_registry->get_registered_styles_for_block(
                $block_type->name
            );
