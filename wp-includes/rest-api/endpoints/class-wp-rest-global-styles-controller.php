...
class WP_REST_Global_Styles_Controller extends WP_REST_Posts_Controller
{
    ...
    protected function prepare_item_for_database($request)
    {
        ...
        if ($post) {
            ...
            if (
                ...
                !isset($existing_config["isGlobalStylesUserThemeJSON"]) ||
    ...
    public function prepare_item_for_response($post, $request)
    {
        ...
        $is_global_styles_user_theme_json =
            isset($raw_config["isGlobalStylesUserThemeJSON"]) &&
            true === $raw_config["isGlobalStylesUserThemeJSON"];
        $config = [];
        $theme_json = null;
        ...
        if (rest_is_field_included("settings", $fields)) {
            $data["settings"] =
                !empty($config["settings"]) && $is_global_styles_user_theme_json
                    ? $config["settings"]
                    : new stdClass();
        }
        ...
        if (rest_is_field_included("styles", $fields)) {
            $data["styles"] =
                !empty($config["styles"]) && $is_global_styles_user_theme_json
                    ? $config["styles"]
                    : new stdClass();
        }
    ...
    public function get_theme_item($request)
    {
        ...
        if (rest_is_field_included("styles", $fields)) {
            ...
            $data["styles"] = isset($raw_data["styles"])
                ? $raw_data["styles"]
                : [];
        }
