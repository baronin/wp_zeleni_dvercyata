...
class WP_REST_Menus_Controller extends WP_REST_Terms_Controller
{
    ...
    public function update_item($request)
    {
        ...
        if (!empty($prepared_term)) {
            ...
            $update = wp_update_nav_menu_object(
                $term->term_id,
    ...
    public function delete_item($request)
    {
        ...
        if (!$request["force"]) {
            ...
            return new WP_Error(
                ...
                sprintf(
                    __("Menus do not support trashing. Set '%s' to delete."),
                    "force=true"
                ),
                ["status" => 501]
            );
        ...
        $schema["properties"]["locations"] = [
            ...
            "arg_options" => [
                "validate_callback" => static function (
                    ...
                    $valid = rest_validate_request_arg(
                        $locations,
                        $request,
                        $param
                    );
                    ...
                    $locations = rest_sanitize_request_arg(
                        $locations,
                        $request,
                        $param
                    );
