...
class WP_REST_Site_Health_Controller extends WP_REST_Controller
{
    ...
    public function register_routes()
    {
        register_rest_route(
            $this->namespace,
            sprintf("/%s/%s", $this->rest_base, "background-updates"),
            [
                [
                    "methods" => "GET",
                    "callback" => [$this, "test_background_updates"],
                    "permission_callback" => function () {
                        return $this->validate_request_permission(
                            "background_updates"
                        );
                    },
                ],
        ...
        register_rest_route(
            $this->namespace,
            sprintf("/%s/%s", $this->rest_base, "loopback-requests"),
            [
                [
                    "methods" => "GET",
        ...
        register_rest_route(
            $this->namespace,
            sprintf("/%s/%s", $this->rest_base, "https-status"),
            [
                [
                    "methods" => "GET",
        ...
        register_rest_route(
            $this->namespace,
            sprintf("/%s/%s", $this->rest_base, "dotorg-communication"),
            [
                [
                    "methods" => "GET",
        ...
        register_rest_route(
            $this->namespace,
            sprintf("/%s/%s", $this->rest_base, "authorization-header"),
            [
                [
                    "methods" => "GET",
        ...
        register_rest_route(
            $this->namespace,
            sprintf("/%s/%s", $this->rest_base, "page-cache"),
            [
                [
                    "methods" => "GET",
    ...
    public function get_directory_sizes()
    {
        ...
        if (
            ...
            return new WP_Error(
                "not_available",
                __("Directory sizes could not be returned."),
                ["status" => 500]
            );
        }
