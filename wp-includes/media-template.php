...
<audio style="visibility: hidden"
	...
	<#
	<?php foreach (["autoplay", "loop"] as $attr): ?>
...
function wp_print_media_templates()
{
	...
	<script type="text/html" id="tmpl-media-frame">
		...
		<h2 class="media-frame-menu-heading"><?php _ex(
      "Actions",
      "media modal menu actions"
  ); ?></h2>
  ...
  _e("Selected media actions"); ?>
   ...
   _e("Close uploader"); ?>
		...
		<?php if (!_device_can_upload()): ?>
			<div class="upload-ui">
				<h2 class="upload-instructions"><?php _e(
      ...
      /** This action is documented in wp-admin/includes/media.php */ // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
      /** This action is documented in wp-admin/includes/media.php */ // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
      /** This action is documented in wp-admin/includes/media.php */ // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
      /** This action is documented in wp-admin/includes/media.php */ // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
      ...
      elseif (is_multisite() && !is_upload_space_available()): ?>
		...
		<?php else: ?>
			<div class="upload-ui">
				<h2 class="upload-instructions drop-instructions"><?php _e(
        "Drop files to upload"
    ); ?></h2>
				<p class="upload-instructions drop-instructions"><?php _ex(
        "or",
        "Uploader: Drop files here - or - Select Files"
    ); ?></p>
				<button type="button" class="browser button button-hero" aria-labelledby="post-upload-info"><?php _e(
        "Select Files"
    ); ?></button>
			</div>
    ...
    _e("List view"); ?>
		...
		<a href="<?php echo esc_url(
      add_query_arg("mode", "grid", admin_url("upload.php"))
	...
	<script type="text/html" id="tmpl-uploader-status">
		...
		<button type="button" class="button upload-dismiss-errors"><?php _e(
      "Dismiss errors"
  ); ?></button>
	</script>
	...
	<script type="text/html" id="tmpl-edit-attachment-frame">
		<div class="edit-media-header">
			<button class="left dashicons"<# if ( ! data.hasPrevious ) { #> disabled<# } #>><span class="screen-reader-text"><?php /* translators: Hidden accessibility text. */ _e(
       "Edit previous media item"
   ); ?></span></button>
			<button class="right dashicons"<# if ( ! data.hasNext ) { #> disabled<# } #>><span class="screen-reader-text"><?php /* translators: Hidden accessibility text. */ _e(
       "Edit next media item"
   ); ?></span></button>
			<button type="button" class="media-modal-close"><span class="media-modal-icon"><span class="screen-reader-text"><?php _e(
       "Close dialog"
   ); ?></span></span></button>
		</div>
	...
	<script type="text/html" id="tmpl-attachment-details-two-column">
		<div class="attachment-media-view {{ data.orientation }}">
			<?php if (isset($_GET["error"]) && "deprecated" === $_GET["error"]) {
       wp_admin_notice(
           __(
           ...
           [
			...
			<h2 class="screen-reader-text"><?php /* translators: Hidden accessibility text. */ _e(
       "Attachment Preview"
   ); ?></h2>
			<div class="thumbnail thumbnail-{{ data.type }}">
				...
				<div class="attachment-actions">
					...
					<button type="button" class="button edit-attachment"><?php _e(
         "Edit Image"
     ); ?></button>
     ...
     _e("Details"); ?>
				...
				<div class="uploaded"><strong><?php _e(
        "Uploaded on:"
				...
				<# } #>
				<div class="filename"><strong><?php _e(
        "File name:"
    ); ?></strong> {{ data.filename }}</div>
				<div class="file-type"><strong><?php _e(
        "File type:"
    ); ?></strong> {{ data.mime }}</div>
				<div class="file-size"><strong><?php _e(
        "File size:"
    ); ?></strong> {{ data.filesizeHumanReadable }}</div>
				<# if ( 'image' === data.type && ! data.uploading ) { #>
					<# if ( data.width && data.height ) { #>
						<div class="dimensions"><strong><?php _e("Dimensions:"); ?></strong>
							<?php /* translators: 1: A number of pixels wide, 2: A number of pixels tall. */
       printf(
          ...
          "Bitrate:"
				...
				<# if ( data.mediaStates ) { #>
					<div class="media-states"><strong><?php _e(
         "Used as:"
			...
			<div class="settings">
				...
				<# if ( 'image' === data.type ) { #>
					<span class="setting alt-text has-description" data-setting="alt">
						<label for="attachment-details-two-column-alt-text" class="name"><?php _e(
          "Alternative Text"
      ); ?></label>
				...
				<span class="setting" data-setting="title">
					<label for="attachment-details-two-column-title" class="name"><?php _e(
         "Title"
     ); ?></label>
        ...
        as $key => $label
				...
				<span class="setting" data-setting="<?php echo esc_attr($key); ?>">
					<label for="attachment-details-two-column-<?php echo esc_attr(
         $key
     ); ?>" class="name"><?php echo $label; ?></label>
					<input type="text" id="attachment-details-two-column-<?php echo esc_attr(
         $key
				...
				<span class="setting" data-setting="caption">
					<label for="attachment-details-two-column-caption" class="name"><?php _e(
         "Caption"
     ); ?></label>
					<textarea id="attachment-details-two-column-caption" {{ maybeReadOnly }}>{{ data.caption }}</textarea>
				</span>
				<span class="setting" data-setting="description">
					<label for="attachment-details-two-column-description" class="name"><?php _e(
         "Description"
     ); ?></label>
					<textarea id="attachment-details-two-column-description" {{ maybeReadOnly }}>{{ data.description }}</textarea>
				</span>
				<span class="setting" data-setting="url">
					<label for="attachment-details-two-column-copy-link" class="name"><?php _e(
         "File URL:"
     ); ?></label>
					<input type="text" class="attachment-details-copy-link" id="attachment-details-two-column-copy-link" value="{{ data.url }}" readonly />
					<span class="copy-to-clipboard-container">
						<button type="button" class="button button-small copy-attachment-url" data-clipboard-target="#attachment-details-two-column-copy-link"><?php _e(
          "Copy URL to clipboard"
			...
			<div class="actions">
				<# if ( data.link ) { #>
					<?php $view_media_text =
         "1" === get_option("wp_attachment_pages_enabled")
             ? __("View attachment page")
             : __("View media file"); ?>
				...
				<# if ( ! data.uploading && data.can.remove ) { #>
					...
					<?php if (MEDIA_TRASH): ?>
						<# if ( 'trash' === data.status ) { #>
							<button type="button" class="button-link untrash-attachment"><?php _e(
           "Restore from Trash"
       ); ?></button>
						<# } else { #>
							<button type="button" class="button-link trash-attachment"><?php _e(
           "Move to Trash"
       ); ?></button>
						<# } #>
					<?php else: ?>
						<button type="button" class="button-link delete-attachment"><?php _e(
          "Delete permanently"
      ); ?></button>
					<?php endif; ?>
				<# } #>
	...
	<script type="text/html" id="tmpl-attachment-details">
       ...
       printf(
           ...
           "{{ data.height }}"
					...
					<# if ( data.can.save && data.sizes ) { #>
						<a class="edit-attachment" href="{{ data.editLink }}&amp;image-editor" target="_blank"><?php _e(
          "Edit Image"
      ); ?></a>
					<# } #>
				<# } #>
      ...
      as $key => $label
		...
		<span class="setting" data-setting="<?php echo esc_attr($key); ?>">
			<label for="attachment-details-<?php echo esc_attr(
       $key
   ); ?>" class="name"><?php echo $label; ?></label>
			<input type="text" id="attachment-details-<?php echo esc_attr(
       $key
   ); ?>" value="{{ data.<?php echo $key; ?> || data.meta.<?php echo $key; ?> || '' }}" />
		</span>
		<?php endforeach; ?>
		<# } #>
		<span class="setting" data-setting="caption">
			<label for="attachment-details-caption" class="name"><?php _e(
       "Caption"
   ); ?></label>
			<textarea id="attachment-details-caption" {{ maybeReadOnly }}>{{ data.caption }}</textarea>
		</span>
		<span class="setting" data-setting="description">
			<label for="attachment-details-description" class="name"><?php _e(
       "Description"
   ); ?></label>
			<textarea id="attachment-details-description" {{ maybeReadOnly }}>{{ data.description }}</textarea>
		</span>
		<span class="setting" data-setting="url">
			<label for="attachment-details-copy-link" class="name"><?php _e(
       "File URL:"
   ); ?></label>
			<input type="text" class="attachment-details-copy-link" id="attachment-details-copy-link" value="{{ data.url }}" readonly />
			<div class="copy-to-clipboard-container">
				<button type="button" class="button button-small copy-attachment-url" data-clipboard-target="#attachment-details-copy-link"><?php _e(
        "Copy URL to clipboard"
    ); ?></button>
				<span class="success hidden" aria-hidden="true"><?php _e("Copied!"); ?></span>
			</div>
	...
	<script type="text/html" id="tmpl-media-selection">
		<div class="selection-info">
			...
			<# if ( data.editable ) { #>
				<button type="button" class="button-link edit-selection"><?php _e(
        "Edit Selection"
    ); ?></button>
			<# } #>
			<# if ( data.clearable ) { #>
				<button type="button" class="button-link clear-selection"><?php _e(
        "Clear"
    ); ?></button>
			<# } #>
		</div>
	...
	<script type="text/html" id="tmpl-attachment-display-settings">
		...
		<# if ( 'image' === data.type ) { #>
			<span class="setting align">
				<label for="attachment-display-settings-alignment" class="name"><?php _e(
        "Alignment"
    ); ?></label>
		...
		<span class="setting">
			<label for="attachment-display-settings-link-to-custom" class="name"><?php _e(
       "URL"
   ); ?></label>
		...
		<# if ( 'undefined' !== typeof data.sizes ) { #>
			<span class="setting">
				<label for="attachment-display-settings-size" class="name"><?php _e(
        "Size"
    ); ?></label>
	...
	<script type="text/html" id="tmpl-gallery-settings">
		...
		<span class="setting">
			<label for="gallery-settings-link-to" class="name"><?php _e(
       "Link To"
   ); ?></label>
		...
		<span class="setting">
			<label for="gallery-settings-columns" class="name select-label-inline"><?php _e(
       "Columns"
   ); ?></label>
		...
		<span class="setting">
			...
			<label for="gallery-settings-random-order" class="checkbox-label-inline"><?php _e(
       "Random Order"
   ); ?></label>
		</span>
	...
	<script type="text/html" id="tmpl-embed-link-settings">
		<span class="setting link-text">
			<label for="embed-link-settings-link-text" class="name"><?php _e(
       "Link Text"
   ); ?></label>
	...
	<script type="text/html" id="tmpl-embed-image-settings">
		...
		<span class="setting alt-text has-description">
			<label for="embed-image-settings-alt-text" class="name"><?php _e(
       "Alternative Text"
   ); ?></label>
  ...
  if (!apply_filters("disable_captions", "")): ?>
			<span class="setting caption">
				<label for="embed-image-settings-caption" class="name"><?php _e(
        "Caption"
    ); ?></label>
		...
		<fieldset class="setting-group">
			...
			<span class="setting">
				<label for="embed-image-settings-link-to-custom" class="name"><?php _e(
        "URL"
    ); ?></label>
		...
		<div class="media-embed">
			<div class="embed-media-settings">
				<div class="column-settings">
					<span class="setting alt-text has-description">
						<label for="image-details-alt-text" class="name"><?php _e(
          "Alternative Text"
      ); ?></label>
         ...
         ?>
						...
						<# } #>
							<div class="custom-size wp-clearfix<# if ( data.model.size !== 'custom' ) { #> hidden<# } #>">
								...
								<p id="image-size-desc" class="description"><?php _e(
            "Image size in pixels"
					...
					<span class="setting">
						<label for="image-details-link-to-custom" class="name"><?php _e(
          "URL"
      ); ?></label>
					...
					<div class="advanced-section">
						<h2><button type="button" class="button-link advanced-toggle"><?php _e(
          "Advanced Options"
      ); ?></button></h2>
						<div class="advanced-settings hidden">
							<div class="advanced-image">
								<span class="setting title-text">
									<label for="image-details-title-attribute" class="name"><?php _e(
             "Image Title Attribute"
         ); ?></label>
									<input type="text" id="image-details-title-attribute" data-setting="title" value="{{ data.model.title }}" />
								</span>
								<span class="setting extra-classes">
									<label for="image-details-css-class" class="name"><?php _e(
             "Image CSS Class"
         ); ?></label>
							...
							<div class="advanced-link">
								<span class="setting link-target">
									...
									<label for="image-details-link-target" class="checkbox-label"><?php _e(
             "Open link in a new tab"
         ); ?></label>
								</span>
								<span class="setting link-rel">
									<label for="image-details-link-rel" class="name"><?php _e(
             "Link Rel"
         ); ?></label>
									<input type="text" id="image-details-link-rel" data-setting="linkRel" value="{{ data.model.linkRel }}" />
								</span>
								<span class="setting link-class-name">
									<label for="image-details-link-css-class" class="name"><?php _e(
             "Link CSS Class"
         ); ?></label>
				...
				<div class="column-image">
					<div class="image">
						...
						<# if ( data.attachment && window.imageEdit ) { #>
							<div class="actions">
								<input type="button" class="edit-attachment button" value="<?php esc_attr_e(
            "Edit Original"
        ); ?>" />
								<input type="button" class="replace-attachment button" value="<?php esc_attr_e(
            "Replace"
        ); ?>" />
							</div>
						<# } #>
		...
		<div class="media-embed media-embed-details">
			<div class="embed-media-settings embed-audio-settings">
				...
				<span class="setting">
					...
					<button type="button" class="button-link remove-setting"><?php _e(
         "Remove audio source"
     ); ?></button>
				</span>
				<# } #>
				...
				#>
				<span class="setting">
					<label for="audio-details-<?php echo $type .
         "-source"; ?>" class="name"><?php echo strtoupper($type); ?></label>
					<input type="text" id="audio-details-<?php echo $type .
         "-source"; ?>" readonly data-setting="<?php echo $type; ?>" value="{{ data.model.<?php echo $type; ?> }}" />
					<button type="button" class="button-link remove-setting"><?php _e(
         "Remove audio source"
     ); ?></button>
				</span>
				...
				<fieldset class="setting-group">
					...
					<span class="setting preload">
						<span class="button-group button-large" data-setting="preload">
							<button class="button" value="auto"><?php _ex(
           "Auto",
           "auto preload"
       ); ?></button>
							<button class="button" value="metadata"><?php _e("Metadata"); ?></button>
							<button class="button active" value="none"><?php _ex(
           "None",
           "Preload value"
       ); ?></button>
						</span>
				...
				<span class="setting-group">
					<span class="setting checkbox-setting autoplay">
						...
						<label for="audio-details-autoplay" class="checkbox-label"><?php _e(
          "Autoplay"
      ); ?></label>
					</span>
					...
					<span class="setting checkbox-setting">
						...
						<label for="audio-details-loop" class="checkbox-label"><?php _e(
          "Loop"
      ); ?></label>
					</span>
				</span>
	...
	<script type="text/html" id="tmpl-video-details">
		...
		<div class="media-embed media-embed-details">
         ...
         "Remove video source"
				...
				#>
				<span class="setting">
					<label for="video-details-<?php echo $type .
         "-source"; ?>" class="name"><?php echo strtoupper($type); ?></label>
					<input type="text" id="video-details-<?php echo $type .
         "-source"; ?>" readonly data-setting="<?php echo $type; ?>" value="{{ data.model.<?php echo $type; ?> }}" />
					<button type="button" class="button-link remove-setting"><?php _e(
         "Remove video source"
     ); ?></button>
         ...
         "Add alternate sources for maximum HTML5 playback"
				...
				<span class="setting">
					<label for="video-details-poster-image" class="name"><?php _e(
         "Poster Image"
     ); ?></label>
         ...
         "Remove poster image"
           ...
           "Preload value"
				...
				<span class="setting-group">
					<span class="setting checkbox-setting autoplay">
						...
						<label for="video-details-autoplay" class="checkbox-label"><?php _e(
          "Autoplay"
      ); ?></label>
					</span>
					...
					<span class="setting checkbox-setting">
						...
						<label for="video-details-loop" class="checkbox-label"><?php _e(
          "Loop"
      ); ?></label>
					</span>
				</span>
				...
				<span class="setting" data-setting="content">
					...
					if ( ! _.isEmpty( data.model.content ) ) {
						...
						<label for="video-details-track-{{ index }}" class="name"><?php _e(
          ...
          "kind"
						...
						<button type="button" class="button-link remove-setting remove-track"><?php _ex(
          "Remove video track",
          "media"
      ); ?></button><br />
						<# } ); #>
					<# } else { #>
					<span class="name"><?php _e(
         "Tracks (subtitles, captions, descriptions, chapters, or metadata)"
     ); ?></span><br />
	...
	<script type="text/html" id="tmpl-editor-gallery">
		...
		<# } else { #>
			<div class="wpview-error">
				<div class="dashicons dashicons-format-gallery"></div><p><?php _e(
        "No items found."
    ); ?></p>
			</div>
		<# } #>
	...
	<script type="text/html" id="tmpl-crop-content">
		<img class="crop-image" src="{{ data.url }}" alt="<?php esc_attr_e(
	...
	<script type="text/html" id="tmpl-site-icon-preview-crop">
		...
		<div class="site-icon-preview crop">
			<div class="image-preview-wrap app-icon-preview">
				<img id="preview-app-icon" src="{{ data.url }}" class="app-icon-preview" alt="<?php esc_attr_e(
			...
			<div class="site-icon-preview-browser">
				...
				<div class="site-icon-preview-tab">
					<div class="image-preview-wrap browser">
						<img id="preview-favicon" src="{{ data.url }}" class="browser-icon-preview" alt="<?php esc_attr_e(
          "Preview as a browser icon"
      ); ?>" />
					</div>
					<div class="site-icon-preview-site-title" aria-hidden="true"><# print( '<?php echo esc_js(
         get_bloginfo("name")
     ); ?>' ) #></div>
