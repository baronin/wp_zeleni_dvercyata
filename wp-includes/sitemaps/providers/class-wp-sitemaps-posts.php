...
class WP_Sitemaps_Posts extends WP_Sitemaps_Provider
{
    ...
    public function get_url_list($page_num, $object_subtype = "")
    {
        ...
        if (
            ...
            if (!empty($latest_posts->posts)) {
                ...
                $sitemap_entry["lastmod"] = wp_date(
                    DATE_W3C,
                    strtotime($posts[0]->post_modified_gmt)
                );
            }
    ...
    public function get_max_num_pages($object_subtype = "")
    {
        ...
        $min_num_pages =
            "page" === $post_type && "posts" === get_option("show_on_front")
                ? 1
                : 0;
        return isset($query->max_num_pages)
            ? max($min_num_pages, $query->max_num_pages)
            : 1;
    }
    ...
    protected function get_posts_query_args($post_type)
    {
        ...
        $args = apply_filters(
            ...
            [
                ...
                "order" => "ASC",
                "post_type" => $post_type,
                "posts_per_page" => wp_sitemaps_get_max_urls(
                    $this->object_type
                ),
                "post_status" => ["publish"],
                "no_found_rows" => true,
