...
get_current_screen()->add_help_tab([
    "id" => "site-visibility",
    "title" => has_action("blog_privacy_selector")
        ? __("Site visibility")
...
<td id="front-static-pages"><fieldset>
	<legend class="screen-reader-text"><span>
		<?php _e("Your homepage displays"); ?>
	</span></legend>
	<p><label>
		<input name="show_on_front" type="radio" value="posts" class="tog" <?php checked(
      "posts",
	...
	<p><label>
		<input name="show_on_front" type="radio" value="page" class="tog" <?php checked(
      "page",
      get_option("show_on_front")
  ); ?> />
		<?php printf(
...
<ul>
 ...
 if (
     get_option("wp_page_for_privacy_policy") ===
         get_option("page_for_posts") ||
     get_option("wp_page_for_privacy_policy") === get_option("page_on_front")
 ):
     wp_admin_notice(
         __(
...
<?php endif; ?>
<tr>
<th scope="row"><label for="posts_per_page"><?php _e(
    "Blog pages show at most"
); ?></label></th>
<td>
<input name="posts_per_page" type="number" step="1" min="1" id="posts_per_page" value="<?php form_option(
    "posts_per_page"
); ?>" class="small-text" /> <?php _e("posts"); ?>
</td>
</tr>
<tr>
<th scope="row"><label for="posts_per_rss"><?php _e(
    "Syndication feeds show the most recent"
); ?></label></th>
<td><input name="posts_per_rss" type="number" step="1" min="1" id="posts_per_rss" value="<?php form_option(
    "posts_per_rss"
...
<td><fieldset>
  ...
  _e("For each post in a feed, include"); ?>
	...
	<p>
		<label><input name="rss_use_excerpt" type="radio" value="0" <?php checked(
      0,
...
<?php else: ?>
	<label for="blog_public"><input name="blog_public" type="checkbox" id="blog_public" value="0" <?php checked(
     "0",
     get_option("blog_public")
 ); ?> />
