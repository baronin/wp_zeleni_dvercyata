...
if (!current_user_can("manage_privacy_options")) {
    wp_die(
        __("Sorry, you are not allowed to manage privacy options on this site.")
    );
}
...
if (!empty($action)) {
    ...
    if ("set-privacy-page" === $action) {
        ...
        $privacy_page_updated_message = __(
...
<div class="privacy-settings-header">
	...
	<nav class="privacy-settings-tabs-wrapper hide-if-no-js" aria-label="<?php esc_attr_e(
     "Secondary menu"
 ); ?>">
		<a href="<?php echo esc_url(
      admin_url("options-privacy.php")
  ); ?>" class="privacy-settings-tab active" aria-current="true">
			<?php /* translators: Tab heading for Site Health Status page. */
...
<?php wp_admin_notice(__("The Privacy Settings require JavaScript."), [
    "type" => "error",
...
<div class="privacy-settings-body hide-if-no-js">
  ...
  if ($privacy_policy_page_exists) {
      ...
      ?>
				<strong>
				<?php if ("publish" === get_post_status($privacy_policy_page_id)) {
        printf(
  ...
  ?>
	...
	<table class="form-table tools-privacy-policy-page" role="presentation">
     ...
     submit_button(__("Create"), "secondary", "submit", false, [
         "id" => "create-page",
     ]);
     ?>
				</form>
		...
		<tr>
			<th scope="row">
				<label for="page_for_privacy_policy">
					<?php if ($privacy_policy_page_exists) {
     ...
     submit_button(__("Use This Page"), "primary", "submit", false, [
         "id" => "set-page",
     ]);
     ?>
				</form>
