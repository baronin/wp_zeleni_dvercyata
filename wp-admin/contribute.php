...
<div class="wrap about__container">
	...
	<nav class="about__header-navigation nav-tab-wrapper wp-clearfix" aria-label="<?php esc_attr_e(
     "Secondary menu"
		...
		<a href="contribute.php" class="nav-tab nav-tab-active" aria-current="page"><?php _e(
      "Get Involved"
  ); ?></a>
	</nav>
	...
	<div class="about__section has-2-columns is-wider-right">
       ...
       admin_url("images/contribute-main.svg?ver=6.5")
	...
	<div class="about__section has-2-columns is-wider-left">
       ...
       "WordPress may thrive on technical contributions, but you don&#8217;t have to code to contribute. Here are some of the ways you can make an impact without writing a single line of code:"
		...
		<div class="column">
			<img src="<?php echo esc_url(
       admin_url("images/contribute-no-code.svg?ver=6.5")
   ); ?>" alt="" width="290" height="290" />
		</div>
	</div>
	<div class="about__section has-2-columns is-wider-right">
		<div class="column">
			<img src="<?php echo esc_url(
       admin_url("images/contribute-code.svg?ver=6.5")
   ); ?>" alt="" width="290" height="290" />
		</div>
		<div class="column is-vertically-aligned-center">
   ...
   ); ?>"><?php _e("Find your team &rarr;"); ?></a></p>
		</div>
	</div>
