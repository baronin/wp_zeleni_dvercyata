    ...
    foreach ($menu as $key => $item) {
        ...
        if (!empty($item[6])) {
            ...
            if ("none" === $item[6] || "div" === $item[6]) {
                ...
                $img = "<br />";
                $img_class =
                    " dashicons-before " . sanitize_html_class($item[6]);
            }
        }
...
<div id="adminmenumain" role="navigation" aria-label="<?php esc_attr_e(
    "Main menu"
); ?>">
<a href="#wpbody-content" class="screen-reader-shortcut"><?php _e(
    "Skip to main content"
); ?></a>
<a href="#wp-toolbar" class="screen-reader-shortcut"><?php _e(
    "Skip to toolbar"
); ?></a>
