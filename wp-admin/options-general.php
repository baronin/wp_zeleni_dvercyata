...
<td><input name="blogname" type="text" id="blogname" value="<?php form_option(
    "blogname"
...
if (!is_multisite()) {
    ...
    $sample_tagline = sprintf(
        __("Just another %s site"),
...
?>
<tr>
<th scope="row"><label for="blogdescription"><?php _e(
    "Tagline"
); ?></label></th>
<td><input name="blogdescription" type="text" id="blogdescription" aria-describedby="tagline-description" value="<?php form_option(
    "blogdescription"
); ?>" class="regular-text" />
...
<td>
 ...
 ?>
	...
	<div id="site-icon-preview" class="site-icon-preview settings <?php echo esc_attr(
     $classes_for_wrapper
 ); ?>">
		<div class="direction-wrap">
			<img id="app-icon-preview" src="<?php echo esc_url(
       $site_icon_url
   ); ?>" class="app-icon-preview" alt="<?php echo esc_attr(
    $app_icon_alt_value
); ?>" />
			<div class="site-icon-preview-browser">
				<svg role="img" aria-hidden="true" fill="none" xmlns="http://www.w3.org/2000/svg" class="browser-buttons"><path fill-rule="evenodd" clip-rule="evenodd" d="M0 20a6 6 0 1 1 12 0 6 6 0 0 1-12 0Zm18 0a6 6 0 1 1 12 0 6 6 0 0 1-12 0Zm24-6a6 6 0 1 0 0 12 6 6 0 0 0 0-12Z" /></svg>
				<div class="site-icon-preview-tab">
					<img id="browser-icon-preview" src="<?php echo esc_url(
         $site_icon_url
     ); ?>" class="browser-icon-preview" alt="<?php echo esc_attr(
    $browser_icon_alt_value
); ?>" />
					<div class="site-icon-preview-site-title" id="site-icon-preview-site-title" aria-hidden="true"><?php bloginfo(
         "name"
     ); ?></div>
	...
	<input type="hidden" name="site_icon" id="site_icon_hidden_field" value="<?php form_option(
     "site_icon"
 ); ?>" />
	<div class="site-icon-action-buttons">
		...
		<button
			...
			type="button"
			<?php echo has_site_icon()
       ? 'class="button button-secondary reset remove-site-icon"'
       : 'class="button button-secondary reset hidden"'; ?>
		>
...
<tr>
<th scope="row"><label for="siteurl"><?php _e(
    "WordPress Address (URL)"
); ?></label></th>
<td><input name="siteurl" type="url" id="siteurl" value="<?php form_option(
    "siteurl"
); ?>"<?php disabled(
    defined("WP_SITEURL")
...
<tr>
<th scope="row"><label for="home"><?php _e(
    "Site Address (URL)"
); ?></label></th>
<td><input name="home" type="url" id="home" aria-describedby="home-description" value="<?php form_option(
    "home"
); ?>"<?php disabled(
    defined("WP_HOME")
...
<tr>
<th scope="row"><label for="new_admin_email"><?php _e(
    "Administration Email Address"
); ?></label></th>
<td><input name="new_admin_email" type="email" id="new_admin_email" aria-describedby="new-admin-email-description" value="<?php form_option(
    "admin_email"
...
<input name="users_can_register" type="checkbox" id="users_can_register" value="1" <?php checked(
    "1",
...
<tr>
<th scope="row"><label for="default_role"><?php _e(
...
if (!empty($languages) || !empty($translations)) { ?>
	<tr>
		<th scope="row"><label for="WPLANG"><?php _e(
      "Site Language"
   ...
   if (defined("WPLANG") && "" !== WPLANG && WPLANG !== $locale) {
       _deprecated_argument(
           ...
           sprintf(
               __('The %1$s constant in your %2$s file is no longer needed.'),
               "WPLANG",
               "wp-config.php"
           )
       );
...
?>
<th scope="row"><label for="timezone_string"><?php _e(
    "Timezone"
); ?></label></th>
<td>
...
checked($custom);
echo '/> <span class="date-time-text date-time-custom-text">' .
    __("Custom:") .
...
$time_formats = array_unique(
    apply_filters("time_formats", [__("g:i a"), "g:i A", "H:i"])
);
...
<tr>
<th scope="row"><label for="start_of_week"><?php _e(
    "Week Starts On"
); ?></label></th>
...
for ($day_index = 0; $day_index <= 6; $day_index++):
    $selected =
        (int) get_option("start_of_week") === $day_index
            ? 'selected="selected"'
            : "";
    echo "\n\t<option value='" .
        esc_attr($day_index) .
