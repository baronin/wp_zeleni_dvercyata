...
<p class="step"><a class="button button-large" href="<?php echo esc_url(
    get_option("home")
); ?>/"><?php _e("Continue"); ?></a></p>
...
<p class="step"><a class="button button-large button-primary" href="upgrade.php?step=1&amp;backto=<?php echo $goback; ?>"><?php _e(
    "Update WordPress Database"
        ...
        case 1:
            ...
            $backto = !empty($_GET["backto"])
                ? wp_unslash(urldecode($_GET["backto"]))
                : __get_option("home") . "/";
	...
	<p class="step"><a class="button button-large" href="<?php echo $backto; ?>"><?php _e(
    "Continue"
); ?></a></p>
			<?php break;
    endswitch;
