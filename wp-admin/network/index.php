...
$quick_tasks .=
    "<ul><li>" .
    __("To add a new user, <strong>click Create a New User</strong>.") .
    "</li>";
$quick_tasks .=
    "<li>" .
    __("To add a new site, <strong>click Create a New Site</strong>.") .
    "</li></ul>";
$quick_tasks .=
    "<p>" . __("To search for a user or site, use the search boxes.") . "</p>";
$quick_tasks .=
    "<ul><li>" .
    __(
...
$quick_tasks .=
    "<li>" .
    __("To search for a site, <strong>enter the path or domain</strong>.") .
    "</li></ul>";
...
get_current_screen()->set_help_sidebar(
    "<p><strong>" .
        ...
        "<p>" .
        __(
            '<a href="https://developer.wordpress.org/advanced-administration/multisite/admin/">Documentation on the Network Admin</a>'
        ) .
        "</p>" .
        "<p>" .
        __(
