...
if ($action) {
    switch ($action) {
        ...
        case "enable-selected":
            ...
            wp_safe_redirect(
                add_query_arg("enabled", count($themes), $referer)
            );
            exit();
        case "disable-selected":
            ...
            wp_safe_redirect(
                add_query_arg("disabled", count($themes), $referer)
            );
            exit();
        ...
        case "delete-selected":
            ...
            $themes = isset($_REQUEST["checked"])
                ? (array) $_REQUEST["checked"]
                : [];
         ...
         "<strong>" .
             __("Caution:") .
             "</strong> " .
             __("This theme may be active on other sites in the network."),
         [
         ...
         "<strong>" .
             __("Caution:") .
             "</strong> " .
             __("These themes may be active on other sites in the network."),
         [
             "additional_classes" => ["error"],
         ]
     ); ?>
     ...
     ?>
        ...
        : ""; ?>" style="display:inline;">
					<?php submit_button(
         __("No, return me to the theme list"),
         "",
         "submit",
         false
     ); ?>
...
<?php if (current_user_can("install_themes")): ?>
	<a href="theme-install.php" class="page-title-action"><?php echo esc_html__(
     "Add Theme"
 ); ?></a>
<?php endif; ?>
...
<input type="hidden" name="theme_status" value="<?php echo esc_attr(
    $status
); ?>" />
