...
get_current_screen()->set_help_sidebar(
    "<p><strong>" .
        ...
        "<p>" .
        __(
            '<a href="https://developer.wordpress.org/advanced-administration/multisite/admin/#network-admin-updates-screen">Documentation on Upgrade Network</a>'
        ) .
        "</p>" .
        "<p>" .
        __(
...
switch ($action) {
...
); ?> <a class="button" href="upgrade.php?action=upgrade&amp;n=<?php echo $n +
     5; ?>"><?php _e("Next Sites"); ?></a></p>
    ...
    default:
        if (
            (int) get_site_option("wpmu_upgrade_site") !==
      ...
      "The database update process may take a little while, so please be patient."
		...
		<p><a class="button button-primary" href="upgrade.php?action=upgrade"><?php _e(
      "Upgrade Network"
  ); ?></a></p>
		<?php
  /**
