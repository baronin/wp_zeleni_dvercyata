...
<div class="wrap about__container">
	...
	<nav class="about__header-navigation nav-tab-wrapper wp-clearfix" aria-label="<?php esc_attr_e(
     "Secondary menu"
		...
		<a href="privacy.php" class="nav-tab nav-tab-active" aria-current="page"><?php _e(
      "Privacy"
  ); ?></a>
	...
	<div class="about__section has-2-columns is-wider-right">
		<div class="column about__image">
			<img class="privacy-image" src="<?php echo esc_url(
       admin_url("images/privacy.svg?ver=6.5")
   ); ?>" alt="" />
		</div>
