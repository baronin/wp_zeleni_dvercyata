  ...
  if (current_user_can("promote_users") && $this->has_items()): ?>
   ...
   _e("Change role to&hellip;"); ?>
		...
		<select name="<?php echo $id; ?>" id="<?php echo $id; ?>">
			...
			<option value="none"><?php _e(
       "&mdash; No role for this site &mdash;"
   ); ?></option>
		</select>
			<?php submit_button(__("Change"), "", $button_id, false);endif;
        ...
        foreach ($this->items as $userid => $user_object) {
            echo "\n\t" .
                $this->single_row(
                    ...
                    "",
                    "",
                    isset($post_counts) ? $post_counts[$userid] : 0
                );
        }
    }
        ...
        if (current_user_can("list_users")) {
            ...
            if (
                ...
                $actions["delete"] =
                    ...
                    wp_nonce_url(
                        "users.php?action=delete&amp;user=$user_object->ID",
                        "bulk-users"
                    ) .
                    "'>" .
                    __("Delete") .
            ...
            if (
                ...
                $actions["remove"] =
                    "<a class='submitdelete' href='" .
                    wp_nonce_url(
                        $url . "action=remove&amp;user=$user_object->ID",
                        "bulk-users"
                    ) .
                    "'>" .
                    __("Remove") .
            ...
            if (
                ...
                $actions["resetpassword"] =
                    ...
                    wp_nonce_url(
                        "users.php?action=resetpassword&amp;users=$user_object->ID",
                        "bulk-users"
                    ) .
                    "'>" .
    ...
    protected function get_role_list($user_object)
    {
        ...
        foreach ($user_object->roles as $role) {
            if (isset($wp_roles->role_names[$role])) {
                $role_list[$role] = translate_user_role(
