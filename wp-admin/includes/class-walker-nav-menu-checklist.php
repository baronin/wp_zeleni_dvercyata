...
class Walker_Nav_Menu_Checklist extends Walker_Nav_Menu
{
    ...
    public function start_el(
        ...
        $possible_object_id =
            isset($menu_item->post_type) &&
            "nav_menu_item" === $menu_item->post_type
                ? $menu_item->object_id
                : $_nav_menu_placeholder;
        $possible_db_id =
            !empty($menu_item->ID) && 0 < $possible_object_id
                ? (int) $menu_item->ID
                : 0;
