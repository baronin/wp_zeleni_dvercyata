...
class Theme_Installer_Skin extends WP_Upgrader_Skin
{
    ...
    private function do_overwrite()
    {
        ...
        foreach ($all_themes as $theme) {
            $stylesheet_dir = wp_normalize_path(
        ...
        if (!empty($new_theme_data["Template"])) {
            $is_invalid_parent = !in_array(
                $new_theme_data["Template"],
        ...
        $table .=
            "<tr><th></th><th>" .
            esc_html_x("Installed", "theme") .
            "</th><th>" .
            esc_html_x("Uploaded", "theme") .
            "</th></tr>";
        ...
        foreach ($rows as $field => $label) {
            ...
            $new_value = !empty($new_theme_data[$field])
                ? (string) $new_theme_data[$field]
                : "-";
            ...
            $table .=
                ...
                "</td>";
            $table .=
                $diff_field || $diff_version || $invalid_parent
                    ? '<td class="warning">'
                    : "<td>";
        ...
        $requires_php = isset($new_theme_data["RequiresPHP"])
            ? $new_theme_data["RequiresPHP"]
            : null;
        $requires_wp = isset($new_theme_data["RequiresWP"])
            ? $new_theme_data["RequiresWP"]
            : null;
