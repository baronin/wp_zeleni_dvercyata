...
class Language_Pack_Upgrader extends WP_Upgrader
{
    ...
    {
        $this->strings["starting_upgrade"] = __(
        ...
        $this->strings["downloading_package"] = sprintf(
            __("Downloading translation from %s&#8230;"),
    ...
    public function bulk_upgrade($language_updates = [], $args = [])
    {
        ...
        foreach ($language_updates as $language_update) {
            ...
            $language_updates_results[] = [
                ...
                "slug" => isset($language_update->slug)
    ...
    public function clear_destination($remote_destination)
    {
        ...
        if ("core" === $language_update->type) {
            ...
            $json_translation_files = glob(
                $language_directory . $language_update->language . "-*.json"
            );
            ...
            $language_directory =
                $language_directory . $language_update->type . "s/";
            $json_translation_files = glob(
                $language_directory .
                    $language_update->slug .
                    "-" .
