 ...
 * @since 4.9.6
 */
class WP_Privacy_Data_Export_Requests_List_Table extends
        ...
        switch ($status) {
            ...
            case "request-confirmed":
                ...
                echo '<div class="export-personal-data" ' .
                    ...
                    '">';
                ?>
				<span class="export-personal-data-idle"><button type="button" class="button-link export-personal-data-handle"><?php _e(
        "Send export link"
    ); ?></button></span>
				<span class="export-personal-data-processing hidden"><?php _e(
        "Sending email..."
    ); ?> <span class="export-progress"></span></span>
				<span class="export-personal-data-success success-message hidden"><?php _e(
        "Email sent."
    ); ?></span>
				<span class="export-personal-data-failed hidden"><?php _e(
        "Email could not be sent."
    ); ?> <button type="button" class="button-link export-personal-data-handle"><?php _e(
     "Retry"
 ); ?></button></span>
				<?php
    echo "</div>";
