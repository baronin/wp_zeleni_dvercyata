...
class WP_Site_Health_Auto_Updates
{
    ...
    public function test_constants($constant, $value)
    {
        ...
        if (
            defined($constant) &&
            !in_array(constant($constant), $acceptable_values, true)
        ) {
            return [
                "description" => sprintf(
    ...
    {
        if (
            (!is_multisite() || (is_main_site() && is_network_admin())) &&
    ...
    public function test_if_failed_update()
    {
        ...
        if (!empty($failed["critical"])) {
            ...
            $description .=
                " " . __("You would have received an email because of this.");
            $description .=
                " " .
                __(
        ...
        $description .=
            " " . __("Another attempt will be made with the next release.");
        $description .=
            " " .
            sprintf(
                /* translators: %s: Code of error shown. */
    ...
    public function test_vcs_abspath()
    {
        ...
        if (
            $checkout &&
            !apply_filters("automatic_updates_is_vcs_checkout", true, ABSPATH)
        ) {
            return [
                "description" => sprintf(
    ...
    public function test_all_files_writable()
    {
        ...
        if ($unwritable_files) {
            ...
            return [
                "description" =>
                    __("Some files are not writable by WordPress:") .
                    " <ul><li>" .
                    implode("</li><li>", $unwritable_files) .
                    "</li></ul>",
                "severity" => "fail",
            ];
        } else {
    ...
    public function test_accepts_dev_updates()
    {
        ...
        if (
            ...
            ("minor" === WP_AUTO_UPDATE_CORE || false === WP_AUTO_UPDATE_CORE)
        ) {
            return [
                "description" => sprintf(
