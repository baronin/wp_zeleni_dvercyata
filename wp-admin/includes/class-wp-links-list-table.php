...
class WP_Links_List_Table extends WP_List_Table
{
   ...
   echo '<label class="screen-reader-text" for="cat_id">' .
       get_taxonomy("link_category")->labels->filter_by_item .
       "</label>";
   ...
   submit_button(__("Filter"), "", "filter_action", false, [
    ...
    protected function get_sortable_columns()
    {
        return [
            ...
            "visible" => [
                ...
                false,
                __("Visible"),
                __("Table ordered by Visibility."),
            ],
            "rating" => [
                "rating",
                false,
                __("Rating"),
                __("Table ordered by Rating."),
            ],
        ];
    }
    ...
    public function column_cb($item)
    {
		...
		<label for="cb-select-<?php echo $link->link_id; ?>">
			...
			<?php /* translators: Hidden accessibility text. %s: Link name. */
