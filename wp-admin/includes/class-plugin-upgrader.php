...
class Plugin_Upgrader extends WP_Upgrader
{
    ...
    public function upgrade_strings()
    {
        ...
        $this->strings["process_bulk_success"] = __(
    ...
    public function bulk_upgrade($plugins, $args = [])
    {
        ...
        foreach ($plugins as $plugin) {
            ++$this->update_current;
            $this->skin->plugin_info = get_plugin_data(
        ...
        foreach ($results as $plugin => $result) {
            ...
            if (
                !$result ||
                is_wp_error($result) ||
                !isset($past_failure_emails[$plugin])
            ) {
                continue;
            }
     ...
     */
    public function delete_old_plugin(
        $removed,
        $local_destination,
        $remote_destination,
        $plugin
