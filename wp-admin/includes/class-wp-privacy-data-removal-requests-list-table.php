 ...
 * @since 4.9.6
 */
class WP_Privacy_Data_Removal_Requests_List_Table extends
        ...
        switch ($status) {
            ...
            case "request-confirmed":
                ...
                echo '<div class="remove-personal-data" ' .
                    ...
                    '">';
                ?>
				<span class="remove-personal-data-idle"><button type="button" class="button-link remove-personal-data-handle"><?php _e(
        "Erase personal data"
    ); ?></button></span>
				<span class="remove-personal-data-processing hidden"><?php _e(
        "Erasing data..."
    ); ?> <span class="erasure-progress"></span></span>
				<span class="remove-personal-data-success success-message hidden" ><?php _e(
        "Erasure completed."
    ); ?></span>
				<span class="remove-personal-data-failed hidden"><?php _e(
        "Data erasure has failed."
    ); ?> <button type="button" class="button-link remove-personal-data-handle"><?php _e(
     "Retry"
 ); ?></button></span>
				<?php
    echo "</div>";
