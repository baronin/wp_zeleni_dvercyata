...
if (
    ...
    switch ($_REQUEST["fetch"]) { case 3: ?>
			<div class="media-item-wrapper">
				<div class="attachment-details">
					<?php
     $thumb_url = wp_get_attachment_image_src($id, "thumbnail", true);
     if ($thumb_url) {
         echo '<img class="pinkynail" src="' .
             esc_url($thumb_url[0]) .
             '" alt="" />';
     }
     ...
     ?>
					<div class="filename new">
						<span class="media-list-title"><strong><?php echo esc_html(
          wp_html_excerpt($title, 60, "&hellip;")
      ); ?></strong></span>
						<span class="media-list-subtitle"><?php echo esc_html(
          wp_basename($file)
      ); ?></span>
						<div class="attachment-tools">
							<?php if (current_user_can("edit_post", $id)) {
           echo '<a class="edit-attachment" href="' .
               esc_url(get_edit_post_link($id)) .
               '">' .
               _x("Edit", "media item") .
               "</a>";
       } else {
           echo '<span class="edit-attachment">' .
               _x("Success", "media item") .
               "</span>";
       } ?>
