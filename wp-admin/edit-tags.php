...
<div class="form-field term-parent-wrap">
  ...
  ?>
		...
		<p id="parent-description"><?php _e(
	...
	<?php else: ?>
		<p id="parent-description"><?php echo $tax->labels
...
<div class="form-field term-description-wrap">
	...
	<p id="description-description"><?php echo $tax->labels
     ->desc_field_description; ?></p>
</div>
