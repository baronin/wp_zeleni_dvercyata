...
$editor_settings = get_block_editor_settings(
    array_merge(get_legacy_widget_block_editor_settings(), [
...
?>
  ...
  if (file_exists(WP_PLUGIN_DIR . "/classic-widgets/classic-widgets.php")) {
      ...
      $plugin_activate_url = wp_nonce_url(
          "plugins.php?action=activate&amp;plugin=classic-widgets/classic-widgets.php",
      ...
      $plugin_install_url = wp_nonce_url(
          self_admin_url(
              "update.php?action=install-plugin&plugin=classic-widgets"
          ),
