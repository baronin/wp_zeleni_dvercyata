...
<label for="use_balanceTags"><input name="use_balanceTags" type="checkbox" id="use_balanceTags" value="1" <?php checked(
    "1",
...
<?php endif; ?>
<tr>
<th scope="row"><label for="default_category"><?php _e(
...
?>
<tr>
<th scope="row"><label for="default_post_format"><?php _e(
    "Default Post Format"
); ?></label></th>
<td>
...
<?php foreach ($post_formats as $format_slug => $format_name): ?>
      ...
      $format_slug
  ); ?> value="<?php echo esc_attr($format_slug); ?>"><?php echo esc_html(
    $format_name
); ?></option>
<?php endforeach; ?>
	</select>
...
<tr>
<th scope="row"><label for="default_link_category"><?php _e(
...
<table class="form-table" role="presentation">
<tr>
<th scope="row"><label for="mailserver_url"><?php _e(
    "Mail Server"
); ?></label></th>
<td><input name="mailserver_url" type="text" id="mailserver_url" value="<?php form_option(
    "mailserver_url"
); ?>" class="regular-text code" />
<label for="mailserver_port"><?php _e("Port"); ?></label>
<input name="mailserver_port" type="text" id="mailserver_port" value="<?php form_option(
    "mailserver_port"
); ?>" class="small-text" />
</td>
</tr>
<tr>
<th scope="row"><label for="mailserver_login"><?php _e(
    "Login Name"
); ?></label></th>
<td><input name="mailserver_login" type="text" id="mailserver_login" value="<?php form_option(
    "mailserver_login"
...
<tr class="mailserver-pass-wrap">
	...
	<td>
		...
		<span class="wp-pwd">
			<input type="text" name="mailserver_pass" id="mailserver_pass" class="regular-text ltr" autocomplete="off" data-reveal="1" data-pw="<?php echo esc_attr(
       get_option("mailserver_pass")
   ); ?>" />
			<button type="button" class="button wp-hide-pw hide-if-no-js" data-toggle="0" data-start-masked="1" aria-label="<?php esc_attr_e(
       "Hide password"
   ); ?>">
...
<tr>
<th scope="row"><label for="default_email_category"><?php _e(
...
<h2 class="title"><?php _e("Update Services"); ?></h2>
	...
	<textarea name="ping_sites" id="ping_sites" class="large-text code" rows="3"><?php echo esc_textarea(
     get_option("ping_sites")
 ); ?></textarea>
