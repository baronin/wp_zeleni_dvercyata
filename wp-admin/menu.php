...
$submenu["link-manager.php"][5] = [
    _x("All Links", "admin menu"),
    "manage_links",
    "link-manager.php",
];
$submenu["link-manager.php"][10] = [
    __("Add Link"),
    "manage_links",
    "link-add.php",
];
...
foreach (array_merge($builtin, $types) as $ptype) {
    ...
    while (
        isset($menu[$ptype_menu_position]) ||
    ...
    foreach (get_taxonomies([], "objects") as $tax) {
        if (
            !$tax->show_ui ||
            !$tax->show_in_menu ||
            !in_array($ptype, (array) $tax->object_type, true)
        ) {
            continue;
        }
...
$appearance_cap = current_user_can("switch_themes")
    ? "switch_themes"
    : "edit_theme_options";
...
if (wp_is_block_theme()) {
    ...
    $supports_stylebook =
        current_theme_supports("editor-styles") || wp_theme_has_theme_json();
...
$submenu["tools.php"][30] = [
    __("Erase Personal Data"),
    "erase_others_personal_data",
    "erase-personal-data.php",
];
if (is_multisite() && !is_main_site()) {
    $submenu["tools.php"][35] = [
        __("Delete Site"),
        "delete_site",
        "ms-delete-site.php",
    ];
...
$submenu["options-general.php"][25] = [
    __("Discussion"),
    "manage_options",
    "options-discussion.php",
];
$submenu["options-general.php"][30] = [
    __("Media"),
    "manage_options",
    "options-media.php",
];
...
$submenu["options-general.php"][45] = [
    __("Privacy"),
