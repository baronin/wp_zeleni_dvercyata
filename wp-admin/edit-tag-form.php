        ...
        $message .= sprintf(
            ...
            esc_url(
                wp_validate_redirect(
                    ...
                    admin_url("term.php?taxonomy=" . $taxonomy)
                )
            ),
...
?>
	<table class="form-table" role="presentation">
		<tr class="form-field form-required term-name-wrap">
			<th scope="row"><label for="name"><?php _ex(
       "Name",
       "term name"
   ); ?></label></th>
			...
			<p class="description" id="name-description"><?php echo $tax->labels
       ->name_field_description; ?></p></td>
		</tr>
   ...
   $slug = isset($tag->slug)
       ...
       : ""; ?>
			<td><input name="slug" id="slug" type="text" value="<?php echo esc_attr(
       $slug
   ); ?>" size="40" aria-describedby="slug-description" />
			<p class="description" id="slug-description"><?php echo $tax->labels
       ->slug_field_description; ?></p></td>
		</tr>
<?php if (is_taxonomy_hierarchical($taxonomy)): ?>
		<tr class="form-field term-parent-wrap">
			<th scope="row"><label for="parent"><?php echo esc_html(
       $tax->labels->parent_item
   ); ?></label></th>
			<td>
				<?php
    $dropdown_args = [
    ...
    ?>
				<?php if ("category" === $taxonomy): ?>
					<p class="description" id="parent-description"><?php _e(
         "Categories, unlike tags, can have a hierarchy. You might have a Jazz category, and under that have children categories for Bebop and Big Band. Totally optional."
				...
				<?php else: ?>
					<p class="description" id="parent-description"><?php echo $tax->labels
         ->parent_field_description; ?></p>
				<?php endif; ?>
			</td>
		</tr>
<?php endif;
...
?>
		<tr class="form-field term-description-wrap">
			<th scope="row"><label for="description"><?php _e(
       "Description"
   ); ?></label></th>
			<td><textarea name="description" id="description" rows="5" cols="50" class="large-text" aria-describedby="description-description"><?php echo $tag->description;
// textarea_escaped
?></textarea>
			<p class="description" id="description-description"><?php echo $tax->labels
       ->desc_field_description; ?></p></td>
		</tr>
		<?php
  // Back compat hooks.
  if ("category" === $taxonomy) {
...
<div class="edit-tag-actions">
	...
	<?php if (current_user_can("delete_term", $tag->term_id)): ?>
		<span id="delete-link">
			<a class="delete" href="<?php echo esc_url(
       admin_url(
           wp_nonce_url(
