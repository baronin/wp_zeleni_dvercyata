...
<div class="wrap about__container">
	...
	<nav class="about__header-navigation nav-tab-wrapper wp-clearfix" aria-label="<?php esc_attr_e(
     "Secondary menu"
		...
		<a href="freedoms.php" class="nav-tab nav-tab-active" aria-current="page"><?php _e(
      "Freedoms"
  ); ?></a>
	...
	<div class="about__section has-2-columns">
		<div class="column aligncenter">
			<img class="freedom-image" src="<?php echo esc_url(
       admin_url("images/freedom-1.svg?ver=6.5")
   ); ?>" alt="" />
		...
		<div class="column aligncenter">
			<img class="freedom-image" src="<?php echo esc_url(
       admin_url("images/freedom-2.svg?ver=6.5")
   ); ?>" alt="" />
       ...
       "To study how the program works and change it to make it do what you wish."
		...
		<div class="column aligncenter">
			<img class="freedom-image" src="<?php echo esc_url(
       admin_url("images/freedom-3.svg?ver=6.5")
   ); ?>" alt="" />
		...
		<div class="column aligncenter">
			<img class="freedom-image" src="<?php echo esc_url(
       admin_url("images/freedom-4.svg?ver=6.5")
   ); ?>" alt="" />
   ...
   $themes_url = current_user_can("switch_themes")
