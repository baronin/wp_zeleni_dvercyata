...
?>
	<div class="wrap about__container">
      ...
      "Secondary menu"
			...
			<a href="about.php" class="nav-tab nav-tab-active" aria-current="page"><?php _e(
       "What&#8217;s New"
   ); ?></a>
		...
		<div class="about__section has-2-columns is-wider-left is-feature" style="background-color:var(--background);border-radius:var(--border-radius);">
         ...
         __("https://wordpress.org/download/releases/6-8/")
     ); ?>" class="button button-primary button-hero"><?php _e(
    "See everything new"
); ?></a>
				</div>
			</div>
        ...
        admin_url("images/about-release-badge.svg?ver=6.8")
   ...
   if (isset($_GET["updated"]) && current_user_can("update_core")) {
       printf(
           ...
           is_multisite()
               ? __("Go to Updates")
               : __("Go to Dashboard &rarr; Updates")
       );
   }
