...
if (
    ...
    !@file_exists(ABSPATH . "../wp-settings.php")
) {
    wp_die(
        "<p>" .
            sprintf(
...
<p class="step"><a href="<?php echo $step_1; ?>" class="button button-large"><?php _e(
    "Let&#8217;s go!"
); ?></a></p>
		<?php break;
...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table" role="presentation">
		<tr>
			...
			<p id="dbname-desc"><?php _e(
       "The name of the database you want to use with WordPress."
   ); ?></p></td>
		</tr>
		<tr>
			<th scope="row"><label for="uname"><?php _e("Username"); ?></label></th>
			<td><input name="uname" id="uname" type="text" aria-describedby="uname-desc" size="25" placeholder="<?php echo htmlspecialchars(
       ...
       ENT_QUOTES
		...
		<tr>
			...
			<td>
				<div class="wp-pwd">
					<input name="pwd" id="pwd" type="password" class="regular-text" data-reveal="1" aria-describedby="pwd-desc" size="25" placeholder="<?php echo htmlspecialchars(
         _x("password", "example password"),
         ENT_QUOTES
     ); ?>" autocomplete="off" spellcheck="false" />
					<button type="button" class="button pwd-toggle hide-if-no-js" data-toggle="0" data-start-masked="1" aria-label="<?php esc_attr_e(
         "Show password"
     ); ?>">
...
<input name="noapi" type="hidden" value="1" /><?php } ?>
	<input type="hidden" name="language" value="<?php echo esc_attr(
     $language
 ); ?>" />
	<p class="step"><input name="submit" type="submit" value="<?php echo htmlspecialchars(
     __("Submit"),
     ENT_QUOTES
  ...
  break;
    ...
    case 2:
        ...
        $tryagain_link =
            ...
            $step_1 .
            '" onclick="javascript:history.go(-1);return false;" class="button button-large">' .
            __("Try Again") .
            "</a>";
        ...
        if (!is_writable(ABSPATH)):
            setup_config_display_header(); ?>
<p>
			<?php /* translators: %s: wp-config.php */
...
<p class="step"><a href="<?php echo $install; ?>" class="button button-large"><?php _e(
...
if ( ! /iPad|iPod|iPhone/.test( navigator.userAgent ) ) {
	...
	el.select();
            ...
            if (false !== $handle) {
                ...
                if (
                    !empty($wp_config_perms) &&
                    !is_writable($path_to_wp_config)
                ) {
            ...
            if (false !== $handle): ?>
<h1 class="screen-reader-text">
				<?php _e("Successful database connection"); ?>
</h1>
<p><?php _e(
...
<p class="step"><a href="<?php echo $install; ?>" class="button button-large"><?php _e(
    "Run the installation"
				...
				<?php else:printf("<p>%s</p>", $error_message);endif;
        endif;
        break;
}
