...
require ABSPATH .
    WPINC .
    "/rest-api/endpoints/class-wp-rest-navigation-fallback-controller.php";
require ABSPATH .
    WPINC .
    "/rest-api/endpoints/class-wp-rest-font-families-controller.php";
require ABSPATH .
    WPINC .
    "/rest-api/endpoints/class-wp-rest-font-faces-controller.php";
require ABSPATH .
    WPINC .
    "/rest-api/endpoints/class-wp-rest-font-collections-controller.php";
    ...
    if ($textdomain) {
        if ($plugin_data["DomainPath"]) {
            $GLOBALS["wp_textdomain_registry"]->set_custom_path(
                $textdomain,
                dirname($plugin) . $plugin_data["DomainPath"]
            );
        } else {
            $GLOBALS["wp_textdomain_registry"]->set_custom_path(
                $textdomain,
